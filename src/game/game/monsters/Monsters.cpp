...
void Monsters::initPage()
{
    ...
    case 0:
        ...
        if (scene->getMonsters(12) && !ennemis[12])
            ennemis[12] = (Ennemi *)(new Ennemi012(16 + 17, 112 + 16));
        if (scene->getMonsters(6) && !ennemis[6])
            ennemis[6] = (Ennemi *)(new Ennemi006(96 + 16, 112 + 2));
        if (scene->getMonsters(5) && !ennemis[5])
            ennemis[5] = (Ennemi *)(new Ennemi005(176 + 16, 112 + 10));
        if (scene->getMonsters(1) && !ennemis[1])
            ennemis[1] = (Ennemi *)(new Ennemi001(256 + 16, 112 + 11));
        if (scene->getMonsters(22) && !ennemis[22])
            ennemis[22] = (Ennemi *)(new Ennemi022(16 + 16, 176 + 12));
    ...
    case 1:
        ...
        if (scene->getMonsters(121) && !ennemis[121])
            ennemis[121] = (Ennemi *)(new Ennemi121(208 + 8, 8 + 8));
        if (scene->getMonsters(7) && !ennemis[7])
            ennemis[7] = (Ennemi *)(new Ennemi007(264 + 8, 8 + 8));
        if (scene->getMonsters(23) && !ennemis[23])
            ennemis[23] = (Ennemi *)(new Ennemi023(16 + 11, 48 + 16));
        if (scene->getMonsters(25) && !ennemis[25])
            ennemis[25] = (Ennemi *)(new Ennemi025(96 + 10, 48 + 9));
        if (scene->getMonsters(16) && !ennemis[16])
            ennemis[16] = (Ennemi *)(new Ennemi016(176 + 16, 48 + 12));
        if (scene->getMonsters(29) && !ennemis[29])
            ennemis[29] = (Ennemi *)(new Ennemi029(256 + 16, 48 + 11));
        if (scene->getMonsters(19) && !ennemis[19])
            ennemis[19] = (Ennemi *)(new Ennemi019(16 + 8, 112 + 8));
        if (scene->getMonsters(28) && !ennemis[28])
            ennemis[28] = (Ennemi *)(new Ennemi028(112 + 8, 112 + 4));
        if (scene->getMonsters(40) && !ennemis[40])
            ennemis[40] = (Ennemi *)(new Ennemi040(176 + 5, 112 + 11));
        if (scene->getMonsters(24) && !ennemis[24])
            ennemis[24] = (Ennemi *)(new Ennemi024(256 + 8, 112 + 8, false));
        if (scene->getMonsters(35) && !ennemis[35])
            ennemis[35] = (Ennemi *)(new Ennemi035(16 + 8, 176 + 8));
        if (scene->getMonsters(43) && !ennemis[43])
            ennemis[43] = (Ennemi *)(new Ennemi043(96 + 8, 176 + 8));
        break;
    case 2:
        if (scene->getMonsters(91) && !ennemis[91])
            ennemis[91] = (Ennemi *)(new Ennemi091(16 + 13, 48 + 16));
        if (scene->getMonsters(93) && !ennemis[93])
            ennemis[93] = (Ennemi *)(new Ennemi093(88 + 8, 48 + 8));
        if (scene->getMonsters(95) && !ennemis[95])
            ennemis[95] = (Ennemi *)(new Ennemi095(176 + 14, 8 + 12));
        if (scene->getMonsters(104) && !ennemis[104])
            ennemis[104] = (Ennemi *)(new Ennemi104(256 + 8, 8 + 9));
        if (scene->getMonsters(105) && !ennemis[105])
            ennemis[105] = (Ennemi *)(new Ennemi105(16 + 8, 128 + 6));
        if (scene->getMonsters(94) && !ennemis[94])
            ennemis[94] = (Ennemi *)(new Ennemi094(152 + 8, 160 + 8));
        if (scene->getMonsters(97) && !ennemis[97])
            ennemis[97] = (Ennemi *)(new Ennemi097(240 + 5, 152 + 5));
        if (scene->getMonsters(92) && !ennemis[92])
            ennemis[92] = (Ennemi *)(new Ennemi092(160 + 11, 72 + 6));
        break;
    case 3:
        if (scene->getMonsters(84) && !ennemis[84])
            ennemis[84] = (Ennemi *)(new Ennemi084(152 + 8, 8 + 9, S));
        if (scene->getMonsters(56) && !ennemis[56])
            ennemis[56] = (Ennemi *)(new Ennemi056(208 + 9, 8 + 8));
        if (scene->getMonsters(86) && !ennemis[86])
            ennemis[86] = (Ennemi *)(new Ennemi086(264 + 8, 8 + 8));
        if (scene->getMonsters(32) && !ennemis[32])
            ennemis[32] = (Ennemi *)(new Ennemi032(16 + 16, 48 + 11));
        if (scene->getMonsters(11) && !ennemis[11])
            ennemis[11] = (Ennemi *)(new Ennemi011(96 + 16, 48 + 14, true));
        if (scene->getMonsters(55) && !ennemis[55])
            ennemis[55] = (Ennemi *)(new Ennemi055(176 + 13, 48 + 9));
        if (scene->getMonsters(37) && !ennemis[37])
            ennemis[37] = (Ennemi *)(new Ennemi037(256 + 16, 48 + 11));
        if (scene->getMonsters(15) && !ennemis[15])
            ennemis[15] = (Ennemi *)(new Ennemi015(16 + 12, 112 + 6));
        if (scene->getMonsters(44) && !ennemis[44])
            ennemis[44] = (Ennemi *)(new Ennemi044(96 + 13, 112 + 9));
        if (scene->getMonsters(26) && !ennemis[26])
            ennemis[26] = (Ennemi *)(new Ennemi026(176 + 17, 112 + 14));
        if (scene->getMonsters(101) && !ennemis[101])
            ennemis[101] = (Ennemi *)(new Ennemi101(256 + 8, 112 + 8, N));
        if (scene->getMonsters(62) && !ennemis[62])
            ennemis[62] = (Ennemi *)(new Ennemi062(16 + 12, 176 + 5, false));
        if (scene->getMonsters(64) && !ennemis[64])
            ennemis[64] = (Ennemi *)(new Ennemi064(96 + 4, 176 + 6));
        break;
    case 4:
        if (scene->getMonsters(98) && !ennemis[98])
            ennemis[98] = (Ennemi *)(new Ennemi098(16 + 8, 48 + 8));
        if (scene->getMonsters(102) && !ennemis[102])
            ennemis[102] = (Ennemi *)(new Ennemi102(104 + 12, 48 + 11));
        if (scene->getMonsters(99) && !ennemis[99])
            ennemis[99] = (Ennemi *)(new Ennemi099(184 + 14, 64 + 17));
        if (scene->getMonsters(103) && !ennemis[103])
            ennemis[103] = (Ennemi *)(new Ennemi103(32 + 7, 112 + 7));
        break;
    case 5:
        if (scene->getMonsters(112) && !ennemis[112])
            ennemis[112] = (Ennemi *)(new Ennemi112(152 + 8, 8 + 8));
        if (scene->getMonsters(118) && !ennemis[118])
            ennemis[118] = (Ennemi *)(new Ennemi118(208 + 8, 8 + 8));
        if (scene->getMonsters(77) && !ennemis[77])
            ennemis[77] = (Ennemi *)(new Ennemi077(16 + 3, 48 + 9));
        if (scene->getMonsters(42) && !ennemis[42])
            ennemis[42] = (Ennemi *)(new Ennemi042(96 + 11, 48 + 14));
        if (scene->getMonsters(41) && !ennemis[41])
            ennemis[41] = (Ennemi *)(new Ennemi041(176 + 16, 48 + 12));
        if (scene->getMonsters(87) && !ennemis[87])
            ennemis[87] = (Ennemi *)(new Ennemi087(256 - 5, 48 + 12));
        if (scene->getMonsters(30) && !ennemis[30])
            ennemis[30] = (Ennemi *)(new Ennemi030(16 + 16, 112 + 12));
        if (scene->getMonsters(33) && !ennemis[33])
            ennemis[33] = (Ennemi *)(new Ennemi033(96 + 13, 112 + 12));
        if (scene->getMonsters(34) && !ennemis[34])
            ennemis[34] = (Ennemi *)(new Ennemi034(176 + 12, 112 + 12));
        if (scene->getMonsters(2) && !ennemis[2])
            ennemis[2] = (Ennemi *)(new Ennemi002(256 + 14, 112 + 12));
        if (scene->getMonsters(72) && !ennemis[72])
            ennemis[72] = (Ennemi *)(new Ennemi072(16 + 16, 176 + 11));
        if (scene->getMonsters(38) && !ennemis[38])
            ennemis[38] = (Ennemi *)(new Ennemi038(96 + 13, 176 + 12));
        if (scene->getMonsters(39) && !ennemis[39])
            ennemis[39] = (Ennemi *)(new Ennemi039(176 + 12, 176 + 12));
        if (scene->getMonsters(119) && !ennemis[119])
            ennemis[119] = (Ennemi *)(new Ennemi119(256 + 13, 176 + 9));
        break;
    case 6:
        if (scene->getMonsters(108) && !ennemis[108])
            ennemis[108] = (Ennemi *)(new Ennemi108(16 + 3, 48 + 8));
        if (scene->getMonsters(110) && !ennemis[110])
            ennemis[110] = (Ennemi *)(new Ennemi110(80 + 10, 48 + 8));
        if (scene->getMonsters(106) && !ennemis[106])
            ennemis[106] = (Ennemi *)(new Ennemi106(152 + 6, 8 + 8));
        if (scene->getMonsters(76) && !ennemis[76])
            ennemis[76] = (Ennemi *)(new Ennemi076(224 + 10, 8 + 6));
        if (scene->getMonsters(113) && !ennemis[113])
            ennemis[113] = (Ennemi *)(new Ennemi113(16 + 10, 112 + 10));
        if (scene->getMonsters(107) && !ennemis[107])
            ennemis[107] = (Ennemi *)(new Ennemi107(208 + 9, 88 + 7));
        if (scene->getMonsters(109) && !ennemis[109])
            ennemis[109] = (Ennemi *)(new Ennemi109(80 - 5, 112 + 9));
        if (scene->getMonsters(111) && !ennemis[111])
            ennemis[111] = (Ennemi *)(new Ennemi111(224 + 9, 168 + 8));
        break;
    case 7:
        if (scene->getMonsters(115) && !ennemis[115])
            ennemis[115] = (Ennemi *)(new Ennemi115(32 + 8, 64 + 10));
        if (scene->getMonsters(120) && !ennemis[120])
            ennemis[120] = (Ennemi *)(new Ennemi120(208 + 8, 64 + 8));
        if (scene->getMonsters(89) && !ennemis[89])
            ennemis[89] = (Ennemi *)(new Ennemi089(208 + 14, 127 + 11));
        break;
    case 8:
        if (scene->getMonsters(46) && !ennemis[46])
            ennemis[46] = (Ennemi *)(new Ennemi046(16 + 13, 48 + 9));
        if (scene->getMonsters(47) && !ennemis[47])
            ennemis[47] = (Ennemi *)(new Ennemi047(96 + 13, 48 + 9));
        if (scene->getMonsters(48) && !ennemis[48])
            ennemis[48] = (Ennemi *)(new Ennemi048(176 + 13, 48 + 9));
        if (scene->getMonsters(31) && !ennemis[31])
            ennemis[31] = (Ennemi *)(new Ennemi031(16 + 8, 112 + 8));
        if (scene->getMonsters(50) && !ennemis[50])
            ennemis[50] = (Ennemi *)(new Ennemi050(96 + 8, 112 + 6));
        break;
    case 9:
        if (scene->getMonsters(123) && !ennemis[123])
            ennemis[123] = (Ennemi *)(new Ennemi123(16 + 13, 48 + 9));
        if (scene->getMonsters(126) && !ennemis[126])
            ennemis[126] = (Ennemi *)(new Ennemi126(96 + 16, 48 + 16));
        if (scene->getMonsters(127) && !ennemis[127])
            ennemis[127] = (Ennemi *)(new Ennemi127(16 + 9, 112 + 8));
        if (scene->getMonsters(128) && !ennemis[128])
            ennemis[128] = (Ennemi *)(new Ennemi128(144 + 6, 112 - 3));
        break;
    case 10:
        if (scene->getMonsters(129) && !ennemis[129])
            ennemis[129] = (Ennemi *)(new Ennemi129(16 + 16, 48 + 2));
        if (scene->getMonsters(130) && !ennemis[130])
            ennemis[130] = (Ennemi *)(new Ennemi130(96 + 12, 48 + 6));
        if (scene->getMonsters(131) && !ennemis[131])
            ennemis[131] = (Ennemi *)(new Ennemi131(176 + 16, 48 + 12));
        if (scene->getMonsters(139) && !ennemis[139])
            ennemis[139] = (Ennemi *)(new Ennemi139(256 + 13, 32 + 16));
        if (scene->getMonsters(133) && !ennemis[133])
            ennemis[133] = (Ennemi *)(new Ennemi133(16 + 12, 112 + 12));
        if (scene->getMonsters(134) && !ennemis[134])
            ennemis[134] = (Ennemi *)(new Ennemi134(96 + 13, 112 + 9));
        if (scene->getMonsters(135) && !ennemis[135])
            ennemis[135] = (Ennemi *)(new Ennemi135(176 + 12, 112 + 5));
        if (scene->getMonsters(136) && !ennemis[136])
            ennemis[136] = (Ennemi *)(new Ennemi136(256 + 4, 112 + 6));
        if (scene->getMonsters(137) && !ennemis[137])
            ennemis[137] = (Ennemi *)(new Ennemi137(16 + 16, 176 + 11));
        if (scene->getMonsters(138) && !ennemis[138])
            ennemis[138] = (Ennemi *)(new Ennemi138(96 + 3, 176 + 9));
        if (scene->getMonsters(132) && !ennemis[132])
            ennemis[132] = (Ennemi *)(new Ennemi132(176 + 16, 176 + 11));
        if (scene->getMonsters(140) && !ennemis[140])
            ennemis[140] = (Ennemi *)(new Ennemi140(256 + 16, 176 + 16));
        break;
    case 11:
        if (scene->getMonsters(141) && !pnj)
            pnj = new Pnj(136 + 16, 96 + 12, 8, 1654);
        break;
    }
}
...
bool Monsters::isPageEmpty(int p)
{
    ...
    {
    case 0:
        if (scene->getMonsters(4) || scene->getMonsters(53) || scene->getMonsters(54) || scene->getMonsters(27) || scene->getMonsters(10) || scene->getMonsters(9) || scene->getMonsters(8) || scene->getMonsters(12) || scene->getMonsters(6) || scene->getMonsters(5) || scene->getMonsters(1) || scene->getMonsters(22) || scene->getMonsters(3) || scene->getMonsters(13) || scene->getMonsters(14))
        {
            return false;
        }
        break;
    case 1:
        if (scene->getMonsters(18) || scene->getMonsters(121) || scene->getMonsters(7) || scene->getMonsters(23) || scene->getMonsters(25) || scene->getMonsters(16) || scene->getMonsters(29) || scene->getMonsters(19) || scene->getMonsters(28) || scene->getMonsters(40) || scene->getMonsters(24) || scene->getMonsters(35) || scene->getMonsters(43))
        {
            return false;
        }
        break;
    case 2:
        if (scene->getMonsters(91) || scene->getMonsters(93) || scene->getMonsters(95) || scene->getMonsters(104) || scene->getMonsters(105) || scene->getMonsters(94) || scene->getMonsters(97) || scene->getMonsters(92))
        {
            return false;
        }
        break;
    case 3:
        if (scene->getMonsters(84) || scene->getMonsters(56) || scene->getMonsters(86) || scene->getMonsters(32) || scene->getMonsters(11) || scene->getMonsters(55) || scene->getMonsters(37) || scene->getMonsters(15) || scene->getMonsters(44) || scene->getMonsters(26) || scene->getMonsters(101) || scene->getMonsters(62) || scene->getMonsters(64))
        {
            return false;
        }
        break;
    case 4:
        if (scene->getMonsters(98) || scene->getMonsters(102) || scene->getMonsters(99) || scene->getMonsters(103))
        {
            return false;
        }
        break;
    case 5:
        if (scene->getMonsters(112) || scene->getMonsters(118) || scene->getMonsters(77) || scene->getMonsters(42) || scene->getMonsters(41) || scene->getMonsters(87) || scene->getMonsters(30) || scene->getMonsters(33) || scene->getMonsters(34) || scene->getMonsters(2) || scene->getMonsters(72) || scene->getMonsters(38) || scene->getMonsters(39) || scene->getMonsters(119))
        {
            return false;
        }
        break;
    case 6:
        if (scene->getMonsters(108) || scene->getMonsters(110) || scene->getMonsters(106) || scene->getMonsters(76) || scene->getMonsters(113) || scene->getMonsters(107) || scene->getMonsters(109) || scene->getMonsters(111))
        {
            return false;
        }
        break;
    case 7:
        ...
        break;
    case 8:
        if (scene->getMonsters(46) || scene->getMonsters(47) || scene->getMonsters(48) || scene->getMonsters(31) || scene->getMonsters(50))
        {
            return false;
        }
        break;
    case 9:
        if (scene->getMonsters(123) || scene->getMonsters(126) || scene->getMonsters(127) || scene->getMonsters(128))
        {
            return false;
        }
        break;
    case 10:
        if (scene->getMonsters(129) || scene->getMonsters(130) || scene->getMonsters(131) || scene->getMonsters(139) || scene->getMonsters(133) || scene->getMonsters(134) || scene->getMonsters(135) || scene->getMonsters(136) || scene->getMonsters(137) || scene->getMonsters(138) || scene->getMonsters(132) || scene->getMonsters(140))
        {
            return false;
        }
        break;
