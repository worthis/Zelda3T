...
void MapDonjon::drawMap()
{
    ...
    if (scene->getCoffre(mapId == 156 ? 16 : mapId - 45, 1))
    {
        ...
        case 46:
            if (etage == -1)
            {
                if (!scene->getCoffre(mapId - 45, 25))
                { // mini boss
                    WindowManager::getInstance()->draw(imageBoussole, 10, 0, 6, 6,
                                                       128 + ((10 - w) / 2) * 16 + 5,
                                                       48 + (((10 - h) / 2) + 2) * 16 + 5);
                }
                if (!scene->getLink()->getInventory()->hasObject(ARC))
                { // arc
            ...
            else if (etage == 2)
            {
                ...
                if (!scene->getLink()->getInventory()->hasMedaillon(0))
                { // medaillon
                    WindowManager::getInstance()->draw(imageBoussole, 0, 0, 2, 2,
                                                       128 + ((10 - w) / 2) * 16 + 7,
                                                       48 + ((10 - h) / 2) * 16 + 7);
        ...
        case 47:
            ...
            else if (etage == -2)
            {
                ...
                if (!scene->getLink()->getInventory()->hasMedaillon(1))
                { // medaillon
                    WindowManager::getInstance()->draw(imageBoussole, 0, 0, 2, 2,
                                                       128 + (((10 - w) / 2) + 5) * 16 + 7,
                                                       48 + (((10 - h) / 2) + 1) * 16 + 7);
                }
                if (!scene->getCoffre(mapId - 45, 20))
                { // mini boss
                    WindowManager::getInstance()->draw(imageBoussole, 10, 0, 6, 6,
                                                       128 + (((10 - w) / 2) + 4) * 16 + 5,
                                                       48 + (((10 - h) / 2) + 3) * 16 + 5);
        ...
        case 48:
            if (etage == 0)
            {
                ...
                if (!scene->getCoffre(mapId - 45, 28))
                { // mini boss
                    WindowManager::getInstance()->draw(imageBoussole, 10, 0, 6, 6,
                                                       128 + (((10 - w) / 2) + 6) * 16 + 5,
                                                       48 + (((10 - h) / 2) + 2) * 16 + 5);
            ...
            {
                if (!scene->getLink()->getInventory()->hasMedaillon(2))
                { // medaillon
                    WindowManager::getInstance()->draw(imageBoussole, 0, 0, 2, 2,
                                                       128 + ((10 - w) / 2) * 16 + 7,
                                                       48 + (((10 - h) / 2) + 1) * 16 + 7);
        ...
        case 50:
            if (etage == 0)
            {
                if (!scene->getCoffre(mapId - 45, 41))
                { // mini boss
                    WindowManager::getInstance()->draw(imageBoussole, 10, 0, 6, 6,
                                                       128 + (((10 - w) / 2) + 4) * 16 + 5,
                                                       48 + (((10 - h) / 2) + 2) * 16 + 5);
                }
                if (scene->getLink()->getTunique() < 2)
                { // tunique
                    WindowManager::getInstance()->draw(imageBoussole, 0, 0, 2, 2,
                                                       128 + (((10 - w) / 2) + 4) * 16 + 7,
                                                       48 + (((10 - h) / 2) + 1) * 16 + 7);
            ...
            else if (etage == -1)
            {
                ...
                if (!scene->getLink()->getInventory()->hasObject(CLE_TEMPS))
                { // cle temps
                    WindowManager::getInstance()->draw(imageBoussole, 0, 0, 2, 2,
                                                       128 + (((10 - w) / 2) + 3) * 16 + 7,
                                                       48 + ((10 - h) / 2) * 16 + 7);
        ...
        case 52:
            if (etage == 0)
            {
                if (!scene->getCoffre(mapId - 45, 24))
                { // mini boss
                    WindowManager::getInstance()->draw(imageBoussole, 10, 0, 6, 6,
                                                       128 + (((10 - w) / 2) + 2) * 16 + 5,
                                                       48 + (((10 - h) / 2) + 2) * 16 + 5);
                }
                if (!scene->getLink()->getInventory()->hasObject(GANTS_2))
                { // gants 2
                    WindowManager::getInstance()->draw(imageBoussole, 0, 0, 2, 2,
                                                       128 + (((10 - w) / 2) + 2) * 16 + 7,
                                                       48 + (((10 - h) / 2) + 1) * 16 + 7);
            ...
            else if (etage == -1)
            {
                ...
                if (!scene->getLink()->getInventory()->hasObject(TROC_GEMME_JAUNE))
                { // gemme jaune
                    WindowManager::getInstance()->draw(imageBoussole, 0, 0, 2, 2,
                                                       128 + (((10 - w) / 2) + 3) * 16 + 7,
                                                       48 + (((10 - h) / 2) + 1) * 16 + 7);
        ...
        case 53:
            ...
            if (etage == 1)
            {
                if (!scene->getCoffre(mapId - 45, 27))
                { // mini boss
                    WindowManager::getInstance()->draw(imageBoussole, 10, 0, 6, 6,
                                                       128 + ((10 - w) / 2) * 16 + 5,
                                                       48 + (((10 - h) / 2) + 1) * 16 + 5);
            ...
            if (etage == 2)
            {
                ...
                if (!scene->getLink()->getInventory()->hasObject(TROC_GEMME_VERTE))
                { // gemme verte
                    WindowManager::getInstance()->draw(imageBoussole, 0, 0, 2, 2,
                                                       128 + (((10 - w) / 2) + 2) * 16 + 7,
                                                       48 + ((10 - h) / 2) * 16 + 7);
        ...
        case 54:
            if (etage == -1)
            {
                if (!scene->getCoffre(mapId - 45, 56))
                { // mini boss
                    WindowManager::getInstance()->draw(imageBoussole, 10, 0, 6, 6,
                                                       128 + (((10 - w) / 2) + 2) * 16 + 5,
                                                       48 + ((10 - h) / 2) * 16 + 5);
            ...
            else if (etage == -2)
            {
                ...
                if (!scene->getLink()->getInventory()->hasObject(TROC_GEMME_BLEUE))
                { // gemme bleue
                    WindowManager::getInstance()->draw(imageBoussole, 0, 0, 2, 2,
                                                       128 + (((10 - w) / 2) + 2) * 16 + 7 + 8,
                                                       48 + ((10 - h) / 2) * 16 + 7);
        ...
        case 55:
            if (etage == 0)
            {
                if (!scene->getLink()->getInventory()->hasObject(TROC_GEMME_ROUGE))
                { // gemme rouge
                    WindowManager::getInstance()->draw(imageBoussole, 0, 0, 2, 2,
                                                       128 + (((10 - w) / 2) + 3) * 16 + 7,
                                                       48 + (((10 - h) / 2) + 2) * 16 + 7);
        ...
        case 56:
            if (etage == 0)
            {
                if (!scene->getCoffre(mapId - 45, 19))
                { // mini boss
                    WindowManager::getInstance()->draw(imageBoussole, 10, 0, 6, 6,
                                                       128 + (((10 - w) / 2) + 5) * 16 + 5,
                                                       48 + (((10 - h) / 2) + 6) * 16 + 5);
        ...
        case 57:
            if (etage == 1)
            {
                if (bossIsAlive() && !scene->getMonsters(50))
                { // boss
                    WindowManager::getInstance()->draw(imageBoussole, 2, 0, 8, 8,
                                                       128 + (((10 - w) / 2) + 1) * 16 + 4,
                                                       48 + (((10 - h) / 2) + 1) * 16 + 4);
            ...
            {
                if (scene->getLink()->getBouclier() == 0)
                { // bouclier 1
                    WindowManager::getInstance()->draw(imageBoussole, 0, 0, 2, 2,
                                                       128 + (((10 - w) / 2) + 4) * 16 + 7 - 2,
                                                       48 + ((10 - h) / 2) * 16 + 7);
            ...
            break;
        case 58:
            if (scene->getLink()->getBouclier() < 4)
            { // bouclier 4
                WindowManager::getInstance()->draw(imageBoussole, 0, 0, 2, 2,
                                                   128 + (((10 - w) / 2) + 3) * 16 + 7 - 2,
                                                   48 + (((10 - h) / 2) + 1) * 16 + 7);
        ...
        case 60:
            if (etage == -1)
            {
                if (!scene->getLink()->getInventory()->hasObject(MASQUE))
                { // masque oni link
                    WindowManager::getInstance()->draw(imageBoussole, 0, 0, 2, 2,
                                                       128 + (((10 - w) / 2) + 3) * 16 + 7,
                                                       48 + ((10 - h) / 2) * 16 + 7);
