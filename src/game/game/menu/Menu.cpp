...
void Menu::drawNomObject(int df) {
    ...
    int tmp = 0;
    switch (current) {
        case ARC : tmp = 0; break;
        case ARC_FEE : tmp = 1; break;
        case GRAPPIN : tmp = 2; break;
        case BOMBES : tmp = 3; break;
        case FLECHE_FEU : tmp = 4; break;
        case TROC_GEMME_ROUGE :
            if (MainController::getInstance()->getGameController()->getSceneController()->getScene()->getLink()->getInventory()->getTrocGemme(0) == TGR_RIEN) return;
            if (MainController::getInstance()->getGameController()->getSceneController()->getScene()->getLink()->getInventory()->getTrocGemme(0) == TGR_RIEN_2) return;
            ...
            break;
        case BAGUETTE_FEU : tmp = 12; break;
        case BAGUETTE_GLACE : tmp = 13; break;
        case LANTERNE : tmp = 14; break;
        case FLECHE_GLACE : tmp = 15; break;
        case TROC_GEMME_BLEUE :
            ...
            break;
        case MARTEAU : tmp = 23; break;
        case OCARINA : tmp = 24; break;
        case CANNE_A_PECHE_1 : tmp = 25; break;
        case CANNE_A_PECHE_2 : tmp = 26; break;
        case CANNE_A_PECHE_3 : tmp = 27; break;
        case FLECHE_LUMIERE : tmp = 28; break;
        ...
        case TROC_GEMME_VERTE :
            ...
            break;
        case FLACON_1 :
            tmp = 44 + MainController::getInstance()->getGameController()->getSceneController()->getScene()->getLink()->getInventory()->getFlacon(0); break;
        case FLACON_2 :
            tmp = 44 + MainController::getInstance()->getGameController()->getSceneController()->getScene()->getLink()->getInventory()->getFlacon(1); break;
        case FLACON_3 :
            tmp = 44 + MainController::getInstance()->getGameController()->getSceneController()->getScene()->getLink()->getInventory()->getFlacon(2); break;
        case FLACON_4 :
            tmp = 44 + MainController::getInstance()->getGameController()->getSceneController()->getScene()->getLink()->getInventory()->getFlacon(3); break;
        default : tmp = 0;
    }
...
void Menu::drawStatus(int df) {
    ...
    if (rubisMax) {
        int srcX = 0;
        if (rubisMax >= 200) srcX += 16;
        if (rubisMax >= 500) srcX += 16;
        if (rubisMax == 999) srcX += 16;
    ...
    if (ganonOrMax) {
        ...
        int srcX = 64;
        if (ganonOrMax >= 200) srcX += 16;
        if (ganonOrMax >= 500) srcX += 16;
        if (ganonOrMax == 999) srcX += 16;
    ...
    if (pieceOrMax) {
        int srcX = 0;
        if (pieceOrMax >= 200) srcX += 16;
        if (pieceOrMax >= 500) srcX += 16;
        if (pieceOrMax == 999) srcX += 16;
...
void Menu::initFromSelectedStuff() {
    ...
    switch (current) {
        ...
        case FLECHE_FEU : case TROC_GEMME_ROUGE : tmp = 3; break;
        case BAGUETTE_FEU : tmp = 4; break;
        case BAGUETTE_GLACE : tmp = 5; break;
        case LANTERNE : tmp = 6; break;
        case FLECHE_GLACE : case TROC_GEMME_BLEUE : tmp = 7; break;
        case MARTEAU : tmp = 8; break;
        case OCARINA : tmp = 9; break;
        case CANNE_A_PECHE_1 : case CANNE_A_PECHE_2 : case CANNE_A_PECHE_3 : tmp = 10; break;
        case FLECHE_LUMIERE : case TROC_GEMME_JAUNE : tmp = 11; break;
        case FLACON_1 : tmp = 12; break;
        case FLACON_2 : tmp = 13; break;
        case FLACON_3 : tmp = 14; break;
        case FLACON_4 : case TROC_GEMME_VERTE : tmp = 15; break;
        default : tmp = 0;
    }
    i = tmp % 4;
    j = tmp / 4;
...
Equipment Menu::getSelectedStuff() {
    ...
    switch (tmp) {
        ...
        case 3 :
            if (link->getInventory()->hasObject(FLECHE_FEU)) return FLECHE_FEU;
            return TROC_GEMME_ROUGE;
        case 4 : return BAGUETTE_FEU;
        case 5 : return BAGUETTE_GLACE;
        case 6 : return LANTERNE;
        case 7 :
            if (link->getInventory()->hasObject(FLECHE_GLACE)) return FLECHE_GLACE;
            return TROC_GEMME_BLEUE;
        case 8 : return MARTEAU;
        case 9 : return OCARINA;
        case 10 :
            if (link->getInventory()->hasObject(CANNE_A_PECHE_3)) return CANNE_A_PECHE_3;
            if (link->getInventory()->hasObject(CANNE_A_PECHE_2)) return CANNE_A_PECHE_2;
            return CANNE_A_PECHE_1;
        case 11 :
            if (link->getInventory()->hasObject(FLECHE_LUMIERE)) return FLECHE_LUMIERE;
            return TROC_GEMME_JAUNE;
        case 12 : return FLACON_1;
        case 13 : return FLACON_2;
        case 14 : return FLACON_3;
        case 15 :
            if (link->getInventory()->hasObject(FLACON_4)) return FLACON_4;
