...
private:
    ...
    void drawNomObject(int df);

    void drawHearts(int df);

    void drawGemmes(int df);

    void drawEquipement(int df);

    void drawStatus(int df);

    void drawCadre(int x, int y, int w, int h);

    void drawNombre(int val, int x, int y, int nb, int color = 0);

    void drawSeparateur(int x, int y);
