...
void TextArea::stop()
{
    ...
    case 304:
        ...
        if (map->getId() == 96)
            scene->setCoffre(0, 20, 1);
        if (map->getId() == 140)
            scene->setCoffre(0, 31, 1);
        break;
    case 305:
        link->getStatus()->updateRupees(-10);
        link->trouveObjet(TI_SAC_OLIVES);
    ...
    case 307:
        if (map->getId() == 57)
            scene->setCoffre(12, 13, 1);
        if (map->getId() == 87)
            scene->setCoffre(0, 17, 1);
        if (map->getId() == 96)
            scene->setCoffre(0, 22, 1);
        break;
    case 337:
    ...
    case 363:
        ...
        if (map->getId() == 96)
            scene->setCoffre(0, 21, 1);
        if (map->getId() == 104)
            scene->setCoffre(0, 23, 1);
        if (map->getId() == 140)
            scene->setCoffre(0, 30, 1);
        break;
    case 364:
        link->getStatus()->updateGanonOr(-5);
        break;
    ...
    case 601:
        ...
        if (link->getStatus()->getMaxBombs() < 30 && link->getInventory()->hasObject(BOMBES) && (link->getStatus()->getMaxArrows() == 70 || (int)(rand() % 2) == 1))
        {
    ...
    case 678:
        ...
        return;
    case 684:
        link->getStatus()->updateRupees(-(4 - ((link->getInventory()->hasQuartCoeur(15) ? 0 : 1) + (link->getInventory()->hasGemmeForce(160) ? 0 : 1) + (link->getInventory()->hasGemmeForce(161) ? 0 : 1) + (link->getInventory()->hasGemmeForce(162) ? 0 : 1)) + 1) * 5);
        map->closeChests();
        break;
    case 694:
    ...
    case 1159:
        link->setAnimation(JOUE_OCARINA);
        if (map->getEpoque() == EP_PRESENT)
            MainController::getInstance()->getGameController()->getOcarinaController()->setSong(0);
        else if (map->getEpoque() == EP_PASSE)
            MainController::getInstance()->getGameController()->getOcarinaController()->setSong(2);
        else
            MainController::getInstance()->getGameController()->getOcarinaController()->setSong(1);
        MainController::getInstance()->getGameController()->setStep(GAME_OCARINA);
    ...
    case 1245:
        if (map->getId() == 46)
            MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(22, 84 * 16, 8 * 16, S, false, true);
        else if (map->getId() == 47)
            MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(26, 72 * 16 + 8, 42 * 16, S, false, true);
        else if (map->getId() == 48)
            MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(30, 122 * 16, 36 * 16, S, false, true);
        else if (map->getId() == 49)
            MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(41, 72 * 16 + 8, 44 * 16, S, false, true);
        else if (map->getId() == 50)
            MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(42, 15 * 16 + 8, 22 * 16, S, false, true);
        else if (map->getId() == 51)
            MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(27, 15 * 16 + 8, 22 * 16, S, false, true);
        else if (map->getId() == 52)
            MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(12, 15 * 16 + 8, 22 * 16, S, false, true);
        else if (map->getId() == 53)
            MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(7, 84 * 16, 8 * 16, S, false, true);
        else if (map->getId() == 54)
            MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(11, 72 * 16 + 8, 52 * 16 + 8, S, false, true);
        else if (map->getId() == 55)
            MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(15, 122 * 16, 35 * 16, S, false, true);
        else if (map->getId() == 58)
            MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(44, 34 * 16 + 8, 25 * 16, S, false, true);
        else if (map->getId() == 59)
            MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(45, 108 * 16 + 8, 4 * 16, S, false, true);
        else
            break;
        AudioManager::getInstance()->playSound(TS_TELEPORT);
        MainController::getInstance()->getGameController()->setStep(GAME_TELEPORT);
...
bool TextArea::hasLogicalNext()
{
    ...
    case 305:
        ...
        break;
    case 337:
        if (inventory->getTroc(TT_ROUE) < 1 || inventory->getTroc(TT_JAUGE) < 1 || inventory->getTroc(TT_SOURCE_NRJ) < 1 || link->getStatus()->getVirtualGanonOr() < 100)
        {
            next = 278;
        }
        else
    ...
    case 676:
        ...
        break;
    case 684:
        if (link->getStatus()->getVirtualRupees() < (4 - ((inventory->hasQuartCoeur(15) ? 0 : 1) + (inventory->hasGemmeForce(160) ? 0 : 1) + (inventory->hasGemmeForce(161) ? 0 : 1) + (inventory->hasGemmeForce(162) ? 0 : 1)) + 1) * 5)
        {
            next = 278;
        }
        else
    ...
    case 811:
        ...
        if (tmp > link->getStatus()->getVirtualGanonOr())
            tmp = link->getStatus()->getVirtualGanonOr();
    ...
    case 817:
        ...
        if (tmp > link->getStatus()->getVirtualPieceOr())
            tmp = link->getStatus()->getVirtualPieceOr();
    ...
    case 1521:
    case 1525:
    case 1529: // vrai sur affirmations fausses
    case 1537:
    case 1545:
    case 1549:
    case 1557:
    ...
    case 1522:
    case 1526:
    case 1530: // faux sur affirmations fausses
    case 1538:
    case 1546:
    case 1550:
    case 1558:
    ...
    case 1533:
    case 1541:
    case 1553: // vrai sur affirmations vraies
    case 1573:
    case 1577:
    case 1585:
    case 1589:
    ...
    case 1534:
    case 1542:
    case 1554: // faux sur affirmations vraies
    case 1574:
    case 1578:
    case 1586:
    case 1590:
