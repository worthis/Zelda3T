...
void Troc::drawObjects()
{
    ...
    for (int i = 0; i < 16; i++)
    {
        if (inventory->getTroc(i) > -1)
        {
            ...
            {
            case 0:
                txt = inventory->getTroc(i) > 1 ? 1 : 2;
                break;
            case 1:
                txt = inventory->getTroc(i) > 1 ? 3 : 4;
                break;
            case 2:
                txt = inventory->getTroc(i) > 1 ? 5 : 6;
                break;
            case 3:
                txt = inventory->getTroc(i) > 1 ? 7 : 8;
                break;
            case 4:
                txt = inventory->getTroc(i) > 1 ? 9 : 10;
                break;
            case 5:
                txt = inventory->getTroc(i) > 1 ? 11 : 12;
                break;
            case 6:
                txt = inventory->getTroc(i) > 1 ? 13 : 14;
                break;
            case 7:
                txt = inventory->getTroc(i) > 1 ? 15 : 16;
                break;
            case 8:
                txt = inventory->getTroc(i) > 1 ? 17 : 18;
                break;
            case 9:
                txt = inventory->getTroc(i) > 1 ? 19 : 20;
                break;
            case 10:
                txt = inventory->getTroc(i) > 1 ? 21 : 22;
                break;
            case 11:
                txt = 23;
                break;
