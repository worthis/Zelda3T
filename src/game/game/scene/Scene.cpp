...
void Scene::init(Save *sv)
{
    ...
    if (map->getId() >= 46 && map->getId() < 61 && (map->getId() != 57 || avancement >= AV_TELE_ZELDA) && (map->getId() != 58 || link->getInventory()->hasObject(TRIFORCE)))
    {
...
void Scene::saveData()
{
    ...
    int tmp = 0;
    if (map->getId() == 26)
    { // reset position barque
        tmp = getCoffre(0, 5);
        setCoffre(0, 5, map->getOldBarque());
    }
    if (map->getId() == 68)
    { // reset position wagon
        tmp = getCoffre(0, 14);
...
void Scene::handleActions(Action *action)
{
    ...
    case SCENE_MAIN:
        ...
        if (link->getStatus()->getVirtualLife() > 0 && action->isAction(DISPLAY_MAP) && (map->getId() < 61 || map->getId() == 156) && (map->getId() != 57 || avancement >= AV_TELE_ZELDA) && (map->getId() != 58 || link->getInventory()->hasObject(TRIFORCE)))
        {
...
void Scene::draw()
{
    ...
    else if (map->getId() >= 16 && map->getId() < 31 && avancement >= AV_PORTAIL_PRE_PRESENT_UTILISE && avancement < AV_PORTAIL_PRE_PRESENT_FERME)
    {
...
int Scene::nbGemmeForce()
{
    ...
    case 2:
        ...
        break;
    case 3:
        total = nbGemmeForce(2) + nbGemmeForce(4) + nbGemmeForce(5) + nbGemmeForce(9) + nbGemmeForce(11) + nbGemmeForce(14) + nbGemmeForce(128) + nbGemmeForce(129) + nbGemmeForce(130) + nbGemmeForce(131) + nbGemmeForce(132) + nbGemmeForce(133) + nbGemmeForce(134) + nbGemmeForce(135) + nbGemmeForce(136);
        break;
    case 4:
    ...
    case 9:
        ...
        break;
    case 10:
        total = nbGemmeForce(9) + nbGemmeForce(11) + nbGemmeForce(137) + nbGemmeForce(138) + nbGemmeForce(139) + nbGemmeForce(140) + nbGemmeForce(141) + nbGemmeForce(142) + nbGemmeForce(143);
        break;
    case 11:
        total = nbGemmeForce(3) + nbGemmeForce(9) + nbGemmeForce(10) + nbGemmeForce(12) + nbGemmeForce(54) + nbGemmeForce(127);
        break;
    case 12:
        total = nbGemmeForce(1) + nbGemmeForce(2) + nbGemmeForce(11) + nbGemmeForce(52) + nbGemmeForce(76);
        break;
    case 13:
        total = nbGemmeForce(1) + nbGemmeForce(14) + nbGemmeForce(15) + nbGemmeForce(144) + nbGemmeForce(145) + nbGemmeForce(146) + nbGemmeForce(147) + nbGemmeForce(148) + nbGemmeForce(149);
        break;
    case 14:
        total = nbGemmeForce(2) + nbGemmeForce(3) + nbGemmeForce(4) + nbGemmeForce(13) + nbGemmeForce(15) + nbGemmeForce(125) + nbGemmeForce(153);
        break;
    case 15:
    ...
    case 17:
        ...
        break;
    case 18:
        total = nbGemmeForce(17) + nbGemmeForce(19) + nbGemmeForce(20) + nbGemmeForce(24) + nbGemmeForce(26) + nbGemmeForce(29) + nbGemmeForce(80) + nbGemmeForce(81) + nbGemmeForce(82) + nbGemmeForce(83) + nbGemmeForce(84) + nbGemmeForce(85) + nbGemmeForce(86) + nbGemmeForce(87) + nbGemmeForce(88) + nbGemmeForce(89);
        break;
    case 19:
    ...
    case 20:
        ...
        break;
    case 21:
        total = nbGemmeForce(20) + nbGemmeForce(22) + nbGemmeForce(24) + nbGemmeForce(62) + nbGemmeForce(63) + nbGemmeForce(64) + nbGemmeForce(69) + nbGemmeForce(150);
        break;
    case 22:
        total = nbGemmeForce(20) + nbGemmeForce(21) + nbGemmeForce(23) + nbGemmeForce(46) + nbGemmeForce(65) + nbGemmeForce(90) + nbGemmeForce(91) + nbGemmeForce(92);
        break;
    case 23:
    ...
    case 24:
        ...
        break;
    case 25:
        total = nbGemmeForce(24) + nbGemmeForce(26) + nbGemmeForce(93) + nbGemmeForce(94) + nbGemmeForce(95) + nbGemmeForce(96) + nbGemmeForce(97) + nbGemmeForce(98) + nbGemmeForce(99) + nbGemmeForce(100);
        break;
    case 26:
        total = nbGemmeForce(18) + nbGemmeForce(24) + nbGemmeForce(25) + nbGemmeForce(27) + nbGemmeForce(47) + nbGemmeForce(101);
        break;
    case 27:
        total = nbGemmeForce(16) + nbGemmeForce(17) + nbGemmeForce(26) + nbGemmeForce(51) + nbGemmeForce(67);
        break;
    case 28:
        total = nbGemmeForce(16) + nbGemmeForce(29) + nbGemmeForce(30) + nbGemmeForce(102) + nbGemmeForce(103) + nbGemmeForce(104) + nbGemmeForce(105) + nbGemmeForce(106) + nbGemmeForce(107) + nbGemmeForce(108);
        break;
    case 29:
        total = nbGemmeForce(17) + nbGemmeForce(18) + nbGemmeForce(19) + nbGemmeForce(28) + nbGemmeForce(30) + nbGemmeForce(109) + nbGemmeForce(110) + nbGemmeForce(151);
        break;
    case 30:
    ...
    case 32:
        ...
        break;
    case 33:
        total = nbGemmeForce(32) + nbGemmeForce(34) + nbGemmeForce(35) + nbGemmeForce(39) + nbGemmeForce(41) + nbGemmeForce(44) + nbGemmeForce(117) + nbGemmeForce(118) + nbGemmeForce(119) + nbGemmeForce(120) + nbGemmeForce(121) + nbGemmeForce(122) + nbGemmeForce(123);
        break;
    case 34:
    ...
    case 43:
        ...
        break;
    case 44:
        total = nbGemmeForce(32) + nbGemmeForce(33) + nbGemmeForce(34) + nbGemmeForce(43) + nbGemmeForce(45) + nbGemmeForce(58) + nbGemmeForce(112) + nbGemmeForce(113) + nbGemmeForce(152);
        break;
    case 45:
    ...
    case 91:
    case 92:
        total = nbGemmeForce(22);
        break;
    case 47:
    case 101:
        total = nbGemmeForce(26);
        break;
    case 48:
    case 68:
        total = nbGemmeForce(30);
        break;
    case 49:
        total = nbGemmeForce(41);
        break;
    case 50:
        total = nbGemmeForce(42);
        break;
    case 51:
    case 67:
        total = nbGemmeForce(27);
        break;
    case 52:
    case 76:
        total = nbGemmeForce(12);
        break;
    case 53:
    case 74:
        total = nbGemmeForce(7);
        break;
    case 54:
    case 127:
        total = nbGemmeForce(11);
        break;
    case 55:
        total = nbGemmeForce(15);
        break;
    case 56:
        total = nbGemmeForce(4);
        break;
    case 57:
        total = nbGemmeForce(19);
        break;
    case 58:
    case 112:
    case 113:
    case 152:
        total = nbGemmeForce(44);
        break;
    case 61:
    case 79:
        total = nbGemmeForce(16);
        break;
    case 62:
    case 63:
    case 64:
    case 69:
    case 150:
        total = nbGemmeForce(21);
        break;
    case 66:
    case 111:
        total = nbGemmeForce(23);
        break;
    case 70:
        total = nbGemmeForce(36);
        break;
    case 71:
    case 116:
        total = nbGemmeForce(31);
        break;
    case 72:
    case 114:
        total = nbGemmeForce(38);
        break;
    case 73:
    case 115:
        total = nbGemmeForce(37);
        break;
    case 75:
    case 126:
        total = nbGemmeForce(1);
        break;
    case 77:
    case 78:
        total = nbGemmeForce(6);
        break;
    case 80:
    case 81:
    case 82:
    ...
    case 107:
    case 108:
        total = nbGemmeForce(28);
        break;
    case 109:
    case 110:
    case 151:
        total = nbGemmeForce(29);
        break;
    case 117:
    case 118:
    case 119:
    ...
    case 122:
    case 123:
        total = nbGemmeForce(33);
        break;
    case 124:
        total = nbGemmeForce(8);
        break;
    case 125:
    case 153:
        total = nbGemmeForce(14);
        break;
    case 128:
    case 129:
    case 130:
    ...
    case 148:
    case 149:
        total = nbGemmeForce(13);
        break;
    case 154:
        total = nbGemmeForce(9);
        break;
    case 155:
        total = nbGemmeForce(34);
        break;
    }
...
int Scene::nbGemmeForce(int mapId)
{
    ...
    case 1:
        total = 3;
        if (inventory->hasGemmeForce(6))
            current++;
        if (inventory->hasGemmeForce(7))
            current++;
        if (inventory->hasGemmeForce(8))
            current++;
        break;
    case 2:
        total = 3;
        if (inventory->hasGemmeForce(15))
            current++;
        if (inventory->hasGemmeForce(16))
            current++;
        if (inventory->hasGemmeForce(17))
            current++;
        break;
    case 3:
        total = 3;
        if (inventory->hasGemmeForce(21))
            current++;
        if (inventory->hasGemmeForce(22))
            current++;
        if (inventory->hasGemmeForce(23))
            current++;
        break;
    case 4:
        total = 2;
        if (inventory->hasGemmeForce(32))
            current++;
        if (inventory->hasGemmeForce(33))
            current++;
        break;
    case 5:
        total = 2;
        if (inventory->hasGemmeForce(40))
            current++;
        if (inventory->hasGemmeForce(41))
            current++;
        break;
    case 6:
        total = 2;
        if (inventory->hasGemmeForce(53))
            current++;
        if (inventory->hasGemmeForce(54))
            current++;
        break;
    case 7:
        total = 3;
        if (inventory->hasGemmeForce(62))
            current++;
        if (inventory->hasGemmeForce(63))
            current++;
        if (inventory->hasGemmeForce(64))
            current++;
        break;
    case 8:
        total = 3;
        if (inventory->hasGemmeForce(71))
            current++;
        if (inventory->hasGemmeForce(72))
            current++;
        if (inventory->hasGemmeForce(73))
            current++;
        break;
    case 9:
        total = 3;
        if (inventory->hasGemmeForce(82))
            current++;
        if (inventory->hasGemmeForce(83))
            current++;
        if (inventory->hasGemmeForce(84))
            current++;
        break;
    case 10:
        total = 5;
        if (inventory->hasGemmeForce(89))
            current++;
        if (inventory->hasGemmeForce(90))
            current++;
        if (inventory->hasGemmeForce(91))
            current++;
        if (inventory->hasGemmeForce(92))
            current++;
    ...
    case 11:
        total = 3;
        if (inventory->hasGemmeForce(102))
            current++;
        if (inventory->hasGemmeForce(103))
            current++;
        if (inventory->hasGemmeForce(104))
            current++;
        break;
    case 12:
        total = 3;
        if (inventory->hasGemmeForce(111))
            current++;
        if (inventory->hasGemmeForce(112))
            current++;
        if (inventory->hasGemmeForce(113))
            current++;
        break;
    case 13:
        total = 3;
        if (inventory->hasGemmeForce(119))
            current++;
        if (inventory->hasGemmeForce(120))
            current++;
        if (inventory->hasGemmeForce(121))
            current++;
        break;
    case 14:
        total = 3;
        if (inventory->hasGemmeForce(128))
            current++;
        if (inventory->hasGemmeForce(129))
            current++;
        if (inventory->hasGemmeForce(130))
            current++;
        break;
    case 15:
        total = 5;
        if (inventory->hasGemmeForce(141))
            current++;
        if (inventory->hasGemmeForce(142))
            current++;
        if (inventory->hasGemmeForce(143))
            current++;
        if (inventory->hasGemmeForce(144))
            current++;
        if (inventory->hasGemmeForce(145))
            current++;
        break;
    case 16:
        total = 4;
        if (inventory->hasGemmeForce(0))
            current++;
        if (inventory->hasGemmeForce(1))
            current++;
        if (inventory->hasGemmeForce(2))
            current++;
    ...
    case 17:
        total = 3;
        if (inventory->hasGemmeForce(9))
            current++;
        if (inventory->hasGemmeForce(10))
            current++;
    ...
    case 18:
        total = 2;
        if (inventory->hasGemmeForce(18))
            current++;
        if (inventory->hasGemmeForce(24))
            current++;
        break;
    case 19:
        total = 3;
        if (inventory->hasGemmeForce(26))
            current++;
        if (inventory->hasGemmeForce(27))
            current++;
        if (inventory->hasGemmeForce(28))
            current++;
        break;
    case 20:
        total = 3;
        if (inventory->hasGemmeForce(34))
            current++;
        if (inventory->hasGemmeForce(35))
            current++;
        if (inventory->hasGemmeForce(36))
            current++;
        break;
    case 21:
        total = 5;
        if (inventory->hasGemmeForce(42))
            current++;
        if (inventory->hasGemmeForce(43))
            current++;
        if (inventory->hasGemmeForce(44))
            current++;
        if (inventory->hasGemmeForce(45))
            current++;
        if (inventory->hasGemmeForce(46))
            current++;
        break;
    case 22:
        total = 3;
        if (inventory->hasGemmeForce(55))
            current++;
        if (inventory->hasGemmeForce(56))
            current++;
        if (inventory->hasGemmeForce(57))
            current++;
        break;
    case 23:
        total = 3;
        if (inventory->hasGemmeForce(65))
            current++;
        if (inventory->hasGemmeForce(66))
            current++;
        if (inventory->hasGemmeForce(67))
            current++;
        break;
    case 24:
        total = 4;
        if (inventory->hasGemmeForce(74))
            current++;
        if (inventory->hasGemmeForce(75))
            current++;
        if (inventory->hasGemmeForce(76))
            current++;
        if (inventory->hasGemmeForce(77))
            current++;
        break;
    case 25:
        total = 2;
        if (inventory->hasGemmeForce(85))
            current++;
        if (inventory->hasGemmeForce(86))
            current++;
        break;
    case 26:
        total = 3;
        if (inventory->hasGemmeForce(94))
            current++;
        if (inventory->hasGemmeForce(95))
            current++;
    ...
    case 27:
        total = 3;
        if (inventory->hasGemmeForce(105))
            current++;
        if (inventory->hasGemmeForce(106))
            current++;
        if (inventory->hasGemmeForce(107))
            current++;
        break;
    case 28:
        total = 3;
        if (inventory->hasGemmeForce(114))
            current++;
        if (inventory->hasGemmeForce(115))
            current++;
        if (inventory->hasGemmeForce(116))
            current++;
        break;
    case 29:
        total = 3;
        if (inventory->hasGemmeForce(122))
            current++;
        if (inventory->hasGemmeForce(123))
            current++;
        if (inventory->hasGemmeForce(124))
            current++;
        break;
    case 30:
        total = 5;
        if (inventory->hasGemmeForce(131))
            current++;
        if (inventory->hasGemmeForce(132))
            current++;
        if (inventory->hasGemmeForce(133))
            current++;
        if (inventory->hasGemmeForce(134))
            current++;
        if (inventory->hasGemmeForce(135))
            current++;
        break;
    case 31:
        total = 2;
        if (inventory->hasGemmeForce(4))
            current++;
        if (inventory->hasGemmeForce(5))
            current++;
        break;
    case 32:
        total = 3;
        if (inventory->hasGemmeForce(12))
            current++;
        if (inventory->hasGemmeForce(13))
            current++;
        if (inventory->hasGemmeForce(14))
            current++;
        break;
    case 33:
        total = 3;
    ...
    case 34:
        total = 3;
        if (inventory->hasGemmeForce(29))
            current++;
        if (inventory->hasGemmeForce(30))
            current++;
        if (inventory->hasGemmeForce(31))
            current++;
        break;
    case 35:
        total = 3;
    ...
    case 36:
        ...
        if (inventory->hasGemmeForce(47))
            current++;
        if (inventory->hasGemmeForce(48))
            current++;
        if (inventory->hasGemmeForce(49))
            current++;
        if (inventory->hasGemmeForce(50))
            current++;
        if (inventory->hasGemmeForce(51))
            current++;
        if (inventory->hasGemmeForce(52))
            current++;
        break;
    case 37:
        total = 4;
        if (inventory->hasGemmeForce(58))
            current++;
        if (inventory->hasGemmeForce(59))
            current++;
        if (inventory->hasGemmeForce(60))
            current++;
        if (inventory->hasGemmeForce(61))
            current++;
        break;
    case 38:
        total = 3;
        if (inventory->hasGemmeForce(68))
            current++;
        if (inventory->hasGemmeForce(69))
            current++;
        if (inventory->hasGemmeForce(70))
            current++;
        break;
    case 39:
        total = 4;
        if (inventory->hasGemmeForce(78))
            current++;
        if (inventory->hasGemmeForce(79))
            current++;
        if (inventory->hasGemmeForce(80))
            current++;
        if (inventory->hasGemmeForce(81))
            current++;
        break;
    case 40:
        total = 2;
        if (inventory->hasGemmeForce(87))
            current++;
        if (inventory->hasGemmeForce(88))
            current++;
        break;
    case 41:
        total = 5;
        if (inventory->hasGemmeForce(97))
            current++;
        if (inventory->hasGemmeForce(98))
            current++;
        if (inventory->hasGemmeForce(99))
            current++;
        if (inventory->hasGemmeForce(100))
            current++;
        if (inventory->hasGemmeForce(101))
            current++;
        break;
    case 42:
        total = 3;
        if (inventory->hasGemmeForce(108))
            current++;
        if (inventory->hasGemmeForce(109))
            current++;
        if (inventory->hasGemmeForce(110))
            current++;
        break;
    case 43:
        total = 2;
        if (inventory->hasGemmeForce(117))
            current++;
        if (inventory->hasGemmeForce(118))
            current++;
        break;
    case 44:
        total = 3;
        if (inventory->hasGemmeForce(125))
            current++;
        if (inventory->hasGemmeForce(126))
            current++;
        if (inventory->hasGemmeForce(127))
            current++;
        break;
    case 45:
        total = 5;
        if (inventory->hasGemmeForce(136))
            current++;
        if (inventory->hasGemmeForce(137))
            current++;
        if (inventory->hasGemmeForce(138))
            current++;
        if (inventory->hasGemmeForce(139))
            current++;
        if (inventory->hasGemmeForce(140))
            current++;
        break;
    case 46:
        total = 1;
        if (inventory->hasGemmeForce(185))
            current++;
        break;
    case 47:
        total = 1;
        if (inventory->hasGemmeForce(186))
            current++;
        break;
    case 48:
        total = 1;
        if (inventory->hasGemmeForce(187))
            current++;
        break;
    case 49:
        total = 1;
        if (inventory->hasGemmeForce(188))
            current++;
        break;
    case 50:
        total = 1;
        if (inventory->hasGemmeForce(189))
            current++;
        break;
    case 51:
        total = 1;
        if (inventory->hasGemmeForce(190))
            current++;
        break;
    case 52:
        total = 1;
        if (inventory->hasGemmeForce(191))
            current++;
        break;
    case 53:
        total = 1;
        if (inventory->hasGemmeForce(192))
            current++;
        break;
    case 54:
        total = 1;
        if (inventory->hasGemmeForce(193))
            current++;
        break;
    case 55:
        total = 1;
        if (inventory->hasGemmeForce(194))
            current++;
        break;
    case 56:
        total = 1;
    ...
    case 57:
        total = 2;
        if (inventory->hasGemmeForce(197))
            current++;
        if (inventory->hasGemmeForce(198))
            current++;
        break;
    case 58:
        total = 1;
        if (inventory->hasGemmeForce(199))
            current++;
        break;
    case 63:
        total = 1;
        if (inventory->hasGemmeForce(146))
            current++;
        break;
    case 66:
        total = 1;
        if (inventory->hasGemmeForce(148))
            current++;
        break;
    case 67:
        total = 1;
        if (inventory->hasGemmeForce(149))
            current++;
        break;
    case 68:
        total = 3;
        if (inventory->hasGemmeForce(150))
            current++;
        if (inventory->hasGemmeForce(151))
            current++;
        if (inventory->hasGemmeForce(152))
            current++;
        break;
    case 76:
        total = 1;
        if (inventory->hasGemmeForce(153))
            current++;
        break;
    case 77:
        total = 1;
        if (inventory->hasGemmeForce(154))
            current++;
        break;
    case 78:
        total = 2;
        if (inventory->hasGemmeForce(155))
            current++;
        if (inventory->hasGemmeForce(156))
            current++;
        break;
    case 80:
        total = 1;
        if (inventory->hasGemmeForce(157))
            current++;
        break;
    case 85:
        total = 1;
        if (inventory->hasGemmeForce(158))
            current++;
        break;
    case 88:
        total = 1;
        if (inventory->hasGemmeForce(159))
            current++;
        break;
    case 89:
        total = 3;
        if (inventory->hasGemmeForce(160))
            current++;
        if (inventory->hasGemmeForce(161))
            current++;
        if (inventory->hasGemmeForce(162))
            current++;
        break;
    case 90:
        total = 1;
        if (inventory->hasGemmeForce(163))
            current++;
        break;
    case 91:
        total = 1;
        if (inventory->hasGemmeForce(164))
            current++;
        break;
    case 92:
        total = 1;
        if (inventory->hasGemmeForce(165))
            current++;
        break;
    case 95:
        total = 1;
        if (inventory->hasGemmeForce(166))
            current++;
        break;
    case 101:
        total = 1;
        if (inventory->hasGemmeForce(167))
            current++;
        break;
    case 102:
        total = 1;
        if (inventory->hasGemmeForce(168))
            current++;
        break;
    case 103:
        total = 1;
        if (inventory->hasGemmeForce(169))
            current++;
        break;
    case 113:
        total = 1;
        if (inventory->hasGemmeForce(170))
            current++;
        break;
    case 116:
        total = 1;
        if (inventory->hasGemmeForce(172))
            current++;
        break;
    case 119:
        total = 1;
        if (inventory->hasGemmeForce(173))
            current++;
        break;
    case 120:
        total = 1;
        if (inventory->hasGemmeForce(174))
            current++;
        break;
    case 127:
        total = 1;
        if (inventory->hasGemmeForce(175))
            current++;
        break;
    case 130:
        total = 1;
        if (inventory->hasGemmeForce(176))
            current++;
        break;
    case 135:
        total = 1;
        if (inventory->hasGemmeForce(177))
            current++;
        break;
    case 137:
        total = 1;
        if (inventory->hasGemmeForce(178))
            current++;
        break;
    case 139:
        total = 1;
        if (inventory->hasGemmeForce(179))
            current++;
        break;
    case 140:
        total = 1;
        if (inventory->hasGemmeForce(180))
            current++;
        break;
    case 141:
        total = 1;
        if (inventory->hasGemmeForce(181))
            current++;
        break;
    case 145:
        total = 1;
        if (inventory->hasGemmeForce(182))
            current++;
        break;
    case 147:
        total = 1;
        if (inventory->hasGemmeForce(183))
            current++;
        break;
    case 154:
        total = 1;
        if (inventory->hasGemmeForce(184))
            current++;
        break;
    case 155:
        total = 3;
        if (inventory->hasGemmeForce(147))
            current++;
        if (inventory->hasGemmeForce(171))
            current++;
        if (inventory->hasGemmeForce(196))
            current++;
        break;
    }
