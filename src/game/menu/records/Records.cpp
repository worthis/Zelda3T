...
void Records::drawPage() {
    ...
    drawCadre(16, 48, 144, 32); drawCadre(176, 48, 32, 32); drawCadre(224, 48, 32, 32); drawCadre(272, 48, 32, 32);
    drawCadre(16, 96, 144, 32); drawCadre(176, 96, 32, 32); drawCadre(224, 96, 32, 32); drawCadre(272, 96, 32, 32);
    drawCadre(16, 144, 144, 32); drawCadre(176, 144, 32, 32); drawCadre(224, 144, 32, 32); drawCadre(272, 144, 32, 32);
