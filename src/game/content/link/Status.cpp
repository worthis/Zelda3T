...
{
    ganonOrToAdd += i;
    if (ganonOr + ganonOrToAdd > maxGanonOr)
        ganonOrToAdd = maxGanonOr - ganonOr;
}

void Status::updatePieceOr(int i)
{
    pieceOrToAdd += i;
    if (pieceOr + pieceOrToAdd > maxPieceOr)
        pieceOrToAdd = maxPieceOr - pieceOr;
}
