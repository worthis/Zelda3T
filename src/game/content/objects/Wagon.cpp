...
void Wagon::loop()
{
    ...
    else if (link->getAnimation() == WAGON)
    {
        ...
        {
            if (x + 4 < 31 * 16 && y + 10 == 23 * 16)
                moveE();
            else if (y + 10 > 13 * 16 && x + 4 == 31 * 16)
                moveN();
            else if (x + 4 < 34 * 16 && y + 10 == 13 * 16)
                moveE();

            else if (x + 4 < 45 * 16 && y + 10 == 13 * 16 && scene->getCoffre(0, 13) == 0)
                moveE();
            else if (x + 4 < 49 * 16 && y + 10 == 13 * 16 && x + 4 >= 45 * 16)
                moveE();
            else if (y + 10 < 22 * 16 && x + 4 == 49 * 16)
                moveS();
            else if (x + 4 < 50 * 16 && y + 10 == 22 * 16)
                moveE();

            else if (x + 4 == 34 * 16 && y + 10 > 9 * 16 && scene->getCoffre(0, 13) == 1)
                moveN();
            else if (x + 4 < 41 * 16 && y + 10 == 9 * 16)
                moveE();
            else if (x + 4 < 45 * 16 && y + 10 == 9 * 16 && scene->getCoffre(0, 13) == 1)
                moveE();
            else if (y + 10 < 13 * 16 && x + 4 == 45 * 16)
                moveS();

            else if (x + 4 == 41 * 16 && y + 10 > 5 * 16 && scene->getCoffre(0, 13) == 0)
                moveN();
            else if (x + 4 > 30 * 16 && y + 10 == 5 * 16)
                moveW();
        ...
        {
            if (x + 4 > 49 * 16 && y + 10 == 22 * 16)
                moveW();
            else if (x + 4 == 49 * 16 && y + 10 > 13 * 16)
                moveN();
            else if (x + 4 > 45 * 16 && y + 10 == 13 * 16)
                moveW();

            else if (x + 4 > 34 * 16 && y + 10 == 13 * 16 && scene->getCoffre(0, 13) == 0)
                moveW();
            else if (x + 4 > 31 * 16 && y + 10 == 13 * 16 && x + 4 <= 34 * 16)
                moveW();
            else if (x + 4 == 31 * 16 && y + 10 < 23 * 16)
                moveS();
            else if (x + 4 > 29 * 16 && y + 10 == 23 * 16)
                moveW();
        ...
        else if (scene->getCoffre(0, 14) == 2)
        {
            ...
            if (x + 4 < 41 * 16 && y + 10 == 5 * 16)
                moveE();
            else if (x + 4 == 41 * 16 && y + 10 < 9 * 16)
                moveS();
            else if (x + 4 > 34 * 16 && y + 10 == 9 * 16)
                moveW();
            else if (x + 4 == 34 * 16 && y + 10 < 13 * 16)
                moveS();
            else if (x + 4 > 31 * 16 && y + 10 == 13 * 16)
                moveW();
            else if (x + 4 == 31 * 16 && y + 10 < 23 * 16)
                moveS();
            else if (x + 4 > 29 * 16 && y + 10 == 23 * 16)
    ...
    {
        if (direction == E && link->getX() < x + 4 + 16 * 2)
            link->setX(link->getX() + 2);
        if (direction == W && link->getX() > x + 4 - 16 * 2)
            link->setX(link->getX() - 2);
    }
    else
    {
