...
void Map::launch() {
    ...
    if (map == 26) oldBarque = scene->getCoffre(0, 5);
    if (map == 68) oldBarque = scene->getCoffre(0, 14);

    launchRoom();
}

void Map::launchRoom() {
    if (map >= 46) { // indoor only
        Scene* scene = MainController::getInstance()->getGameController()->getSceneController()->getScene();
        Link* link = scene->getLink();
        ...
        switch (map) {
            case 46 :
                ...
                if (bounds.getX() >= 320*13 && bounds.getX() <= 320*14
                    && bounds.getY() >= 240 && bounds.getY() <= 240*2) {
                    bounds.setX(320*13);
                    bounds.setY(240);
                    bounds.setW(640);
            ...
            case 57 :
                ...
                if ((bounds.getX() == 320*7 || bounds.getX() == 320*9) && bounds.getY() >= 240 && bounds.getY() <= 240*2) {
                    bounds.setY(240);
                    bounds.setH(480);
                    if (bounds.getX() == 320*7) AudioManager::getInstance()->playMusic(27);
                    break;
                }
                if (bounds.getX() == 320*3 && bounds.getY() >= 240*2 && bounds.getY() <= 240*3) {
                    bounds.setY(240*2);
                ...
                break;
            case 58 :
                if (jeuCasinoStarted != 3) jeuCasinoStarted = 0;
            ...
            case 59 :
                ...
                if ((bounds.getX() == 0 || bounds.getX() == 320*3 || bounds.getX() == 320*4 || bounds.getX() == 320*7
                      || bounds.getX() == 320*8 || bounds.getX() == 320*11 || bounds.getX() == 320*12 || bounds.getX() == 320*15)
                    && bounds.getY() >= 240 && bounds.getY() <= 240*2) {
                    bounds.setY(240);
                    bounds.setH(480);
                    break;
...
void Map::reset() {
    Scene* scene = MainController::getInstance()->getGameController()->getSceneController()->getScene();
    if (map == 26) scene->setCoffre(0, 5, oldBarque);
    if (map == 68) scene->setCoffre(0, 14, oldBarque);
    load();
    launch();
    Link* link = scene->getLink();
    testAnim(link->getX(), link->getY(), N, false); // BUG FIX: link bloqué si il revit sur une porte de maison
    ...
    switch (map) {
        ...
        case 50 :
            ...
            if (x == 89*16 && y == 56*16) {
                ...
                if (sound) AudioManager::getInstance()->playSound(TS_SURPRISE);
...
void Map::allumeTorche(int x, int y) { //1935 -> 1936
    Scene* scene = MainController::getInstance()->getGameController()->getSceneController()->getScene();
    switch (map) {
        case 48 :
            if (x == 37 && y == 50) scene->setCoffre(map - 45, 29, 1);
            if (x == 37 && y == 54) scene->setCoffre(map - 45, 30, 1);
            if (x == 68 && y == 27) scene->setCoffre(map - 45, 31, 1);
            if (x == 71 && y == 27) scene->setCoffre(map - 45, 32, 1);
            if (x == 69 && y == 41) scene->setCoffre(map - 45, 33, 1);
            if (x == 70 && y == 41) scene->setCoffre(map - 45, 34, 1);
            if (x == 109 && y == 7) scene->setCoffre(map - 45, 35, 1);
            if (x == 102 && y == 35) scene->setCoffre(map - 45, 36, 1);
            if (x == 102 && y == 39) scene->setCoffre(map - 45, 37, 1);
            if (x == 127 && y == 17) scene->setCoffre(map - 45, 38, 1);
            if (x == 132 && y == 17) scene->setCoffre(map - 45, 39, 1);
            if (x == 186 && y == 26) scene->setCoffre(map - 45, 40, 1);
            if (x == 191 && y == 49) scene->setCoffre(map - 45, 41, 1);
            if (x == 191 && y == 34) scene->setCoffre(map - 45, 42, 1);
            if (x == 196 && y == 34) scene->setCoffre(map - 45, 43, 1);
            if (x == 207 && y == 24) scene->setCoffre(map - 45, 44, 1);
            if (x == 212 && y == 24) scene->setCoffre(map - 45, 45, 1);
            if (x == 204 && y == 35) scene->setCoffre(map - 45, 46, 1);
            if (x == 215 && y == 35) scene->setCoffre(map - 45, 47, 1);
            if (x == 206 && y == 51) scene->setCoffre(map - 45, 48, 1);
            if (x == 213 && y == 51) scene->setCoffre(map - 45, 49, 1);
            if (x == 224 && y == 20) scene->setCoffre(map - 45, 50, 1);
            if (x == 234 && y == 26) scene->setCoffre(map - 45, 51, 1);
            if (x == 229 && y == 37) scene->setCoffre(map - 45, 52, 1);
            if (x == 234 && y == 53) scene->setCoffre(map - 45, 53, 1);
            if (x == 227 && y == 56) scene->setCoffre(map - 45, 54, 1);
            if (x == 242 && y == 49) scene->setCoffre(map - 45, 55, 1);
            if (x == 242 && y == 55) scene->setCoffre(map - 45, 56, 1);
            if (x == 247 && y == 57) scene->setCoffre(map - 45, 57, 1);
            if (x == 252 && y == 57) scene->setCoffre(map - 45, 58, 1);

            if (x == 37 && (y == 50 || y == 54)
                && scene->getCoffre(map - 45, 29)
                && scene->getCoffre(map - 45, 30)
                && mur[40 * 2][52 * 2] == MUR) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                ouvrePorte(38, 51, 1);
            }
            if ((x == 68 || x == 71) && y == 27
                && scene->getCoffre(map - 45, 31)
                && scene->getCoffre(map - 45, 32)
                && mur[69 * 2 + 1][28 * 2 + 1] == MUR) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                ouvrePorte(69, 28, 0);
            }
            if ((x == 69 || x == 70) && y == 41
                && scene->getCoffre(map - 45, 33)
                && scene->getCoffre(map - 45, 34)
                && !nbCoffres()) {
            ...
            if (x == 102 && (y == 35 || y == 39)
                && scene->getCoffre(map - 45, 36)
                && scene->getCoffre(map - 45, 37)
                && mur[100 * 2][37 * 2] == MUR) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                ouvrePorte(98, 36, 1);
            }
            if ((x == 127 || x == 132) && y == 17
                && scene->getCoffre(map - 45, 38)
                && scene->getCoffre(map - 45, 39)
                && mur[129 * 2 + 1][13 * 2 + 1] == MUR) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                ouvrePorte(129, 13, 0);
            }
            if (((x == 186 && y == 26) || (x == 191 && (y == 49 || y == 34)) || (x == 196 && y == 34) || ((x == 207 || x == 212) && y == 24)
                 || ((x == 204 || x ==215) && y == 35) || ((x == 206 || x == 213) && y == 51) || (x == 224 && y == 20) || (x == 234 && y == 26)
                 || (x == 229 && y == 37) || (x == 234 && y == 53) || (x == 227 && y == 56))
                && scene->getCoffre(map - 45, 40) && scene->getCoffre(map - 45, 41) && scene->getCoffre(map - 45, 42) && scene->getCoffre(map - 45, 43)
                && scene->getCoffre(map - 45, 44) && scene->getCoffre(map - 45, 45) && scene->getCoffre(map - 45, 46) && scene->getCoffre(map - 45, 47)
                && scene->getCoffre(map - 45, 48) && scene->getCoffre(map - 45, 49) && scene->getCoffre(map - 45, 50) && scene->getCoffre(map - 45, 51)
                && scene->getCoffre(map - 45, 52) && scene->getCoffre(map - 45, 53) && scene->getCoffre(map - 45, 54)
                && mur[209 * 2 + 1][13 * 2 + 1] == MUR) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                ouvrePorte(209, 13, 0);
            }
            if (x == 242 && (y == 49 || y == 55)
                && scene->getCoffre(map - 45, 55)
                && scene->getCoffre(map - 45, 56)
                && mur[240 * 2][52 * 2] == MUR) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                ouvrePorte(238, 51, 1);
            }
            if ((x == 247 || x == 252) && y == 57
                && scene->getCoffre(map - 45, 57)
                && scene->getCoffre(map - 45, 58)
                && mur[249 * 2 + 1][58 * 2 + 1] == MUR) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                ouvrePorte(249, 58, 0);
            }
            break;
        case 49 :
            if (x == 222 && y == 21) scene->setCoffre(map - 45, 22, 1);
            if (x == 228 && y == 27) scene->setCoffre(map - 45, 23, 1);
            if (x == 231 && y == 27) scene->setCoffre(map - 45, 24, 1);
            if (x == 237 && y == 19) scene->setCoffre(map - 45, 25, 1);
            if (x == 222 && y == 9) scene->setCoffre(map - 45, 26, 1);
            if (x == 230 && y == 2) scene->setCoffre(map - 45, 27, 1);
            if (x == 237 && y == 5) scene->setCoffre(map - 45, 28, 1);
            if (x == 237 && y == 9) scene->setCoffre(map - 45, 29, 1);
            if (x == 117 && y == 35) scene->setCoffre(map - 45, 31, 1);
            if (x == 117 && y == 39) scene->setCoffre(map - 45, 32, 1);
            if (scene->getCoffre(map - 45, 22) && scene->getCoffre(map - 45, 23) && scene->getCoffre(map - 45, 24) && scene->getCoffre(map - 45, 25)
                && scene->getCoffre(map - 45, 26) && scene->getCoffre(map - 45, 27) && scene->getCoffre(map - 45, 28) && scene->getCoffre(map - 45, 29)
                && mur[240 * 2][7 * 2] == MUR) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                ouvrePorte(238, 6, 1);
            }
            ...
            break;
        case 54 :
            if (x == 102 && y == 71) scene->setCoffre(map - 45, 36, 1);
            if (x == 115 && y == 62) scene->setCoffre(map - 45, 37, 1);
            if (x == 127 && y == 62) scene->setCoffre(map - 45, 38, 1);
            if (x == 135 && y == 62) scene->setCoffre(map - 45, 39, 1);
            if (x == 133 && y == 76) scene->setCoffre(map - 45, 40, 1);
            if (x == 107 && y == 80) scene->setCoffre(map - 45, 41, 1);
            if (x == 102 && y == 86) scene->setCoffre(map - 45, 42, 1);
            if (x == 107 && y == 86) scene->setCoffre(map - 45, 43, 1);
            if (x == 130 && y == 86) scene->setCoffre(map - 45, 44, 1);
            if (x == 135 && y == 83) scene->setCoffre(map - 45, 45, 1);
            if (scene->getCoffre(map - 45, 36) && scene->getCoffre(map - 45, 37) && scene->getCoffre(map - 45, 38) && scene->getCoffre(map - 45, 39)
                && scene->getCoffre(map - 45, 40) && scene->getCoffre(map - 45, 41) && scene->getCoffre(map - 45, 42) && scene->getCoffre(map - 45, 43)
                && scene->getCoffre(map - 45, 44) && scene->getCoffre(map - 45, 45) && mur[129 * 2 + 1][58 * 2 + 1] == MUR) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                ouvrePorte(129, 58, 0);
            }
            break;
        case 55 :
            if (x == 47 && y == 57) scene->setCoffre(map - 45, 19, 1);
            if (x == 52 && y == 57) scene->setCoffre(map - 45, 20, 1);
            if (x == 106 && y == 15) scene->setCoffre(map - 45, 21, 1);
            if (x == 115 && y == 2) scene->setCoffre(map - 45, 22, 1);
            if (x == 119 && y == 10) scene->setCoffre(map - 45, 23, 1);
            if (x == 119 && y == 22) scene->setCoffre(map - 45, 24, 1);
            if (x == 136 && y == 4) scene->setCoffre(map - 45, 25, 1);
            if (x == 134 && y == 17) scene->setCoffre(map - 45, 26, 1);
            if (x == 24 && y == 102) scene->setCoffre(map - 45, 27, 1);
            if (x == 35 && y == 102) scene->setCoffre(map - 45, 28, 1);
            if (x == 55 && y == 104) scene->setCoffre(map - 45, 29, 1);
            if (x == 66 && y == 104) scene->setCoffre(map - 45, 30, 1);
            if (x == 73 && y == 104) scene->setCoffre(map - 45, 31, 1);
            if (x == 84 && y == 104) scene->setCoffre(map - 45, 32, 1);
            if (x == 58 && y == 112) scene->setCoffre(map - 45, 33, 1);
            if (x == 81 && y == 112) scene->setCoffre(map - 45, 34, 1);
            if (x == 55 && y == 119) scene->setCoffre(map - 45, 35, 1);
            if (x == 66 && y == 119) scene->setCoffre(map - 45, 36, 1);
            if (x == 73 && y == 119) scene->setCoffre(map - 45, 37, 1);
            if (x == 84 && y == 119) scene->setCoffre(map - 45, 38, 1);
            if (x == 108 && y == 122) scene->setCoffre(map - 45, 39, 1);
            if (x == 111 && y == 122) scene->setCoffre(map - 45, 40, 1);
            if (x == 108 && y == 132) scene->setCoffre(map - 45, 41, 1);
            if (x == 111 && y == 132) scene->setCoffre(map - 45, 42, 1);
            if (x == 97 && y == 152) scene->setCoffre(map - 45, 43, 1);
            if (x == 97 && y == 162) scene->setCoffre(map - 45, 44, 1);
            if (x == 6 && y == 201) scene->setCoffre(map - 45, 45, 1);
            if (x == 27 && y == 201) scene->setCoffre(map - 45, 46, 1);
            if (x == 30 && y == 201) scene->setCoffre(map - 45, 47, 1);
            if (x == 14 && y == 219) scene->setCoffre(map - 45, 48, 1);
            if (x == 23 && y == 213) scene->setCoffre(map - 45, 49, 1);
            if (x == 27 && y == 220) scene->setCoffre(map - 45, 50, 1);
            if (scene->getCoffre(map - 45, 19) && scene->getCoffre(map - 45, 20) && mur[49 * 2 + 1][58 * 2 + 1] == MUR) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                ouvrePorte(49, 58, 0);
            }
            if (scene->getCoffre(map - 45, 21) && scene->getCoffre(map - 45, 22) && scene->getCoffre(map - 45, 23)
                && scene->getCoffre(map - 45, 24) && scene->getCoffre(map - 45, 25) && scene->getCoffre(map - 45, 26) && mur[100 * 2][7 * 2] == MUR) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                ouvrePorte(98, 6, 1);
            }
            ...
            if (scene->getCoffre(map - 45, 29) && scene->getCoffre(map - 45, 30) && scene->getCoffre(map - 45, 31) && scene->getCoffre(map - 45, 32)
                && scene->getCoffre(map - 45, 33) && scene->getCoffre(map - 45, 34) && scene->getCoffre(map - 45, 35) && scene->getCoffre(map - 45, 36)
                && scene->getCoffre(map - 45, 37) && scene->getCoffre(map - 45, 38) && mur[69 * 2 + 1][88 * 2 + 1] == MUR) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                ouvrePorte(69, 88, 0);
            }
            if (scene->getCoffre(map - 45, 39) && scene->getCoffre(map - 45, 40) && scene->getCoffre(map - 45, 41)
                && scene->getCoffre(map - 45, 42) && mur[100 * 2][127 * 2] == MUR) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                ouvrePorte(98, 126, 1);
            }
            ...
            if (scene->getCoffre(map - 45, 45) && scene->getCoffre(map - 45, 46) && scene->getCoffre(map - 45, 47)
                && scene->getCoffre(map - 45, 48) && scene->getCoffre(map - 45, 49) && scene->getCoffre(map - 45, 50) && mur[40 * 2][202 * 2] == MUR) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                ouvrePorte(38, 201, 1);
            }
            break;
...
void Map::eteintTorche(int x, int y) { //1936 -> 1935
    Scene* scene = MainController::getInstance()->getGameController()->getSceneController()->getScene();
    switch (map) {
        case 54 :
        ...
        for (int i = x; i < x + w; i++) {
            if (mur[i * 2][j * 2] == TROU) {
                if (mur[(i-1) * 2][(j-1) * 2] == TROU && mur[i * 2][(j-1) * 2] == TROU && mur[(i+1) * 2][(j-1) * 2] == TROU
                    ...
                    if (mur[(i+1) * 2][(j+1) * 2] != TROU) setSol(i * 16, j * 16, 5080 + offset);
                    if (mur[(i-1) * 2][(j+1) * 2] != TROU) setSol(i * 16, j * 16, 5081 + offset);
                    if (mur[(i+1) * 2][(j-1) * 2] != TROU) setSol(i * 16, j * 16, 5082 + offset);
                    if (mur[(i-1) * 2][(j-1) * 2] != TROU) setSol(i * 16, j * 16, 5083 + offset);
                }
            }
        }
    }
...
int Map::getMotif(int value) {
    ...
    switch (value) {
        ...
        case 415 : case 418 : case 1626 : case 1629 : case 1632 : case 1635 :
        case 1638 : case 1641 :  case 1644 : case 1647 : case 1650 : case 1653 :
        case 1656 : case 1659 : case 1794 : case 1797 : case 2309 : case 2312 :
        case 2315 : case 2334: case 2337: case 2340: case 2397 : case 2400 :
        case 2403 : case 2406 : case 2420 : case 2423 : case 2426 : case 2429 :
        case 2432 : case 2435 :  case 2438 : case 2441 : case 2624 : case 2627 :
        case 2875 : case 2878 : case 2881 : case 2884 : case 2887 : case 2890 :
        case 2893 : case 2896 : case 2899 : case 2902 : case 2905 : case 2908 :
            switch (tmp/2 % 3) {
                case 0 : return value;
            ...
            break;
        case 353 : case 356 : case 1662 : case 1665 : case 1936 : case 4876 :
            switch (tmp % 4) {
                case 0 : return value;
                case 1 : return value + 1;
                case 2 : return value + 2;
        ...
        case 2634 : case 2635 :
            ...
            break;
        case 2912 : case 3079 : case 3082 : case 3085 : case 3088 : case 3091 : case 3094 :
            switch (tmp / 2 % 4) {
                case 0 : return value;
                case 1 : return value + 1;
                case 2 : return value + 2;
        ...
        case 3144 : // teleport
            ...
            break;
        // eau donjon
        case 3147 : case 3148 : case 3149 : case 3150 : case 3151 : case 3152 : case 3153 :
        case 3154 : case 3155 : case 3156 : case 3157 : case 3158 : case 3159 :
        case 4589 : case 4590 : case 4591 : case 4592 : case 4593 : case 4594 : case 4595 :
        case 4596 : case 4597 : case 4598 : case 4599 : case 4600 : case 4601 :
            switch (tmp / 2 % 3) {
                case 0 : return value;
            ...
            break;
        case 3100 : case 3101 : case 3102 : case 3103 : case 3104 : case 3105 : case 3106 :
        case 3107 : case 3108 : case 3109 : case 3110 : case 3111 : case 3112 :

        case 3727 : case 3728 : case 3729 : case 3730 : case 3731 : case 3732 : case 3733 :
        case 3734 : case 3735 : case 3736 : case 3737 : case 3738 : case 3739 :

        case 4339 : case 4340 : case 4341 : case 4342 : case 4343 : case 4344 : case 4345 :
        case 4346 : case 4347 : case 4348 : case 4349 : case 4350 : case 4351 :

        case 5883 : case 5884 : case 5885 : case 5886 : case 5887 : case 5888 : case 5889 :
        case 5890 : case 5891 : case 5892 : case 5893 : case 5894 : case 5895 :
            switch (tmp / 2 % 4) {
                case 0 : return value;
                case 1 : return value + 13;
                case 2 : return value + 26;
        ...
        case 4156 : // pics
            ...
            break;
        case 5299 : case 5303 : case 5307 : case 5311 :// tapis roulant
            switch (tmp % 4) {
                case 0 : return value;
                case 1 : return value + 1;
                case 2 : return value + 2;
...
bool Map::isOnWater(BoundingBox* bb) {
    ...
    for (int j = (y / 8) * 8; j < y + h; j += 8) {
        for (int i = (x / 8) * 8; i < x + w; i += 8) {
            if (getMur(i, j) != EAU_PROF) return false;
        }
    }
    return true;
}
...
bool Map::checkCollisions(BoundingBox* box, Collisionable* object, bool checkEnnemis, bool ignoreNotIdle, bool withAvoid, bool onlyBox, bool checkObjects,
    ...
    if (checkObjects) {
        ...
        while (obj.hasNext()) {
            ...
            if (talkableArea == 0) { // pas de collision avec les TalkableArea
        ...
        for (int i = beginX; i <= endX; i += CASE) {
            ...
            if (effect == TE_GLACE) {
                ...
                switch (val) {
                    ...
                    case 1794 : sol[x][y] = 73; mur[x * 2][y * 2 + 1] = GLACE; mur[x * 2 + 1][y * 2 + 1] = GLACE; break;
                    case 1797 : sol[x][y] = 74; mur[x * 2][y * 2 + 1] = GLACE; mur[x * 2 + 1][y * 2 + 1] = GLACE; break;
                    case 1936 : sol[x][y] = 1935; break; // torche
                    default : break;
                }
                if (val == 1936) eteintTorche(x, y);
            }
            ...
            if (type == TA_EXPLO) {
                if (val == 173 || val == 174 /*|| val == 1615*/ || val == 1772) { // plaine
                    // fissure
                    Scene* scene = MainController::getInstance()->getGameController()->getSceneController()->getScene();
                    AudioManager::getInstance()->playSound(TS_SURPRISE);
                    ...
                    ouvrePorte(58, 18, 0);
                } else if (val == 3055 || val == 3056 || val == 3057 || val == 3058) { // grottes
                    switch (map) {
                        case 69 :
                            Scene* scene = MainController::getInstance()->getGameController()->getSceneController()->getScene();
                            AudioManager::getInstance()->playSound(TS_SURPRISE);
...
bool Map::testBarque(int x, int y) {
    ...
    if (link->getAnimation() == BARQUE) {
        ...
        if ((x == 13 * 16 + 8 && y == 17 * 16 + 8 && b == 5) || (x == 32 * 16 + 8 && y == 56 * 16 + 8 && b == 4)
            || (x == 50 * 16 + 8 && y == 35 * 16 + 8 && b == 3) || (x == 76 * 16 + 8 && y == 53 * 16 + 8 && b == 2)
            || (x == 105 * 16 + 8 && y == 28 * 16 + 8 && b == 1) || (x == 118 * 16 + 8 && y == 47 * 16 + 8 && b == 0)) {
...
bool Map::testInnerTransition(int x, int y) {
    if (map < 46) return false;
    Scene* scene = MainController::getInstance()->getGameController()->getSceneController()->getScene();
    if (map == 55 && bounds.getX() == 320 * 3 && bounds.getY() == 240 * 2) return false;
...
bool Map::testTeleport(int x, int y) {
    ...
    switch (map) {
        ...
        case 21 :
            ...
            break;
        case 22 :
            if (((x == 18 * 16 + 8 && y == 29 * 16 + 8) || (x == 50 * 16 + 8 && y == 34 * 16))
                && scene->getAvancement() >= AV_PORTAIL_PRE_PRESENT_UTILISE
        ...
        case 46 :
            ...
            // escaliers
            if ((x == 89 * 16 + 8 && y == 51 * 16) || (x == 109 * 16 + 8 && y == 21 * 16)
                || (x == 129 * 16 + 8 && y == 36 * 16) || (x == 146 * 16 + 8 && y == 21 * 16)
                || (x == 149 * 16 + 8 && y == 6 * 16) || (x == 169 * 16 + 8 && y == 6 * 16)
                || (x == 197 * 16 + 8 && y == 29 * 16) || (x == 229 * 16 + 8 && y == 36 * 16)
                || (x == 229 * 16 + 8 && y == 51 * 16) || (x == 232 * 16 + 8 && y == 21 * 16)
                || (x == 249 * 16 + 8 && y == 51 * 16) || (x == 281 * 16 + 8 && y == 29 * 16)
                || (x == 309 * 16 + 8 && y == 6 * 16)) {
                teleport->setTeleport(46, x - 80 * 16, y + 24, S, false, false, true);
                AudioManager::getInstance()->playSound(TS_ESCALIERS_DOWN);
                return true;
            }
            if ((x == 9 * 16 + 8 && y == 51 * 16) || (x == 29 * 16 + 8 && y == 21 * 16)
                || (x == 49 * 16 + 8 && y == 36 * 16) || (x == 66 * 16 + 8 && y == 21 * 16)
                || (x == 69 * 16 + 8 && y == 6 * 16) || (x == 89 * 16 + 8 && y == 6 * 16)
                || (x == 117 * 16 + 8 && y == 29 * 16) || (x == 149 * 16 + 8 && y == 36 * 16)
                || (x == 149 * 16 + 8 && y == 51 * 16) || (x == 152 * 16 + 8 && y == 21 * 16)
                || (x == 169 * 16 + 8 && y == 51 * 16) || (x == 201 * 16 + 8 && y == 29 * 16)
                || (x == 229 * 16 + 8 && y == 6 * 16)) {
        ...
        case 47 :
            ...
            // escaliers
            if ((x == 29 * 16 + 8 && y == 65 * 16) || (x == 69 * 16 + 8 && y == 5 * 16)
                || (x == 109 * 16 + 8 && y == 35 * 16) || (x == 129 * 16 + 8 && y == 66 * 16)
                || (x == 189 * 16 + 8 && y == 21 * 16) || (x == 229 * 16 + 8 && y == 51 * 16)) {
                teleport->setTeleport(47, x + 120 * 16, y + 24, S, false, false, true);
                AudioManager::getInstance()->playSound(TS_ESCALIERS_DOWN);
                return true;
            }
            if ((x == 149 * 16 + 8 && y == 65 * 16) || (x == 189 * 16 + 8 && y == 5 * 16)
                || (x == 229 * 16 + 8 && y == 35 * 16) || (x == 249 * 16 + 8 && y == 66 * 16)
                || (x == 309 * 16 + 8 && y == 21 * 16) || (x == 349 * 16 + 8 && y == 51 * 16)) {
        ...
        case 48 :
            ...
            if (x >= 289 * 16 - 4 && x <= 289 * 16 + 4 && y >= 39 * 16 + 4 && y <= 40 * 16 - 4
                && link->getInventory()->hasMedaillon(2)) {
                teleport->setTeleport(48, 9 * 16, 16 * 31 + 8, S, false, false, true);
                AudioManager::getInstance()->playSound(TS_TELEPORT);
                return true;
            }
            // escaliers
            if ((x == 9 * 16 + 8 && y == 6 * 16) || (x == 9 * 16 + 8 && y == 66 * 16)
                || (x == 95 * 16 + 8 && y == 22 * 16) || (x == 129 * 16 + 8 && y == 6 * 16)
                || (x == 129 * 16 + 8 && y == 66 * 16)) {
                teleport->setTeleport(48, x + 140 * 16, y + 24, S, false, false, true);
                AudioManager::getInstance()->playSound(TS_ESCALIERS_DOWN);
                return true;
            }
            if ((x == 149 * 16 + 8 && y == 6 * 16) || (x == 149 * 16 + 8 && y == 66 * 16)
                || (x == 235 * 16 + 8 && y == 22 * 16) || (x == 269 * 16 + 8 && y == 6 * 16)
                || (x == 269 * 16 + 8 && y == 66 * 16)) {
        ...
        case 49 :
            ...
            // escaliers
            if ((x == 9 * 16 + 8 && y == 35 * 16) || (x == 29 * 16 + 8 && y == 6 * 16)
                || (x == 29 * 16 + 8 && y == 81 * 16) || (x == 49 * 16 + 8 && y == 6 * 16)
                || (x == 69 * 16 + 8 && y == 51 * 16) || (x == 69 * 16 + 8 && y == 66 * 16)
                || (x == 89 * 16 + 8 && y == 51 * 16) || (x == 129 * 16 + 8 && y == 6 * 16)
                || (x == 129 * 16 + 8 && y == 23 * 16) || (x == 130 * 16 + 8 && y == 81 * 16)) {
                teleport->setTeleport(49, x + 120 * 16, y + 24, S, false, false, true);
                AudioManager::getInstance()->playSound(TS_ESCALIERS_DOWN);
                return true;
            }
            if ((x == 129 * 16 + 8 && y == 35 * 16) || (x == 149 * 16 + 8 && y == 6 * 16)
                || (x == 149 * 16 + 8 && y == 81 * 16) || (x == 169 * 16 + 8 && y == 6 * 16)
                || (x == 189 * 16 + 8 && y == 51 * 16) || (x == 189 * 16 + 8 && y == 66 * 16)
                || (x == 209 * 16 + 8 && y == 51 * 16) || (x == 249 * 16 + 8 && y == 6 * 16)
                || (x == 249 * 16 + 8 && y == 23 * 16) || (x == 250 * 16 + 8 && y == 81 * 16)) {
        ...
        case 50 :
            ...
            if ((x == 89 * 16 + 8 && y == 21 * 16) || (x == 89 * 16 + 8 && y == 81 * 16)
                || (x == 129 * 16 + 8 && y == 66 * 16) || (x == 169 * 16 + 8 && y == 21 * 16)
                || (x == 169 * 16 + 8 && y == 81 * 16)) {
            ...
            if ((x == 209 * 16 + 8 && y == 21 * 16) || (x == 209 * 16 + 8 && y == 81 * 16)
                || (x == 249 * 16 + 8 && y == 66 * 16) || (x == 289 * 16 + 8 && y == 21 * 16)
                || (x == 289 * 16 + 8 && y == 81 * 16)) {
        ...
        case 51 :
            ...
            if ((x == 29 * 16 + 8 && y == 36 * 16) || (x == 49 * 16 + 8 && y == 66 * 16)
                || (x == 69 * 16 + 8 && y == 51 * 16)) {
                teleport->setTeleport(51, x + 80 * 16, y + 24, S, false, false, true);
                AudioManager::getInstance()->playSound(TS_ESCALIERS_DOWN);
                return true;
            }
            if ((x == 89 * 16 + 8 && y == 81 * 16) || (x == 169 * 16 + 8 && y == 66 * 16)
                || (x == 169 * 16 + 8 && y == 81 * 16)) {
            ...
            if ((x == 109 * 16 + 8 && y == 36 * 16) || (x == 129 * 16 + 8 && y == 66 * 16)
                || (x == 149 * 16 + 8 && y == 51 * 16)) {
                teleport->setTeleport(51, x - 80 * 16, y - 24, N, false, false, true);
                AudioManager::getInstance()->playSound(TS_ESCALIERS_UP);
                return true;
            }
            if ((x == 209 * 16 + 8 && y == 81 * 16) || (x == 289 * 16 + 8 && y == 66 * 16)
                || (x == 289 * 16 + 8 && y == 81 * 16)) {
        ...
        case 52 :
            ...
            if ((x == 29 * 16 + 8 && y == 36 * 16) || (x == 29 * 16 + 8 && y == 51 * 16)
                || (x == 49 * 16 + 8 && y == 66 * 16) || (x == 69 * 16 + 8 && y == 36 * 16)) {
                teleport->setTeleport(52, x + 80 * 16, y + 24, S, false, false, true);
                AudioManager::getInstance()->playSound(TS_ESCALIERS_DOWN);
                return true;
            }
            if ((x == 89 * 16 + 8 && y == 51 * 16) || (x == 89 * 16 + 8 && y == 81 * 16)
                || (x == 109 * 16 + 8 && y == 21 * 16)|| (x == 129 * 16 + 8 && y == 81 * 16)
                || (x == 149 * 16 + 8 && y == 51 * 16)|| (x == 169 * 16 + 8 && y == 21 * 16)
                || (x == 169 * 16 + 8 && y == 51 * 16)|| (x == 169 * 16 + 8 && y == 66 * 16)) {
            ...
            if ((x == 109 * 16 + 8 && y == 36 * 16) || (x == 109 * 16 + 8 && y == 51 * 16)
                || (x == 129 * 16 + 8 && y == 66 * 16) || (x == 149 * 16 + 8 && y == 36 * 16)) {
                teleport->setTeleport(52, x - 80 * 16, y - 24, N, false, false, true);
                AudioManager::getInstance()->playSound(TS_ESCALIERS_UP);
                return true;
            }
            if ((x == 209 * 16 + 8 && y == 51 * 16) || (x == 209 * 16 + 8 && y == 81 * 16)
                || (x == 229 * 16 + 8 && y == 21 * 16)|| (x == 249 * 16 + 8 && y == 81 * 16)
                || (x == 269 * 16 + 8 && y == 51 * 16)|| (x == 289 * 16 + 8 && y == 21 * 16)
                || (x == 289 * 16 + 8 && y == 51 * 16)|| (x == 289 * 16 + 8 && y == 66 * 16)) {
        ...
        case 53 :
            ...
            if ((x == 109 * 16 + 8 && y == 6 * 16) || (x == 149 * 16 + 8 && y == 21 * 16)
                || (x == 149 * 16 + 8 && y == 81 * 16)|| (x == 169 * 16 + 8 && y == 6 * 16)
                || (x == 169 * 16 + 8 && y == 36 * 16)|| (x == 199 * 16 + 8 && y == 29 * 16)
                || (x == 229 * 16 + 8 && y == 51 * 16)) {
            ...
            if ((x == 29 * 16 + 8 && y == 6 * 16) || (x == 69 * 16 + 8 && y == 21 * 16)
                || (x == 69 * 16 + 8 && y == 81 * 16)|| (x == 89 * 16 + 8 && y == 6 * 16)
                || (x == 89 * 16 + 8 && y == 36 * 16)|| (x == 119 * 16 + 8 && y == 29 * 16)
                || (x == 149 * 16 + 8 && y == 51 * 16)) {
        ...
        case 54 :
            ...
            // escaliers
            if ((x == 9 * 16 + 8 && y == 35 * 16) || (x == 29 * 16 + 8 && y == 51 * 16)
                || (x == 49 * 16 + 8 && y == 6 * 16)|| (x == 89 * 16 + 8 && y == 36 * 16)
                || (x == 109 * 16 + 8 && y == 6 * 16)) {
                teleport->setTeleport(54, x + 120 * 16, y + 24, S, false, false, true);
                AudioManager::getInstance()->playSound(TS_ESCALIERS_DOWN);
                return true;
            }
            if ((x == 129 * 16 + 8 && y == 35 * 16) || (x == 149 * 16 + 8 && y == 51 * 16)
                || (x == 169 * 16 + 8 && y == 6 * 16)|| (x == 209 * 16 + 8 && y == 36 * 16)
                || (x == 229 * 16 + 8 && y == 6 * 16)) {
        ...
        case 55 :
            ...
            // escaliers
            if ((x == 9 * 16 + 8 && y == 81 * 16) || (x == 9 * 16 + 8 && y == 216 * 16)
                || (x == 66 * 16 + 8 && y == 216 * 16)|| (x == 72 * 16 + 8 && y == 141 * 16)
                || (x == 129 * 16 + 8 && y == 81 * 16)|| (x == 129 * 16 + 8 && y == 216 * 16)) {
                teleport->setTeleport(55, x, y - 75 * 16 + 24, S, false, false, true);
                AudioManager::getInstance()->playSound(TS_ESCALIERS_DOWN);
                return true;
            }
            if ((x == 9 * 16 + 8 && y == 6 * 16) || (x == 9 * 16 + 8 && y == 141 * 16)
                || (x == 66 * 16 + 8 && y == 141 * 16)|| (x == 72 * 16 + 8 && y == 66 * 16)
                || (x == 129 * 16 + 8 && y == 6 * 16)|| (x == 129 * 16 + 8 && y == 141 * 16)) {
        ...
        case 57 :
            ...
            // escaliers
            if ((x == 49 * 16 + 8 && y == 51 * 16) || (x == 89 * 16 + 8 && y == 51 * 16)
                || (x == 49 * 16 + 8 && y == 156 * 16)) {
                teleport->setTeleport(57, x, y + 90 * 16 + 24, S, false, false, true);
                AudioManager::getInstance()->playSound(TS_ESCALIERS_DOWN);
                return true;
            }
            if ((x == 49 * 16 + 8 && y == 141 * 16) || (x == 89 * 16 + 8 && y == 141 * 16)
                || (x == 49 * 16 + 8 && y == 246 * 16)) {
        ...
        case 59 :
            ...
            // escaliers
            if ((x == 89 * 16 + 8 && y == 51 * 16) || (x == 169 * 16 + 8 && y == 36 * 16)
                || (x == 249 * 16 + 8 && y == 6 * 16)) {
                teleport->setTeleport(59, x - 80 * 16, y + 24, S, false, false, true);
                AudioManager::getInstance()->playSound(TS_ESCALIERS_DOWN);
                return true;
            }
            if ((x == 9 * 16 + 8 && y == 51 * 16) || (x == 89 * 16 + 8 && y == 36 * 16)
                || (x == 169 * 16 + 8 && y == 6 * 16)) {
        ...
        case 60 :
            ...
            // escaliers
            if ((x == 9 * 16 + 8 && y == 81 * 16) || (x == 129 * 16 + 8 && y == 81 * 16)
                || (x == 9 * 16 + 8 && y == 141 * 16) || (x == 129 * 16 + 8 && y == 141 * 16)) {
                teleport->setTeleport(60, x, y - 75 * 16 + 24, S, false, false, true);
                AudioManager::getInstance()->playSound(TS_ESCALIERS_DOWN);
                return true;
            }
            if ((x == 9 * 16 + 8 && y == 6 * 16) || (x == 129 * 16 + 8 && y == 6 * 16)
                || (x == 9 * 16 + 8 && y == 66 * 16) || (x == 129 * 16 + 8 && y == 66 * 16)) {
        ...
        case 64 :
            ...
            if (x >= 9 * 16 - 4 && x <= 10 * 16 + 4 && y <= 2 * 16 + 8
                && scene->getAvancement() >= AV_PORTAIL_F_OUVERT
                && scene->getAvancement() < AV_PORTAIL_F_UTILISE) {
        ...
        case 70 :
            ...
            if (x >= 9 * 16 - 4 && x <= 10 * 16 + 4 && y <= 2 * 16 + 8
                && scene->getAvancement() >= AV_PORTAIL_PRE_PRESENT_OUVERT
                && scene->getAvancement() < AV_PORTAIL_PRE_PRESENT_FERME) {
        ...
        case 150 :
            ...
            // escaliers
            if (((x == 23 * 16 + 8 || x == 35 * 16 + 8) && y == 18 * 16)
                || (x == 89 * 16 + 8 && y == 6 * 16)
                || (x == 149 * 16 + 8 && y == 36 * 16)) {
            ...
            if (((x == 83 * 16 + 8 || x == 95 * 16 + 8) && y == 18 * 16)
                || (x == 149 * 16 + 8 && y == 6 * 16)
                || (x == 209 * 16 + 8 && y == 36 * 16)) {
        ...
        case 156 :
            ...
            if ((x == 9 * 16 + 8 && y == 111 * 16) || (x == 49 * 16 + 8 && y == 21 * 16)
                || (x == 49 * 16 + 8 && y == 111 * 16) || (x == 69 * 16 + 8 && y == 6 * 16)
                || (x == 69 * 16 + 8 && y == 156 * 16) || (x == 89 * 16 + 8 && y == 81 * 16)
                || (x == 89 * 16 + 8 && y == 186 * 16) || (x == 109 * 16 + 8 && y == 156 * 16)
                || (x == 109 * 16 + 8 && y == 201 * 16) || (x == 149 * 16 + 8 && y == 111 * 16)
                || (x == 149 * 16 + 8 && y == 201 * 16) || (x == 169 * 16 + 8 && y == 21 * 16)
                || (x == 209 * 16 + 8 && y == 171 * 16) || (x == 229 * 16 + 8 && y == 6 * 16)
                || (x == 249 * 16 + 8 && y == 21 * 16) || (x == 249 * 16 + 8 && y == 81 * 16)
                || (x == 249 * 16 + 8 && y == 186 * 16) || (x == 269 * 16 + 8 && y == 81 * 16)) {
            ...
            if ((x == 9 * 16 + 8 && y == 186 * 16) || (x == 49 * 16 + 8 && y == 96 * 16)
                || (x == 49 * 16 + 8 && y == 186 * 16) || (x == 69 * 16 + 8 && y == 81 * 16)
                || (x == 69 * 16 + 8 && y == 231 * 16) || (x == 89 * 16 + 8 && y == 156 * 16)
                || (x == 89 * 16 + 8 && y == 261 * 16) || (x == 109 * 16 + 8 && y == 231 * 16)
                || (x == 109 * 16 + 8 && y == 276 * 16) || (x == 149 * 16 + 8 && y == 186 * 16)
                || (x == 149 * 16 + 8 && y == 276 * 16) || (x == 169 * 16 + 8 && y == 96 * 16)
                || (x == 209 * 16 + 8 && y == 246 * 16) || (x == 229 * 16 + 8 && y == 81 * 16)
                || (x == 249 * 16 + 8 && y == 96 * 16) || (x == 249 * 16 + 8 && y == 156 * 16)
                || (x == 249 * 16 + 8 && y == 261 * 16) || (x == 269 * 16 + 8 && y == 156 * 16)) {
...
void Map::testAnim(int x, int y, Direction dir, bool sound) {
    ...
    // open door
    if ((getSol(x, y + 8 - 1) == 468
         || getSol(x, y + 8 - 1) == 789 || getSol(x, y + 8 - 1) == 790
         || getSol(x, y + 8 - 1) == 1903 || getSol(x, y + 8 - 1) == 1904
         || getSol(x, y + 8 - 1) == 2276 || getSol(x, y + 8 - 1) == 2277) && dir == N) {
        ouvrePorteMaison(x, y);
        if (sound) AudioManager::getInstance()->playSound(TS_DOOR);
    }
    // open door dungeon
    if ((getSol(x, y + 8 - 1) == 1362 || getSol(x, y + 8 - 1) == 1363
         || getSol(x, y + 8 - 1) == 2826 || getSol(x, y + 8 - 1) == 2827) && dir == N) {
        ouvrePorte(x, y, 0);
        if (sound) AudioManager::getInstance()->playSound(TS_DOOR);
    }
    ...
    if (map >= 46 && map < 61) {
        ...
        if (scene->getCoffre(map - 45, 3)) {
            ...
            switch (map) {
                case 46 :
                    if (getSol(x, y + 7) == 3895 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 3897 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 3904 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 3909 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 47 :
                    if (getSol(x, y + 7) == 4102 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 4104 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 4111 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 4116 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 48 :
                    if (getSol(x, y + 7) == 4272 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 4274 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 4281 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 4286 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 49 :
                    if (getSol(x, y + 7) == 4512 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 4514 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 4521 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 4526 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 50 :
                    if (getSol(x, y + 7) == 4759 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 4761 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 4768 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 4773 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 51 :
                    if (getSol(x, y + 7) == 4988 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 4990 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 4997 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 5002 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 52 :
                    if (getSol(x, y + 7) == 5217 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 5219 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 5226 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 5231 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 53 :
                    if (getSol(x, y + 7) == 5420 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 5422 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 5429 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 5434 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 54 :
                    if (getSol(x, y + 7) == 5611 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 5613 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 5620 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 5625 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 55 :
                    if (getSol(x, y + 7) == 5802 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 5804 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 5811 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 5816 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 56 :
                    if (getSol(x, y + 7) == 6022 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 6024 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 6031 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 6036 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 57 :
                    if (getSol(x, y + 7) == 6326 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 6328 && dir == S) { i = x/16; j = (y + 24)/16;}
                    break;
                case 58 :
                    if (getSol(x, y + 7) == 6495 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 6497 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 6504 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 6509 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 59 :
                    if (getSol(x, y + 7) == 6652 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 6654 && dir == S) { i = x/16; j = (y + 24)/16;}
                    break;
                case 60 :
                    if (getSol(x - 1, y + 16) == 6794 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 6799 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
            }
            ...
            if (i != 0) {
                ...
                switch (map) {
                    case 46 :
                        if (bounds.getX() == 320*4 && bounds.getY() >= 240*2) k = 9;
                        else if (bounds.getX() <= 320*5 && bounds.getY() == 0) k = 10;
                        else if (bounds.getX() == 320*6) k = 11;
                        else if (bounds.getX() == 320*10) k = 12;
                        else k = 13;
                        break;
                    case 47 :
                        if (bounds.getX() == 320*6 && bounds.getY() == 240*5) k = 10;
                        else if (bounds.getX() == 320*7 && bounds.getY() == 240 * 4) k = 11;
                        else if (bounds.getX() == 320*9) k = 12;
                        else if (bounds.getX() == 320*10) k = 13;
                        else if (bounds.getX() == 320*13) k = 14;
                        else k = 15;
                        break;
                    case 48 :
                        if (x <= 70 * 16) k = 10;
                        else if (bounds.getX() == 320*3 && bounds.getY() == 240*4) k = 11;
                        else if (bounds.getX() == 320*5) k = 12;
                        else if (bounds.getX() == 320*8) k = 13;
                        else if (bounds.getX() == 320*11) k = 14;
                        else k = 15;
                        break;
                    case 49 :
                        if (bounds.getX() <= 320*2) k = 8;
                        else if (bounds.getX() == 320*3) k = 9;
                        else if (bounds.getX() == 320*6 && bounds.getY() == 240*3) k = 10;
                        else k = 11;
                        break;
                    case 50 :
                        if (bounds.getX() == 320*2) k = 8;
                        else if (bounds.getY() == 240*2) k = 9;
                        else if (bounds.getY() == 240*5) k = 10;
                        else k = 11;
                        break;
                    case 51 :
                        if (bounds.getX() == 320*4) k = 7;
                        else if (bounds.getX() == 320*5) k = 8;
                        else k = 9;
                        break;
                    case 52 :
                        if (bounds.getX() == 320*3) k = 8;
                        else if (bounds.getX() == 320*6 && x < 320 * 6 + 160) k = 9;
                        else if (bounds.getX() == 320*6 && x > 320 * 6 + 160) k = 10;
                        else k = 11;
                        break;
                    case 53 :
                        if (bounds.getY() == 240*3) k = 8;
                        else if (bounds.getX() == 320*5) k = 9;
                        else if (bounds.getX() == 320*7) k = 10;
                        else k = 11;
                        break;
                    case 54 :
                        if (bounds.getX() == 320) k = 13;
                        else if (bounds.getX() == 320 * 2 && bounds.getY() == 0) k = 14;
                        else if (bounds.getX() == 320 * 2 && bounds.getY() == 240*3) k = 15;
                        else if (bounds.getX() == 320 * 7) k = 16;
                        else if (bounds.getX() == 320 * 8) k = 17;
                        else if (bounds.getX() == 320*9 && x < 320 * 9 + 4 * 16) k = 18;
                        else if (bounds.getX() == 320*9 && x < 320 * 10) k = 19;
                        else if (bounds.getX() == 320*9 && x < 320 * 10 + 16 * 16) k = 20;
                        else k = 21;
                        break;
                    case 55 :
                        if (bounds.getY() < 240*5) k = 8;
                        else if (bounds.getY() == 240*5) k = 11;
                        else if (bounds.getY() < 240*10) k = 9;
                        else k = 10;
                        break;
                    case 56 :
                        if (bounds.getY() == 240) k = 7;
                        else if (bounds.getY() == 240*2) k = 8;
                        else k = 9;
                        break;
                    case 57 :
                        k = 7;
                        break;
                    case 58 :
                        if (bounds.getY() == 240*6) k = 9;
                        else if (bounds.getY() == 240*4) k = 10;
                        else if (bounds.getX() == 320*4) k = 11;
                        else if (bounds.getX() == 320*5) k = 12;
                        else k = 13;
                        break;
                    case 59 :
                        if (bounds.getX() == 320*5) k = 6;
                        else k = 7;
                        break;
                    case 60 :
                        k = 5;
        ...
        if (scene->getCoffre(map - 45, 2) == 1 && dir == N) {
            int value = false;
            switch (map) {
                case 46 : value = 3915; break;
                case 47 : value = 4122; break;
                case 48 : value = 4292; break;
                case 49 : value = 4552; break;
                case 50 : value = 4799; break;
                case 51 : value = 5028; break;
                case 52 : value = 5257; break;
                case 53 : value = 5460; break;
                case 54 : value = 5651; break;
                case 55 : value = 5842; break;
                case 56 : value = 6062; break;
                case 57 : value = 6175; break;
                case 58 : value = 6535; break;
                case 59 : value = 6680; break;
                case 60 : value = 6825; break;
            }
        ...
        if (scene->getCoffre(16, 3)) {
            ...
            if (getSol(x, y + 7) == 6135 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
            if (getSol(x, y + 24) == 6137 && dir == S) { i = x/16; j = (y + 24)/16;}
            if (getSol(x - 1, y + 16) == 6144 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
            if (getSol(x + 16, y + 16) == 6149 && dir == E) { i = (x+16)/16; j = y/16;}

            if (i != 0) {
                int k = 0;

                if (bounds.getY() == 240) k = 19;
                else if (bounds.getY() == 0) k = 20;
                else if (bounds.getY() == 240 * 7) k = 21;
                else if (bounds.getX() == 320 * 2 && bounds.getY() == 240 * 13) k = 22;
                else if (bounds.getX() == 320 && bounds.getY() == 240 * 13) k = 23;
                else if (bounds.getX() == 320 && bounds.getY() == 240 * 12) k = 24;
                else if (bounds.getX() == 320 && bounds.getY() == 240 * 11) k = 25;
                else if (bounds.getX() == 0 && bounds.getY() == 240 * 11) k = 26;
                else if (bounds.getX() == 0 && bounds.getY() == 240 * 10) k = 27;
                else if (bounds.getX() == 320 && bounds.getY() == 240 * 10) k = 28;
                else if (bounds.getX() == 320 * 2 && bounds.getY() == 240 * 10) k = 29;
                else if (bounds.getX() == 320 * 2 && bounds.getY() == 240 * 11) k = 30;
                else if (bounds.getX() == 320 * 3 && bounds.getY() == 240 * 11) k = 31;
                else if (bounds.getX() == 320 * 3 && bounds.getY() == 240 * 12) k = 32;
                else k = 33;
...
void Map::ouvrePorteMaison(int x, int y) {
    ...
    if (map == 4) {
        ...
        setSol(x, y + 8 - 1, 474); setMur(x, y + 8 - 1, MUR, SOL_BOIS, MUR, SOL_BOIS);
        setSol(x + 16, y + 8 - 1, 475); setMur(x + 16, y + 8 - 1, SOL_BOIS, MUR, SOL_BOIS, MUR);
    }
}
...
void Map::testAnimRoom() {
    ...
    switch (map) {
        case 46 :
            ...
            break;
        case 47 :
            if (bounds.getX() == 320*16 && bounds.getY() == 240*4 && !nbCoffres() && isCaisse(326*16, 71*16)
                && isCaisse(328*16, 70*16) && isCaisse(330*16, 72*16) && isCaisse(332*16, 64*16) && isCaisse(334*16, 66*16)) {
                AudioManager::getInstance()->playSound(TS_SURPRISE);
            ...
            if (bounds.getX() == 320 * 16 && bounds.getY() == 240 * 2 && !nbCoffres() && !nbCaissesMovable()
                && isCaisse(329*16, 38*16) && isCaisse(330*16, 37*16) && isCaisse(330*16, 35*16) && isCaisse(331*16, 35*16)
                && isCaisse(332*16, 35*16) && isCaisse(332*16, 36*16) && isCaisse(332*16, 37*16)) {
                AudioManager::getInstance()->playSound(TS_SURPRISE);
            ...
            if (bounds.getX() == 320 * 13 && bounds.getY() == 240 * 5 && mur[260 * 2][82 * 2] == MUR && !nbCaissesMovable()
                && isCaisse(268*16, 80*16) && isCaisse(268*16, 83*16) && isCaisse(269*16, 84*16) && isCaisse(270*16, 82*16)
                && isCaisse(270*16, 84*16) && isCaisse(271*16, 84*16) && isCaisse(272*16, 80*16) && isCaisse(272*16, 83*16)) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                ouvrePorte(258, 81, 1);
            }
            if (bounds.getX() == 320 * 16 && bounds.getY() == 0 && mur[340 * 2][7 * 2] == MUR && !nbCaissesMovable()
                && isCaisse(329*16, 6*16) && isCaisse(330*16, 6*16) && isCaisse(329*16, 7*16) && isCaisse(330*16, 7*16)
                && isCaisse(328*16, 5*16) && isCaisse(331*16, 5*16) && isCaisse(328*16, 8*16) && isCaisse(331*16, 8*16)) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                ouvrePorte(338, 6, 1);
            }
        ...
        case 54 :
            ...
            if (bounds.getX() == 320 * 4 && bounds.getY() == 240 * 5 && mur[100 * 2][82 * 2] == MUR && !nbCaissesMovable()
                && isCaisse(88*16, 83*16) && isCaisse(89*16, 84*16) && isCaisse(91*16, 82*16)) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                scene->setCoffre(9, 54, 1);
                ouvrePorte(98, 81, 1);
            }
            if (bounds.getX() == 320 * 11 && bounds.getY() == 240 * 3 && mur[229 * 2 + 1][58 * 2 + 1] == MUR && !nbCaissesMovable()
                && isCaisse(228*16, 51*16) && isCaisse(228*16, 53*16) && isCaisse(231*16, 51*16)) {
                AudioManager::getInstance()->playSound(TS_DOOR);
        ...
        case 55 :
            ...
            if (bounds.getX() == 320 * 2 && bounds.getY() == 240 && link->getX() >= 68 * 16 && link->getY() > 55 * 16
                && !link->getInventory()->hasCoeur(9) && mur[69 * 2 + 1][58 * 2 + 1] != MUR) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                fermePorte(69, 58, 0);
            }
            if (bounds.getX() == 320 * 3 && bounds.getY() == 240 * 2) {
            ...
            break;
        case 56 :
            if (!scene->getCoffre(11, 12)) break;
        ...
        case 57 :
            ...
            if (scene->getAvancement() < AV_TELE_ZELDA) break;
        ...
        case 137 :
            ...
            break;
        case 156 :
            if (bounds.getX() == 0 && bounds.getY() == 240 * 5 && mur[20 * 2][82 * 2] != PIERRE && !nbCaissesMovable()
                && isCaisse(8*16, 83*16) && isCaisse(9*16, 82*16) && isCaisse(9*16, 80*16) && isCaisse(10*16, 80*16)
                && isCaisse(11*16, 80*16) && isCaisse(11*16, 81*16) && isCaisse(11*16, 82*16)) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                ouvrePorte(18, 81, 1);
                scene->setCoffre(17, 37, 1);
            }
            if (bounds.getX() == 320 && bounds.getY() == 240 * 17 && mur[20 * 2][262 * 2] != PIERRE && !nbCaissesMovable()
                && isCaisse(27*16, 260*16) && isCaisse(27*16, 263*16) && isCaisse(28*16, 264*16) && isCaisse(29*16, 262*16)
                && isCaisse(29*16, 264*16) && isCaisse(30*16, 264*16) && isCaisse(31*16, 260*16) && isCaisse(31*16, 263*16)) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                ouvrePorte(18, 261, 1);
                scene->setCoffre(17, 40, 1);
            }
            if (bounds.getX() == 320 * 4 && bounds.getY() == 240 * 16 && mur[89 * 2 + 1][238 * 2 + 1] != PIERRE && !nbCaissesMovable()
                && isCaisse(90*16, 247*16) && nbCaisses() == 1) {
                AudioManager::getInstance()->playSound(TS_DOOR);
                ouvrePorte(89, 238, 0);
...
void Map::permuteBlocs(int step) {
    ...
    switch (map) { // orange = 624, blue = 625, +2 = up
        case 24 :
            if (step == 0) {
...
void Map::closeChests() {
    if (map == 89) {
        ...
        int nbGemmes = (link->getInventory()->hasGemmeForce(160) ? 0 : 1)
                + (link->getInventory()->hasGemmeForce(161) ? 0 : 1)
                + (link->getInventory()->hasGemmeForce(162) ? 0 : 1);
...
void Map::barque(bool visible) {
    ...
    if (visible) {
        setSol(a*16, (b-1)*16, 2624); setMur(a*16, (b-1)*16, MURRET, PIERRE, MURRET, SOL_BOIS);
        setSol((a+1)*16, (b-1)*16, 2627); setMur((a+1)*16, (b-1)*16, PIERRE, MURRET, SOL_BOIS, MURRET);

        setSol(a*16, b*16, 2630); setMur(a*16, b*16, MURRET, SOL_BOIS, MURRET, SOL_BOIS);
        setSol((a+1)*16, b*16, 2631); setMur((a+1)*16, b*16, SOL_BOIS, MURRET, SOL_BOIS, MURRET);
        setAir(a*16, b*16, 2632);
        setAir((a+1)*16, b*16, 2633);

        setSol(a*16, (b+1)*16, 2634); setMur(a*16, (b+1)*16, MURRET, MURRET, EAU_PROF, EAU_PROF);
        setSol((a+1)*16, (b+1)*16, 2635); setMur((a+1)*16, (b+1)*16, MURRET, MURRET, EAU_PROF, EAU_PROF);
    } else {
        setSol(a*16, (b-1)*16, 67); setMur(a*16, (b-1)*16, MURRET, PIERRE, EAU_PROF, EAU_PROF);
        setSol((a+1)*16, (b-1)*16, 70); setMur((a+1)*16, (b-1)*16, PIERRE, MURRET, EAU_PROF, EAU_PROF);
        setSol(a*16, b*16, 328, EAU_PROF); setAir(a*16, b*16, -1);
        setSol((a+1)*16, b*16, 328, EAU_PROF); setAir((a+1)*16, b*16, -1);
...
void Map::addWagon() {
    ...
    switch (scene->getCoffre(0, 14)) {
        case 0 : addObject(new Wagon(29 * 16, 23 * 16, E)); break;
        case 1 : addObject(new Wagon(50 * 16, 22 * 16, W)); break;
        case 2 : addObject(new Wagon(30 * 16, 5 * 16, E)); break;
    }
}
...
void Map::tigreFire(int x, int y) {
    // 1 -> selectionner un piege parmis les 3 opposés
    int current = (x == 240 * 16 ? 0 : 1) + (y == 23 * 16 ? 0 : 2);
    int randomValue = ((int)rand()) % 3;
    if (current <= randomValue) randomValue++;
...
void Map::activateStatue() {
    ...
    addEnnemi(new Ennemi119(45*16-3+8,93*16+5-8)); addEnnemi(new Ennemi119(86*16-3+8,49*16+5));
...
void Map::ouvrePorte(int x, int y, int type) {
    switch (map) {
        case 1 :
            ...
            sol[x][y+1]=1773;
            sol[x+1][y+1]=1774;
            mur[x * 2 + 1][y * 2 + 1] = NEIGE; mur[x * 2 + 2][y * 2 + 1] = NEIGE;
            mur[x * 2 + 1][y * 2 + 2] = NEIGE; mur[x * 2 + 2][y * 2 + 2] = NEIGE;
            mur[x * 2 + 1][y * 2 + 3] = NEIGE; mur[x * 2 + 2][y * 2 + 3] = NEIGE;
            break;
        case 14 : case 29 :
        ...
        case 15 :
            ...
            sol[121][36]=2947;
            sol[122][36]=2948; mur[122*2][36*2]=PIERRE; mur[122*2+1][36*2]=PIERRE;
            sol[123][36]=2949;
            break;
        case 18 :
            for (int i = 0; i < 3; i++) {
        ...
        case 37 :
            ...
            setSol(88 * 16, 10 * 16, 1, 1, 2495, HERBE); setAir(88*16, 10*16, 2497);
        ...
        case 45 :
            ...
            for (int i = 0; i < 16; i++) {mur[(99+9)*2+1][i]=MUR; mur[(99+9)*2+2][i]=MUR;}
            break;
        case 46 :
            if (type == 0) {
                sol[x][y]=3873; sol[x + 1][y]=3874;
                sol[x][y + 1]=3875; sol[x + 1][y + 1]=3876;
                sol[x][y + 2]=3867; sol[x + 1][y + 2]=3868;
                sol[x][y + 3]=3869; sol[x + 1][y + 3]=3870;
        ...
        case 47 :
            if (type == 0) {
                sol[x][y]=4080; sol[x + 1][y]=4081;
                sol[x][y + 1]=4082; sol[x + 1][y + 1]=4083;
                sol[x][y + 2]=4074; sol[x + 1][y + 2]=4075;
                sol[x][y + 3]=4076; sol[x + 1][y + 3]=4077;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
        ...
        case 48 :
            if (type == 0) {
                sol[x][y]=4250; sol[x + 1][y]=4251;
                sol[x][y + 1]=4252; sol[x + 1][y + 1]=4253;
                sol[x][y + 2]=4244; sol[x + 1][y + 2]=4245;
                sol[x][y + 3]=4246; sol[x + 1][y + 3]=4247;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y]=4392; sol[x + 1][y]=4393;
                sol[x][y + 1]=4394; sol[x + 1][y + 1]=4395; air[x][y + 1]=4396; air[x + 1][y + 1]=4397;
                sol[x][y + 2]=4386; sol[x + 1][y + 2]=4387; air[x][y + 2]=4390; air[x + 1][y + 2]=4391;
                sol[x][y + 3]=4388; sol[x + 1][y + 3]=4389;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
        ...
        case 49 :
            if (type == 0) {
                sol[x][y]=4491; sol[x + 1][y]=4492;
                sol[x][y + 1]=4493; sol[x + 1][y + 1]=4494; air[x][y + 1]=4556; air[x + 1][y + 1]=4557;
                sol[x][y + 2]=4486; sol[x + 1][y + 2]=4487; air[x][y + 2]=4554; air[x + 1][y + 2]=4555;
                sol[x][y + 3]=4488; sol[x + 1][y + 3]=4489;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=4507;
                sol[x+1][y]=4561;
                sol[x+1][y+1]=4506; air[x+1][y+1]=4562;
                sol[x+1][y+2]=4563;

                sol[x+2][y]=4558;
                sol[x+2][y+1]=4498; air[x+2][y+1]=4559;
                sol[x+2][y+2]=4560;
                sol[x+3][y]=4497;
                sol[x+3][y+1]=4499;
                sol[x+3][y+2]=4501;
        ...
        case 50 :
            if (type == 0) {
                sol[x][y]=4737; sol[x + 1][y]=4738;
                sol[x][y + 1]=4739; sol[x + 1][y + 1]=4740; air[x][y + 1]=4741; air[x + 1][y + 1]=4742;
                sol[x][y + 2]=4731; sol[x + 1][y + 2]=4732; air[x][y + 2]=4735; air[x + 1][y + 2]=4736;
                sol[x][y + 3]=4733; sol[x + 1][y + 3]=4734;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=4754;
                sol[x+1][y]=4751;
                sol[x+1][y+1]=4753; air[x+1][y+1]=4756;
                sol[x+1][y+2]=4755;

                sol[x+2][y]=4743;
                sol[x+2][y+1]=4745; air[x+2][y+1]=4749;
                sol[x+2][y+2]=4747;
                sol[x+3][y]=4744;
                sol[x+3][y+1]=4746;
                sol[x+3][y+2]=4748;
                ...
                sol[x][y]=4811; sol[x + 1][y]=4812;
                sol[x][y + 1]=4813; sol[x + 1][y + 1]=4814; air[x][y + 1]=4815; air[x + 1][y + 1]=4816;
                sol[x][y + 2]=4805; sol[x + 1][y + 2]=4806; air[x][y + 2]=4809; air[x + 1][y + 2]=4810;
                sol[x][y + 3]=4807; sol[x + 1][y + 3]=4808;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=4828;
                sol[x+1][y]=4825;
                sol[x+1][y+1]=4827; air[x+1][y+1]=4830;
                sol[x+1][y+2]=4829;

                sol[x+2][y]=4817;
                sol[x+2][y+1]=4819; air[x+2][y+1]=4823;
                sol[x+2][y+2]=4821;
                sol[x+3][y]=4818;
                sol[x+3][y+1]=4820;
                sol[x+3][y+2]=4822;
        ...
        case 51 :
            if (type == 0) {
                sol[x][y]=4966; sol[x + 1][y]=4967;
                sol[x][y + 1]=4968; sol[x + 1][y + 1]=4969; air[x][y + 1]=4970; air[x + 1][y + 1]=4971;
                sol[x][y + 2]=4960; sol[x + 1][y + 2]=4961; air[x][y + 2]=4964; air[x + 1][y + 2]=4965;
                sol[x][y + 3]=4962; sol[x + 1][y + 3]=4963;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=4983;
                sol[x+1][y]=4980;
                sol[x+1][y+1]=4982; air[x+1][y+1]=4985;
                sol[x+1][y+2]=4984;

                sol[x+2][y]=4972;
                sol[x+2][y+1]=4974; air[x+2][y+1]=4978;
                sol[x+2][y+2]=4976;
                sol[x+3][y]=4973;
                sol[x+3][y+1]=4975;
                sol[x+3][y+2]=4977;
                ...
                sol[x][y]=5040; sol[x + 1][y]=5041;
                sol[x][y + 1]=5042; sol[x + 1][y + 1]=5043; air[x][y + 1]=5044; air[x + 1][y + 1]=5045;
                sol[x][y + 2]=5034; sol[x + 1][y + 2]=5035; air[x][y + 2]=5038; air[x + 1][y + 2]=5039;
                sol[x][y + 3]=5036; sol[x + 1][y + 3]=5037;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=5057;
                sol[x+1][y]=5054;
                sol[x+1][y+1]=5056; air[x+1][y+1]=5059;
                sol[x+1][y+2]=5058;

                sol[x+2][y]=5046;
                sol[x+2][y+1]=5048; air[x+2][y+1]=5052;
                sol[x+2][y+2]=5050;
                sol[x+3][y]=5047;
                sol[x+3][y+1]=5049;
                sol[x+3][y+2]=5051;
        ...
        case 52 :
            if (type == 0) {
                sol[x][y]=5195; sol[x + 1][y]=5196;
                sol[x][y + 1]=5197; sol[x + 1][y + 1]=5198; air[x][y + 1]=5199; air[x + 1][y + 1]=5200;
                sol[x][y + 2]=5189; sol[x + 1][y + 2]=5190; air[x][y + 2]=5193; air[x + 1][y + 2]=5194;
                sol[x][y + 3]=5191; sol[x + 1][y + 3]=5192;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=5212;
                sol[x+1][y]=5209;
                sol[x+1][y+1]=5211; air[x+1][y+1]=5214;
                sol[x+1][y+2]=5213;

                sol[x+2][y]=5201;
                sol[x+2][y+1]=5203; air[x+2][y+1]=5207;
                sol[x+2][y+2]=5205;
                sol[x+3][y]=5202;
                sol[x+3][y+1]=5204;
                sol[x+3][y+2]=5206;
        ...
        case 53 :
            if (type == 0) {
                sol[x][y]=5398; sol[x + 1][y]=5399;
                sol[x][y + 1]=5400; sol[x + 1][y + 1]=5401; air[x][y + 1]=5402; air[x + 1][y + 1]=5403;
                sol[x][y + 2]=5392; sol[x + 1][y + 2]=5393; air[x][y + 2]=5396; air[x + 1][y + 2]=5397;
                sol[x][y + 3]=5394; sol[x + 1][y + 3]=5395;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=5415;
                sol[x+1][y]=5412;
                sol[x+1][y+1]=5414; air[x+1][y+1]=5417;
                sol[x+1][y+2]=5416;

                sol[x+2][y]=5404;
                sol[x+2][y+1]=5406; air[x+2][y+1]=5410;
                sol[x+2][y+2]=5408;
                sol[x+3][y]=5405;
                sol[x+3][y+1]=5407;
                sol[x+3][y+2]=5409;
        ...
        case 54 :
            if (type == 0) {
                sol[x][y]=5589; sol[x + 1][y]=5590;
                sol[x][y + 1]=5591; sol[x + 1][y + 1]=5592; air[x][y + 1]=5593; air[x + 1][y + 1]=5594;
                sol[x][y + 2]=5583; sol[x + 1][y + 2]=5584; air[x][y + 2]=5587; air[x + 1][y + 2]=5588;
                sol[x][y + 3]=5585; sol[x + 1][y + 3]=5586;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=5606;
                sol[x+1][y]=5603;
                sol[x+1][y+1]=5605; air[x+1][y+1]=5608;
                sol[x+1][y+2]=5607;

                sol[x+2][y]=5595;
                sol[x+2][y+1]=5597; air[x+2][y+1]=5601;
                sol[x+2][y+2]=5599;
                sol[x+3][y]=5596;
                sol[x+3][y+1]=5598;
                sol[x+3][y+2]=5600;
        ...
        case 55 :
            if (type == 0) {
                sol[x][y]=5780; sol[x + 1][y]=5781;
                sol[x][y + 1]=5782; sol[x + 1][y + 1]=5783; air[x][y + 1]=5784; air[x + 1][y + 1]=5785;
                sol[x][y + 2]=5774; sol[x + 1][y + 2]=5775; air[x][y + 2]=5778; air[x + 1][y + 2]=5779;
                sol[x][y + 3]=5776; sol[x + 1][y + 3]=5777;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=5797;
                sol[x+1][y]=5794;
                sol[x+1][y+1]=5796; air[x+1][y+1]=5799;
                sol[x+1][y+2]=5798;

                sol[x+2][y]=5786;
                sol[x+2][y+1]=5788; air[x+2][y+1]=5792;
                sol[x+2][y+2]=5790;
                sol[x+3][y]=5787;
                sol[x+3][y+1]=5789;
                sol[x+3][y+2]=5791;
                ...
                sol[x][y]=5930; sol[x + 1][y]=5931;
                sol[x][y + 1]=5932; sol[x + 1][y + 1]=5933; air[x][y + 1]=5934; air[x + 1][y + 1]=5935;
                sol[x][y + 2]=5924; sol[x + 1][y + 2]=5925; air[x][y + 2]=5928; air[x + 1][y + 2]=5929;
                sol[x][y + 3]=5926; sol[x + 1][y + 3]=5927;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
        ...
        case 56 :
            if (type == 0) {
                sol[x][y]=6000; sol[x + 1][y]=6001;
                sol[x][y + 1]=6002; sol[x + 1][y + 1]=6003; air[x][y + 1]=6004; air[x + 1][y + 1]=6005;
                sol[x][y + 2]=5994; sol[x + 1][y + 2]=5995; air[x][y + 2]=5998; air[x + 1][y + 2]=5999;
                sol[x][y + 3]=5996; sol[x + 1][y + 3]=5997;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=6017;
                sol[x+1][y]=6014;
                sol[x+1][y+1]=6016; air[x+1][y+1]=6019;
                sol[x+1][y+2]=6018;

                sol[x+2][y]=6006;
                sol[x+2][y+1]=6008; air[x+2][y+1]=6012;
                sol[x+2][y+2]=6010;
                sol[x+3][y]=6007;
                sol[x+3][y+1]=6009;
                sol[x+3][y+2]=6011;
        ...
        case 57 :
            if (type == 0) {
                if (y < 105) {
                    sol[x][y]=6113; sol[x + 1][y]=6114;
                    sol[x][y + 1]=6115; sol[x + 1][y + 1]=6116; air[x][y + 1]=6117; air[x + 1][y + 1]=6118;
                    sol[x][y + 2]=6107; sol[x + 1][y + 2]=6108; air[x][y + 2]=6111; air[x + 1][y + 2]=6112;
                    sol[x][y + 3]=6109; sol[x + 1][y + 3]=6110;
                } else {
                    sol[x][y]=6304; sol[x + 1][y]=6305;
                    sol[x][y + 1]=6306; sol[x + 1][y + 1]=6307; air[x][y + 1]=6308; air[x + 1][y + 1]=6309;
                    sol[x][y + 2]=6298; sol[x + 1][y + 2]=6299; air[x][y + 2]=6302; air[x + 1][y + 2]=6303;
                    sol[x][y + 3]=6300; sol[x + 1][y + 3]=6301;
                }
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                ...
                if (y < 105) {
                    ...
                    sol[x][y+2]=6130;
                    sol[x+1][y]=6127;
                    sol[x+1][y+1]=6129; air[x+1][y+1]=6132;
                    sol[x+1][y+2]=6131;

                    sol[x+2][y]=6119;
                    sol[x+2][y+1]=6121; air[x+2][y+1]=6125;
                    sol[x+2][y+2]=6123;
                    sol[x+3][y]=6120;
                    sol[x+3][y+1]=6122;
                    sol[x+3][y+2]=6124;
                    ...
                    sol[x][y+2]=6321;
                    sol[x+1][y]=6318;
                    sol[x+1][y+1]=6320; air[x+1][y+1]=6323;
                    sol[x+1][y+2]=6322;

                    sol[x+2][y]=6310;
                    sol[x+2][y+1]=6312; air[x+2][y+1]=6316;
                    sol[x+2][y+2]=6314;
                    sol[x+3][y]=6311;
                    sol[x+3][y+1]=6313;
                    sol[x+3][y+2]=6315;
                ...
                sol[x][y]=6374; sol[x + 1][y]=6375;
                sol[x][y + 1]=6376; sol[x + 1][y + 1]=6377; air[x][y + 1]=6378; air[x + 1][y + 1]=6379;
                sol[x][y + 2]=6368; sol[x + 1][y + 2]=6369; air[x][y + 2]=6372; air[x + 1][y + 2]=6373;
                sol[x][y + 3]=6370; sol[x + 1][y + 3]=6371;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                setSol(146 * 16, 16 * 2, 6105); setSol(147 * 16, 16 * 2, 6088);
                setSol(146 * 16, 16 * 3, 6084); setSol(147 * 16, 16 * 3, 6106);
                setMur(147 * 16, 16 * 2, MUR, PIERRE, MUR, PIERRE); setMur(147 * 16, 16 * 3, MUR, PIERRE, PIERRE, PIERRE);
                setSol(146 * 16, 0, 6091); setSol(147 * 16, 0, 6083);
                setSol(146 * 16, 16, 6087); setSol(147 * 16, 16, 6092);
                setMur(147 * 16, 16, MUR, MUR, MUR, PIERRE);
                setSol(148 * 16, 0, 6083);
                setSol(148 * 16, 16, 6084);
                setMur(148 * 16, 16, MUR, MUR, PIERRE, PIERRE);
                sol[149][0]=6107; sol[150][0]=6108; air[149][0]=6111; air[150][0]=6112;
                sol[149][1]=6109; sol[150][1]=6110;
                setMur(149 * 16, 0, MUR, PIERRE, MUR, PIERRE); setMur(150 * 16, 0, PIERRE, MUR, PIERRE, MUR);
                setMur(149 * 16, 16, MUR, PIERRE, PIERRE, PIERRE); setMur(150 * 16, 16, PIERRE, MUR, PIERRE, PIERRE);
                setSol(151 * 16, 0, 6083);
                setSol(151 * 16, 16, 6084);
                setMur(151 * 16, 16, MUR, MUR, PIERRE, PIERRE);
                setSol(152 * 16, 0, 6083); setSol(153 * 16, 0, 6094);
                setSol(152 * 16, 16, 6093); setSol(153 * 16, 16, 6090);
                setMur(152 * 16, 16, MUR, MUR, PIERRE, MUR);
                setSol(152 * 16, 16 * 2, 6089); setSol(153 * 16, 16 * 2, 6104);
                setSol(152 * 16, 16 * 3, 6103); setSol(153 * 16, 16 * 3, 6084);
                setMur(152 * 16, 16 * 2, PIERRE, MUR, PIERRE, MUR); setMur(152 * 16, 16 * 3, PIERRE, MUR, PIERRE, PIERRE);
            }
            break;
        case 58 :
            if (type == 0) {
                sol[x][y]=6473; sol[x + 1][y]=6474;
                sol[x][y + 1]=6475; sol[x + 1][y + 1]=6476; air[x][y + 1]=6477; air[x + 1][y + 1]=6478;
                sol[x][y + 2]=6467; sol[x + 1][y + 2]=6468; air[x][y + 2]=6471; air[x + 1][y + 2]=6472;
                sol[x][y + 3]=6469; sol[x + 1][y + 3]=6470;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=6490;
                sol[x+1][y]=6487;
                sol[x+1][y+1]=6489; air[x+1][y+1]=6492;
                sol[x+1][y+2]=6491;

                sol[x+2][y]=6479;
                sol[x+2][y+1]=6481; air[x+2][y+1]=6485;
                sol[x+2][y+2]=6483;
                sol[x+3][y]=6480;
                sol[x+3][y+1]=6482;
                sol[x+3][y+2]=6484;
                ...
                sol[x][y+2]=6550;
                sol[x+1][y]=6547;
                sol[x+1][y+1]=6549; air[x+1][y+1]=6552;
                sol[x+1][y+2]=6551;

                sol[x+2][y]=6539;
                sol[x+2][y+1]=6541; air[x+2][y+1]=6545;
                sol[x+2][y+2]=6543;
                sol[x+3][y]=6540;
                sol[x+3][y+1]=6542;
                sol[x+3][y+2]=6544;
        ...
        case 59 :
            if (type == 0) {
                sol[x][y]=6630; sol[x + 1][y]=6631;
                sol[x][y + 1]=6632; sol[x + 1][y + 1]=6633; air[x][y + 1]=6634; air[x + 1][y + 1]=6635;
                sol[x][y + 2]=6624; sol[x + 1][y + 2]=6625; air[x][y + 2]=6628; air[x + 1][y + 2]=6629;
                sol[x][y + 3]=6626; sol[x + 1][y + 3]=6627;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=6647;
                sol[x+1][y]=6644;
                sol[x+1][y+1]=6646; air[x+1][y+1]=6649;
                sol[x+1][y+2]=6648;

                sol[x+2][y]=6636;
                sol[x+2][y+1]=6638; air[x+2][y+1]=6642;
                sol[x+2][y+2]=6640;
                sol[x+3][y]=6637;
                sol[x+3][y+1]=6639;
                sol[x+3][y+2]=6641;
        ...
        case 60 :
            if (type == 0) {
                sol[x][y]=6763; sol[x + 1][y]=6764;
                sol[x][y + 1]=6765; sol[x + 1][y + 1]=6766; air[x][y + 1]=6767; air[x + 1][y + 1]=6768;
                sol[x][y + 2]=6757; sol[x + 1][y + 2]=6758; air[x][y + 2]=6761; air[x + 1][y + 2]=6762;
                sol[x][y + 3]=6759; sol[x + 1][y + 3]=6760;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=6780;
                sol[x+1][y]=6777;
                sol[x+1][y+1]=6779; air[x+1][y+1]=6782;
                sol[x+1][y+2]=6781;

                sol[x+2][y]=6769;
                sol[x+2][y+1]=6771; air[x+2][y+1]=6775;
                sol[x+2][y+2]=6773;
                sol[x+3][y]=6770;
                sol[x+3][y+1]=6772;
                sol[x+3][y+2]=6774;
            ...
            break;
        case 63 : case 67 : case 68 : case 137 : // grottes
            if (type == 0) {
                sol[x][y]=2981; sol[x + 1][y]=2982;
                sol[x][y + 1]=2983; sol[x + 1][y + 1]=2984;
                sol[x][y + 2]=2975; sol[x + 1][y + 2]=2976;
                sol[x][y + 3]=2977; sol[x + 1][y + 3]=2978;
        ...
        case 154 :
            if (type == 0) {
                ...
                sol[x][y+2]=3608;
                sol[x+1][y]=3605;
                sol[x+1][y+1]=3607; air[x+1][y+1]=3610;
                sol[x+1][y+2]=3609;

                sol[x+2][y]=2987;
                sol[x+2][y+1]=2989; air[x+2][y+1]=2993;
                sol[x+2][y+2]=2991;
                sol[x+3][y]=2988;
                sol[x+3][y+1]=2990;
                sol[x+3][y+2]=2992;
        ...
        case 155 :
            if (type == 0) {
                sol[x][y]=3706; sol[x + 1][y]=3707;
                sol[x][y + 1]=3708; sol[x + 1][y + 1]=3709; air[x][y + 1]=3710; air[x + 1][y + 1]=3711;
                sol[x][y + 2]=3700; sol[x + 1][y + 2]=3701; air[x][y + 2]=3704; air[x + 1][y + 2]=3705;
                sol[x][y + 3]=3702; sol[x + 1][y + 3]=3703;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
        ...
        case 156 :
            if (type == 0) {
                ...
                sol[x][y]=6967; sol[x + 1][y]=6968;
                sol[x][y + 1]=6969; sol[x + 1][y + 1]=6970; air[x][y + 1]=6971; air[x + 1][y + 1]=6972;
                sol[x][y + 2]=6961; sol[x + 1][y + 2]=6962; air[x][y + 2]=6965; air[x + 1][y + 2]=6966;
                sol[x][y + 3]=6963; sol[x + 1][y + 3]=6964;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=6984;
                sol[x+1][y]=6981;
                sol[x+1][y+1]=6983; air[x+1][y+1]=6986;
                sol[x+1][y+2]=6985;

                sol[x+2][y]=6973;
                sol[x+2][y+1]=6975; air[x+2][y+1]=6979;
                sol[x+2][y+2]=6977;
                sol[x+3][y]=6974;
                sol[x+3][y+1]=6976;
                sol[x+3][y+2]=6978;
...
void Map::fermePorte(int x, int y, int type) {
    switch (map) {
        case 46 :
            if (type == 0) {
                sol[x][y]=3921; sol[x + 1][y]=3922;
                sol[x][y + 1]=3923; sol[x + 1][y + 1]=3924;
                sol[x][y + 2]=3917; sol[x + 1][y + 2]=3918;
                sol[x][y + 3]=3919; sol[x + 1][y + 3]=3920;
        ...
        case 47 :
            if (type == 0) {
                sol[x][y]=4128; sol[x + 1][y]=4129;
                sol[x][y + 1]=4130; sol[x + 1][y + 1]=4131;
                sol[x][y + 2]=4124; sol[x + 1][y + 2]=4125;
                sol[x][y + 3]=4126; sol[x + 1][y + 3]=4127;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
                ...
                sol[x][y]=4138; sol[x+1][y]=4139;
                sol[x][y+1]=4140; sol[x+1][y+1]=4141;
                sol[x][y+2]=4142; sol[x+1][y+2]=4143;
                sol[x+2][y]=4132; sol[x+3][y]=4133;
                sol[x+2][y+1]=4134; sol[x+3][y+1]=4135;
                sol[x+2][y+2]=4136; sol[x+3][y+2]=4137;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
        ...
        case 48 :
            if (type == 0) {
                sol[x][y]=4298; sol[x + 1][y]=4299;
                sol[x][y + 1]=4300; sol[x + 1][y + 1]=4301;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
        ...
        case 49 :
            if (type == 0) {
                sol[x][y]=4534; sol[x + 1][y]=4535;
                sol[x][y + 1]=4536; sol[x + 1][y + 1]=4537;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
        ...
        case 50 :
            if (type == 0) {
                sol[x][y]=4781; sol[x + 1][y]=4782;
                sol[x][y + 1]=4783; sol[x + 1][y + 1]=4784;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
        ...
        case 51 :
            if (type == 0) {
                sol[x][y]=5010; sol[x + 1][y]=5011;
                sol[x][y + 1]=5012; sol[x + 1][y + 1]=5013;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
                ...
                sol[x][y]=5020; sol[x+1][y]=5021;
                sol[x][y+1]=5022; sol[x+1][y+1]=5023;
                sol[x][y+2]=5024; sol[x+1][y+2]=5025;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 3][y * 2 + 2] = MUR; mur[x * 2 + 4][y * 2 + 2] = MUR;
                mur[x * 2 + 3][y * 2 + 3] = MUR; mur[x * 2 + 4][y * 2 + 3] = MUR;
        ...
        case 52 :
            if (type == 0) {
                sol[x][y]=5239; sol[x + 1][y]=5240;
                sol[x][y + 1]=5241; sol[x + 1][y + 1]=5242;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
        ...
        case 53 :
            if (type == 0) {
                sol[x][y]=5442; sol[x + 1][y]=5443;
                sol[x][y + 1]=5444; sol[x + 1][y + 1]=5445;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
                ...
                sol[x][y]=5452; sol[x+1][y]=5453;
                sol[x][y+1]=5454; sol[x+1][y+1]=5455;
                sol[x][y+2]=5456; sol[x+1][y+2]=5457;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 3][y * 2 + 2] = MUR; mur[x * 2 + 4][y * 2 + 2] = MUR;
                mur[x * 2 + 3][y * 2 + 3] = MUR; mur[x * 2 + 4][y * 2 + 3] = MUR;
        ...
        case 54 :
            if (type == 0) {
                sol[x][y]=5633; sol[x + 1][y]=5634;
                sol[x][y + 1]=5635; sol[x + 1][y + 1]=5636;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
                ...
                sol[x+2][y]=5637; sol[x+3][y]=5638;
                sol[x+2][y+1]=5639; sol[x+3][y+1]=5640;
                sol[x+2][y+2]=5641; sol[x+3][y+2]=5642;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 3][y * 2 + 2] = MUR; mur[x * 2 + 4][y * 2 + 2] = MUR;
                mur[x * 2 + 3][y * 2 + 3] = MUR; mur[x * 2 + 4][y * 2 + 3] = MUR;
        ...
        case 55 :
            if (type == 0) {
                sol[x][y]=5824; sol[x + 1][y]=5825;
                sol[x][y + 1]=5826; sol[x + 1][y + 1]=5827;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
                ...
                sol[x+2][y]=5828; sol[x+3][y]=5829;
                sol[x+2][y+1]=5830; sol[x+3][y+1]=5831;
                sol[x+2][y+2]=5832; sol[x+3][y+2]=5833;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 3][y * 2 + 2] = MUR; mur[x * 2 + 4][y * 2 + 2] = MUR;
                mur[x * 2 + 3][y * 2 + 3] = MUR; mur[x * 2 + 4][y * 2 + 3] = MUR;
        ...
        case 56 :
            if (type == 0) {
                sol[x][y]=6044; sol[x + 1][y]=6045;
                sol[x][y + 1]=6046; sol[x + 1][y + 1]=6047;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
                ...
                sol[x][y]=6054; sol[x+1][y]=6055;
                sol[x][y+1]=6056; sol[x+1][y+1]=6057;
                sol[x][y+2]=6058; sol[x+1][y+2]=6059;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 3][y * 2 + 2] = MUR; mur[x * 2 + 4][y * 2 + 2] = MUR;
                mur[x * 2 + 3][y * 2 + 3] = MUR; mur[x * 2 + 4][y * 2 + 3] = MUR;
        ...
        case 57 :
            if (y < 105) {
                sol[x][y]=6157; sol[x + 1][y]=6158;
                sol[x][y + 1]=6159; sol[x + 1][y + 1]=6160;
            } else {
                sol[x][y]=6336; sol[x + 1][y]=6337;
                sol[x][y + 1]=6338; sol[x + 1][y + 1]=6339;
            }
            mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
            mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
            mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
        ...
        case 58 :
            if (type == 0) {
                sol[x][y]=6517; sol[x + 1][y]=6518;
                sol[x][y + 1]=6519; sol[x + 1][y + 1]=6520;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
        ...
        case 59 :
            if (type == 0) {
                sol[x][y]=6662; sol[x + 1][y]=6663;
                sol[x][y + 1]=6664; sol[x + 1][y + 1]=6665;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
        ...
        case 60 :
            if (type == 0) {
                sol[x][y]=6807; sol[x + 1][y]=6808;
                sol[x][y + 1]=6809; sol[x + 1][y + 1]=6810;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
        ...
        case 137 :
            if (type == 0) {
                sol[x][y]=3025; sol[x + 1][y]=3026;
                sol[x][y + 1]=3027; sol[x + 1][y + 1]=3028;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
        ...
        case 154 :
            if (type == 0) {
                sol[x+2][y]=3626; sol[x + 3][y]=3627;
                sol[x+2][y + 1]=3628; sol[x + 3][y + 1]=3629;
                sol[x+2][y + 2]=3630; sol[x + 3][y + 2]=3631;
                mur[(x+2) * 2][(y+1) * 2] = MUR; mur[(x+2) * 2 + 1][(y+1) * 2] = MUR; mur[(x+2) * 2 + 2][(y+1) * 2] = MUR;
                mur[(x+2) * 2][(y+1) * 2+1] = MUR; mur[(x+2) * 2 + 1][(y+1) * 2+1] = MUR; mur[(x+2) * 2 + 2][(y+1) * 2+1] = MUR;
            } else if (type == 1) {
        ...
        case 156 :
            if (type == 0) {
                sol[x][y]=6157; sol[x + 1][y]=6158;
                sol[x][y + 1]=6159; sol[x + 1][y + 1]=6160;
                sol[x][y + 2]=6153; sol[x + 1][y + 2]=6154;
                sol[x][y + 3]=6155; sol[x + 1][y + 3]=6156;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
                ...
                sol[x][y]=6167; sol[x+1][y]=6168;
                sol[x][y+1]=6169; sol[x+1][y+1]=6170;
                sol[x][y+2]=6171; sol[x+1][y+2]=6172;
                sol[x+2][y]=6161; sol[x+3][y]=6162;
                sol[x+2][y+1]=6163; sol[x+3][y+1]=6164;
                sol[x+2][y+2]=6165; sol[x+3][y+2]=6166;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 3][y * 2 + 2] = MUR; mur[x * 2 + 4][y * 2 + 2] = MUR;
                mur[x * 2 + 3][y * 2 + 3] = MUR; mur[x * 2 + 4][y * 2 + 3] = MUR;
...
void Map::removeStele() {
    if ((map != 64 && map < 151) || map > 153) return;
...
void Map::startJeuCasino() {
    ...
    if (bounds.getX() == 320 && bounds.getY() == 240 * 4) {
        ...
        while (list.hasNext()) {
            ...
            if (dices != 0) dices->activer(true);
        }
    } else if (bounds.getX() == 320 * 2 && bounds.getY() == 0) {
        if (jeuCasinoStarted == 2) { // retry 421 en gardant ceux ok
            bool value4 = false;
            bool value2 = false;
            bool value1 = false;
            List list;
            ...
            while (list.hasNext()) {
                ...
                if (dices != 0 && !dices->isActif()) {
                    if (dices->getValue() == 3) {
                        if (value4) dices->activer(true);
                        else value4 = true;
                    } else if (dices->getValue() == 1) {
                        if (value2) dices->activer(true);
                        else value2 = true;
                    } else if (dices->getValue() == 0) {
                        if (value1) dices->activer(true);
                        else value1 = true;
                    } else {
                        dices->activer(true);
                    }
...
bool Map::isJeuCasinoGagne() {
    if (map != 58) return false;
    if (jeuCasinoStarted == 1) { // jeu 1 : 4 signes differents
        bool signe[4];
        for (int i = 0; i < 4; i++) signe[i] = false;
        List list;
        objects->get(&bounds, &list);
        list.iterateOnFirst();
        while (list.hasNext()) {
            Dices* dices = dynamic_cast<Dices*>(list.getNext());
            if (dices != 0) {
                if (dices->isActif()) return false;
                signe[dices->getValue()] = true;
            }
        }
        for (int i = 0; i < 4; i++) if (!signe[i]) return false;
        return true;
    } if (jeuCasinoStarted == 2) { // jeu 2 : 421
        bool value4 = false;
        bool value2 = false;
        bool value1 = false;
        List list;
        ...
        while (list.hasNext()) {
            ...
            if (dices != 0) {
                if (dices->isActif()) return false;
                if (dices->getValue() == 3) value4 = true;
                else if (dices->getValue() == 1) value2 = true;
                else if (dices->getValue() == 0) value1 = true;
                else return false;
            }
        }
        return value4 && value2 && value1;
    } if (jeuCasinoStarted == 4) { // jeu 4 : risk
    ...
    } if (jeuCasinoStarted == 5) { // jeu 5 : 1 or 6
        List list;
        objects->get(&bounds, &list);
        list.iterateOnFirst();
        while (list.hasNext()) {
            Dices* dices = dynamic_cast<Dices*>(list.getNext());
            if (dices != 0 && !dices->isActif()) {
                if ((choixCasino && dices->getValue() == 0) || (!choixCasino && dices->getValue() == 5)) return true;
            }
        }
    } if (jeuCasinoStarted == 6) { // jeu caisses
...
bool Map::isJeuCasinoFini() {
    if (map != 58 || jeuCasinoStarted == 0) return false;
    if (jeuCasinoStarted == 1 || jeuCasinoStarted == 2 || jeuCasinoStarted == 4 || jeuCasinoStarted == 7) {
        ...
        while (list.hasNext()) {
            Dices* dices = dynamic_cast<Dices*>(list.getNext());
            if (dices != 0 && dices->isActif()) return false;
        }
...
int Map::getTotalDices(int i, int j, int w, int h) {
    ...
    while (list.hasNext()) {
        Dices* dices = dynamic_cast<Dices*>(list.getNext());
        if (dices != 0 && !dices->isActif()) total += (1 + dices->getValue());
    }
    return total;
}
...
bool Map::bossCasinoVaincu() {
    ...
    if (bounds.getX() == 320 * 3 && bounds.getY() == 240 * 2) {
        ...
        while (list.hasNext()) {
            ...
            if (ennemi != 0) return ennemi->getLife() <= 0;
        }
    }
    return false;
}
...
void Map::startDestFinal() {
    ...
    for (int i = 0; i < 12; i++) scene->setCoffre(15, 21 + i, 0);
...
void Map::setDestFinalTypeEnn(int type) {
    if (map == 60 && type >= 129 && type <= 140) {
        ...
        if (scene->getCoffre(15, 33) < 99) scene->setCoffre(15, 33, scene->getCoffre(15, 33) + 1);
    }
}
...
int Map::getDestFinalTypeEnn() {
    int total = 0;
    Scene* scene = MainController::getInstance()->getGameController()->getSceneController()->getScene();
    for (int i = 0; i < 12; i++) if (scene->getCoffre(15, 21 + i)) total++;
    return total;
}
...
int Map::getEtage() {
    switch (map) {
        case 46 : return (bounds.getX() / (80 * 16) - 1);
        case 47 : return -(bounds.getX() / (120 * 16));
        case 48 : return -(bounds.getX() / (140 * 16));
        case 49 : case 54 : return -((bounds.getX() + (100 * 16)) / (120 * 16));
        case 50 : case 51 : case 52 :
            if (bounds.getX() >= 320 * 9) return -1;
            if (bounds.getX() >= 320 * 4) return 0;
            if (bounds.getX() >= 320) return 1;
            return 2;
        case 53 : return ((bounds.getY() / (240 * 4)) * (-2)) + (bounds.getX() / (320 * 4));
        case 55 : return (bounds.getY() / (75 * 16)) - 2;
        case 56 : return (bounds.getX() / (140 * 16));
        case 57 :
            if (bounds.getY() >= 240 * 14) return -2;
            if (bounds.getY() >= 240 * 7) return -1;
            if (bounds.getX() >= 320 * 7) return 1;
            return 0;
        case 58 :
            return 0;
        case 59 : return (bounds.getX() / (80 * 16) - 1);
        case 60 : return (bounds.getY() / (75 * 16)) - 1;
        case 63 :
            if (bounds.getX() >= 320 * 3) return 0;
            return -1;
        case 67 :
            if (bounds.getX() >= 320 * 2) return 0;
            return -1;
        case 78 :
            if (bounds.getX() >= 320 * 3) return 0;
            return -1;
        case 137 :
            if (bounds.getY() == 240 * 4) return 0;
            return -1;
        case 140 :
            if (bounds.getX() == 0) return 0;
            return -1;
        case 150 :
            if (bounds.getX() >= 320 * 9) return -2;
            if (bounds.getX() >= 320 * 6) return -1;
            if (bounds.getX() >= 320 * 3) return 0;
            return 1;
        case 154 :
            if (bounds.getX() == 0) return 0;
            if (bounds.getX() >= 320 && bounds.getY() == 0) return -1;
            return -2;
        case 156 : return 2 - (bounds.getY() / (75 * 16));
        default : return 0;
    }
}
...
Epoque Map::getEpoque() {
    // overworld
    if (map < 16) return EP_PASSE;
    if (map < 31) return EP_PRESENT;
    if (map < 46) return EP_FUTUR;
    // donjons
    if (map < 49) return EP_PRESENT;
    if (map < 51) return EP_FUTUR;
    if (map < 52) return EP_PRESENT;
    if (map < 57) return EP_PASSE;
    if (map < 58) return EP_PRESENT;
    if (map < 60) return EP_FUTUR;
    if (map == 60) return EP_RIEN;
    // grottes
    if (map < 70) return EP_PRESENT;
    if (map < 74) return EP_FUTUR;
    if (map < 79) return EP_PASSE;
    // maisons
    if (map < 112) return EP_PRESENT;
    if (map < 124) return EP_FUTUR;
    if (map < 150) return EP_PASSE;
    // autres
    if (map < 152) return EP_PRESENT;
    if (map < 153) return EP_FUTUR;
    if (map < 155) return EP_PASSE;
    if (map < 156) return EP_FUTUR;
    // donjon de trop
    if (bounds.getX() < 320 * 5) return EP_PASSE;
    if (bounds.getX() < 320 * 10) return EP_PRESENT;
    return EP_FUTUR;
}
