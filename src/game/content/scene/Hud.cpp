...
void Hud::drawInfo()
{
    ...
    if (destFinal)
    {
        ...
        // monsters
        if (!scene->getCoffre(15, 13) || !scene->getCoffre(15, 14) || !scene->getCoffre(15, 15) || !scene->getCoffre(15, 16) || !scene->getCoffre(15, 17) || !scene->getCoffre(15, 18) || !scene->getCoffre(15, 19))
        {
...
void Hud::drawItems()
{
    ...
    // keys
    if (scene->getMap()->getId() >= 46 && scene->getMap()->getId() < 61 && (scene->getMap()->getId() != 57 || scene->getAvancement() >= AV_TELE_ZELDA))
    {
