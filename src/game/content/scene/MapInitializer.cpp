...
void MapInitializer::init()
{
    ...
    case 1:
        ...
        addEnnemi(new Ennemi077(7 * 16 - 13, 53 * 16 - 12));
        addEnnemi(new Ennemi077(8 * 16 - 13, 34 * 16 - 12));
        addEnnemi(new Ennemi077(13 * 16 - 13, 18 * 16 - 12));
        addEnnemi(new Ennemi077(13 * 16 - 13, 43 * 16 - 12));
        addEnnemi(new Ennemi077(26 * 16 - 13, 29 * 16 - 12));
        addEnnemi(new Ennemi077(31 * 16 - 13, 51 * 16 - 12));
        addEnnemi(new Ennemi077(35 * 16 - 13, 15 * 16 - 12));
        addEnnemi(new Ennemi077(51 * 16 - 13, 15 * 16 - 12));
        addEnnemi(new Ennemi077(53 * 16 - 13, 29 * 16 - 12));
        addEnnemi(new Ennemi077(62 * 16 - 13, 49 * 16 - 12));
    ...
    case 2:
        ...
        addEnnemi(new Ennemi077(13 * 16 - 13, 34 * 16 - 12));
        addEnnemi(new Ennemi077(15 * 16 - 13, 48 * 16 - 12));
        addEnnemi(new Ennemi077(23 * 16 - 13, 45 * 16 - 12));
        addEnnemi(new Ennemi077(29 * 16 - 13, 12 * 16 - 12));
        addEnnemi(new Ennemi077(41 * 16 - 13, 33 * 16 - 12));
        addEnnemi(new Ennemi077(47 * 16 - 13, 40 * 16 - 12));
    ...
    case 3:
        ...
        if (scene->getAvancement() >= AV_INFO_PASSE_OK)
        {
            ...
            {
                map->setSol(45 * 16, 31 * 16, link->getStatus()->getMaxPieceOr() == 500 ? 2179 : link->getStatus()->getMaxPieceOr() == 200 ? 2177
                                                                                                                                           : 2175);
            }
            map->setSol(45 * 16, 32 * 16, link->getStatus()->getMaxPieceOr() == 999 ? 2173 : link->getStatus()->getMaxPieceOr() == 500 ? 2178
                                                                                         : link->getStatus()->getMaxPieceOr() == 200   ? 2176
                                                                                                                                       : 2174);
    ...
    case 4:
        ...
        if (scene->getAvancement() < AV_TEMPLE_DEESSES_APPARU)
        {
            ...
            map->setSol(22 * 16, 28 * 16, 550);
            map->setSol(25 * 16, 24 * 16, 550);
            map->setSol(25 * 16, 34 * 16, 550);
            map->setSol(26 * 16, 41 * 16, 550);
            map->setSol(28 * 16, 37 * 16, 550);
            map->setSol(30 * 16, 31 * 16, 550);
            map->setSol(33 * 16, 25 * 16, 550);
            map->setSol(34 * 16, 36 * 16, 550);
            map->setSol(36 * 16, 43 * 16, 550);
            map->setSol(38 * 16, 38 * 16, 550);
            map->setSol(39 * 16, 32 * 16, 550);
            map->setSol(41 * 16, 45 * 16, 550);
            map->setSol(42 * 16, 25 * 16, 550);
            map->setSol(44 * 16, 36 * 16, 550);
            map->setSol(47 * 16, 41 * 16, 550);
            map->setSol(48 * 16, 30 * 16, 550);
            map->setSol(51 * 16, 26 * 16, 550);
            map->setSol(52 * 16, 33 * 16, 550);
            map->setSol(53 * 16, 37 * 16, 550);
            map->setSol(55 * 16, 24 * 16, 550);
            map->setSol(56 * 16, 28 * 16, 550);
            map->setSol(56 * 16, 42 * 16, 550);
            map->setSol(57 * 16, 34 * 16, 550);

            // triforce
            map->setSol(39 * 16, 36 * 16, 2301);
            map->setSol(40 * 16, 36 * 16, 2302);
            map->setSol(38 * 16, 37 * 16, 2303);
            map->setSol(39 * 16, 37 * 16, 2304);
            map->setSol(40 * 16, 37 * 16, 2305);
            map->setSol(41 * 16, 37 * 16, 2306);
            map->setSol(38 * 16, 38 * 16, 2307);
            map->setSol(39 * 16, 38 * 16, 2308);
            map->setSol(40 * 16, 38 * 16, 2307);
            map->setSol(41 * 16, 38 * 16, 2308);
    ...
    case 5:
        ...
        addEnnemi(new Ennemi077(43 * 16 - 13, 59 * 16 - 12));
        addEnnemi(new Ennemi077(32 * 16 - 13, 68 * 16 - 12));
        addEnnemi(new Ennemi077(52 * 16 - 13, 21 * 16 - 12));
        addEnnemi(new Ennemi077(23 * 16 - 13, 9 * 16 - 12));
        addEnnemi(new Ennemi077(13 * 16 - 13, 27 * 16 - 12));
        addEnnemi(new Ennemi077(14 * 16 - 13, 55 * 16 - 12));
        addEnnemi(new Ennemi077(48 * 16 - 13, 72 * 16 - 12));
        addEnnemi(new Ennemi077(53 * 16 - 13, 41 * 16 - 12));
        break;
    case 6:
        ...
        addEnnemi(new Ennemi042(31 * 16 - 5, 27 * 16 - 3));
        addEnnemi(new Ennemi042(41 * 16 - 5, 12 * 16 - 3));
        addEnnemi(new Ennemi042(64 * 16 - 5, 28 * 16 - 3));
        addEnnemi(new Ennemi042(7 * 16 - 5, 18 * 16 - 3));
        addEnnemi(new Ennemi042(54 * 16 - 5, 82 * 16 - 3));
        addEnnemi(new Ennemi042(41 * 16 - 5, 44 * 16 - 3));
    ...
    case 7:
        ...
        addEnnemi(new Ennemi041(27 * 16, 6 * 16 - 8));
        addEnnemi(new Ennemi041(65 * 16, 14 * 16 - 8));
        addEnnemi(new Ennemi041(94 * 16, 7 * 16 - 8));
        addEnnemi(new Ennemi041(112 * 16, 17 * 16 - 8));
        addEnnemi(new Ennemi041(52 * 16, 34 * 16 - 8));
        addEnnemi(new Ennemi041(89 * 16, 37 * 16 - 8));
        break;
    case 8:
        ...
        addEnnemi(new Ennemi064(39 * 16 - 4, 20 * 16 - 4));
        addEnnemi(new Ennemi064(18 * 16 - 4, 33 * 16 - 4));
        addEnnemi(new Ennemi064(55 * 16 - 4, 22 * 16 - 4));
        addEnnemi(new Ennemi064(20 * 16 - 4, 22 * 16 - 4));
        break;
    case 9:
        ...
        addEnnemi(new Ennemi077(33 * 16 - 13, 38 * 16 - 12));
        addEnnemi(new Ennemi077(38 * 16 - 13, 50 * 16 - 12));
        addEnnemi(new Ennemi077(49 * 16 - 13, 30 * 16 - 12));
        addEnnemi(new Ennemi077(59 * 16 - 13, 55 * 16 - 12));
        addEnnemi(new Ennemi077(65 * 16 - 13, 42 * 16 - 12));
        addEnnemi(new Ennemi077(86 * 16 - 13, 13 * 16 - 12));
        addEnnemi(new Ennemi077(99 * 16 - 13, 42 * 16 - 12));
        addEnnemi(new Ennemi077(110 * 16 - 13, 23 * 16 - 12));
        break;
    case 10:
    ...
    case 11:
        ...
        addEnnemi(new Ennemi041(59 * 16, 63 * 16 - 8));
        addEnnemi(new Ennemi041(78 * 16, 60 * 16 - 8));
        addEnnemi(new Ennemi041(120 * 16, 68 * 16 - 8));
        addEnnemi(new Ennemi041(121 * 16, 38 * 16 - 8));
        addEnnemi(new Ennemi041(13 * 16, 38 * 16 - 8));

        addEnnemi(new Ennemi077(119 * 16 - 13, 9 * 16 - 12));
        addEnnemi(new Ennemi077(23 * 16 - 13, 8 * 16 - 12));
    ...
    case 12:
        ...
        addEnnemi(new Ennemi041(108 * 16, 24 * 16 - 8));
        addEnnemi(new Ennemi041(109 * 16, 62 * 16 - 8));

        addEnnemi(new Ennemi087(48 * 16 + 3, 27 * 16 - 8));
        addEnnemi(new Ennemi087(16 * 16 + 3, 43 * 16 - 8));
        addEnnemi(new Ennemi087(33 * 16 + 3, 57 * 16 - 8));
        addEnnemi(new Ennemi087(55 * 16 + 3, 51 * 16 - 8));
        addEnnemi(new Ennemi087(71 * 16 + 3, 59 * 16 - 8));
        addEnnemi(new Ennemi087(72 * 16 + 3, 35 * 16 - 8));
        break;
    case 13:
    ...
    case 14:
        ...
        addEnnemi(new Ennemi077(16 * 16 - 13, 64 * 16 - 12));
        addEnnemi(new Ennemi077(33 * 16 - 13, 38 * 16 - 12));
        break;
    case 15:
        addObject(new Pierre(16 * 9, 16 * 39, 1, map));
        ...
        addEnnemi(new Ennemi042(105 * 16 - 5, 45 * 16 - 3));
        addEnnemi(new Ennemi042(86 * 16 - 5, 25 * 16 - 3));
        addEnnemi(new Ennemi042(50 * 16 - 5, 36 * 16 - 3));
        addEnnemi(new Ennemi042(28 * 16 - 5, 45 * 16 - 3));
        addEnnemi(new Ennemi042(25 * 16 - 5, 21 * 16 - 3));
        addEnnemi(new Ennemi042(52 * 16 - 5, 18 * 16 - 3));
    ...
    case 18:
        ...
        if (link->getEpee() > 0 || inventory->hasObject(OCARINA))
        {
            if (inventory->hasObject(SAC_TROC) && (scene->getAvancement() < AV_PORTAIL_PRE_PRESENT_UTILISE || scene->getAvancement() >= AV_PORTAIL_PRE_PRESENT_FERME))
            {
                addObject(new Poule(16 * 25, 16 * 58));
                addObject(new Poule(16 * 30, 16 * 57));
                addObject(new Poule(16 * 26, 16 * 61));
                ...
                map->setSol(31 * 16, 31 * 16, inventory->getTroc(TT_ROUAGE) == -1 ? 1961 : inventory->hasQuartCoeur(2) ? 1959
                                                                                                                       : 1960);
                addObject(new Pnj(16 * 46 + 8, 16 * 30 + 6, 2, 286));
                map->setSol(45 * 16, 31 * 16, link->getStatus()->getMaxRupees() == 999 ? 1959 : link->getStatus()->getMaxRupees() == 500 ? 1964
                                                                                            : link->getStatus()->getMaxRupees() == 200   ? 1963
                                                                                                                                         : 1962);
    ...
    case 20:
        ...
        if ((link->getEpee() > 0 && scene->getAvancement() < AV_PORTAIL_PRE_PRESENT_UTILISE) || scene->getAvancement() >= AV_PORTAIL_PRE_PRESENT_FERME)
        {
        ...
        if (scene->getAvancement() >= AV_PORTAIL_PRE_PRESENT_UTILISE && scene->getAvancement() < AV_PORTAIL_PRE_PRESENT_FERME)
        {
            addObject(new Pnj(25 * 16 + 5, 13 * 16 + 5, 68, 269));
            addEffect(new Zzzzz(26 * 16 + 5, 13 * 16));
            addObject(new Pnj(17 * 16 + 5, 59 * 16 + 5, 68, 269));
            addEffect(new Zzzzz(18 * 16 + 5, 59 * 16));
            addObject(new Pnj(27 * 16 + 5, 79 * 16 + 5, 68, 269));
            addEffect(new Zzzzz(28 * 16 + 5, 79 * 16));
            addObject(new Pnj(41 * 16 + 5, 36 * 16 + 5, 68, 269));
            addEffect(new Zzzzz(42 * 16 + 5, 36 * 16));
            addObject(new Pnj(19 * 16 + 5, 28 * 16 + 5, 68, 269));
            addEffect(new Zzzzz(20 * 16 + 5, 28 * 16));
            addObject(new Pnj(9 * 16 + 5, 85 * 16 + 5, 68, 269));
            addEffect(new Zzzzz(10 * 16 + 5, 85 * 16));
            addObject(new Pnj(7 * 16 + 5, 84 * 16 + 5, 68, 269));
            addEffect(new Zzzzz(8 * 16 + 5, 84 * 16));
        }
        break;
    case 21:
        ...
        if (scene->getAvancement() >= AV_PORTAIL_PRE_PRESENT_UTILISE && scene->getAvancement() < AV_PORTAIL_PRE_PRESENT_FERME)
        {
            addObject(new Pnj(44 * 16 + 5, 2 * 16 + 5, 68, 269));
            addEffect(new Zzzzz(45 * 16 + 5, 2 * 16));
            addObject(new Pnj(27 * 16 + 5, 11 * 16 + 5 - 8, 68, 269));
            addEffect(new Zzzzz(28 * 16 + 5, 11 * 16 - 8));
            addObject(new Pnj(33 * 16 + 5 - 8, 31 * 16 + 5, 68, 269));
            addEffect(new Zzzzz(34 * 16 + 5 - 8, 31 * 16));
            addObject(new Pnj(15 * 16 + 5, 11 * 16 + 5 - 8, 68, 269));
            addEffect(new Zzzzz(16 * 16 + 5, 11 * 16 - 8));
            addObject(new Pnj(9 * 16 + 5, 8 * 16 + 5, 68, 269));
            addEffect(new Zzzzz(10 * 16 + 5, 8 * 16));
            addObject(new Pnj(8 * 16 + 5 - 8, 31 * 16 + 5, 68, 269));
            addEffect(new Zzzzz(9 * 16 + 5 - 8, 31 * 16));
        }
        else if (scene->getAvancement() >= AV_STELE_LUE)
        {
            addEnnemi(new Ennemi004(9 * 16, 51 * 16 - 1));
            addEnnemi(new Ennemi004(4 * 16, 60 * 16 - 1));
            addEnnemi(new Ennemi004(22 * 16, 46 * 16 - 1));
            addEnnemi(new Ennemi004(25 * 16, 52 * 16 - 1));
            addEnnemi(new Ennemi004(14 * 16, 35 * 16 - 1));
            addEnnemi(new Ennemi004(7 * 16, 16 * 16 - 1));
            addEnnemi(new Ennemi004(20 * 16, 25 * 16 - 1));
            addEnnemi(new Ennemi004(41 * 16, 12 * 16 - 1));
            addEnnemi(new Ennemi004(61 * 16, 45 * 16 - 1));
            addEnnemi(new Ennemi004(54 * 16, 54 * 16 - 1));
            addEnnemi(new Ennemi004(61 * 16, 62 * 16 - 1));
            addEnnemi(new Ennemi004(53 * 16, 83 * 16 - 1));
            addEnnemi(new Ennemi004(38 * 16, 73 * 16 - 1));
            addEnnemi(new Ennemi004(32 * 16, 67 * 16 - 1));
            addEnnemi(new Ennemi004(41 * 16, 46 * 16 - 1));
            addEnnemi(new Ennemi004(50 * 16, 32 * 16 - 1));
            addEnnemi(new Ennemi004(74 * 16, 30 * 16 - 1));
            addEnnemi(new Ennemi004(34 * 16, 34 * 16 - 1));
            addEnnemi(new Ennemi004(42 * 16, 21 * 16 - 1));
            addEnnemi(new Ennemi004(47 * 16, 59 * 16 - 1));

            addEnnemi(new Ennemi054(69 * 16, 16 * 16, N));
            addEnnemi(new Ennemi054(37 * 16, 25 * 16, N));
            addEnnemi(new Ennemi054(69 * 16, 60 * 16, S));
            addEnnemi(new Ennemi054(49 * 16, 72 * 16, S));
            addEnnemi(new Ennemi054(12 * 16, 62 * 16, S));
            addEnnemi(new Ennemi054(45 * 16, 83 * 16, N));
            addEnnemi(new Ennemi054(75 * 16, 72 * 16, S));
            addEnnemi(new Ennemi054(13 * 16, 82 * 16, S));
            addEnnemi(new Ennemi054(6 * 16, 73 * 16, S));
            addEnnemi(new Ennemi054(21 * 16, 78 * 16, S));
            addEnnemi(new Ennemi054(4 * 16, 85 * 16, S));
            addEnnemi(new Ennemi054(11 * 16, 40 * 16, S));
            addEnnemi(new Ennemi054(45 * 16, 65 * 16, S));
            addEnnemi(new Ennemi054(68 * 16, 49 * 16, S));
            addEnnemi(new Ennemi054(50 * 16, 14 * 16, S));
            addEnnemi(new Ennemi054(59 * 16, 23 * 16, S));
        }
        break;
    case 22:
        ...
        if (scene->getAvancement() >= AV_PORTAIL_PRE_PRESENT_UTILISE && scene->getAvancement() < AV_PORTAIL_PRE_PRESENT_FERME)
        {
            addObject(new Pnj(9 * 16 + 5 - 8, 36 * 16 + 5 + 2, 68, 269));
            addEffect(new Zzzzz(10 * 16 + 5 - 8, 36 * 16 + 2));
            addObject(new Pnj(21 * 16 + 5, 12 * 16 + 5, 68, 269));
            addEffect(new Zzzzz(22 * 16 + 5, 12 * 16));
            addObject(new Pnj(36 * 16 + 5, 4 * 16 + 5 - 8, 68, 269));
            addEffect(new Zzzzz(37 * 16 + 5, 4 * 16 - 8));
            addObject(new Pnj(49 * 16 + 5, 9 * 16 + 5, 68, 269));
            addEffect(new Zzzzz(50 * 16 + 5, 9 * 16));
            addObject(new Pnj(56 * 16 + 5, 29 * 16 + 5, 68, 269));
            addEffect(new Zzzzz(57 * 16 + 5, 29 * 16));
        ...
        else
        {
            if (inventory->getTroc(TT_ROUAGE) == 0)
            {
                ...
                for (int i = 0; i < 9; i++)
                    map->setMur(24 * 16, (14 + i) * 16, MUR, PIERRE, MUR, PIERRE);
                for (int i = 0; i < 9; i++)
                    map->setMur(31 * 16, (14 + i) * 16, PIERRE, MUR, PIERRE, MUR);
            }
            addObject(new Pnj(124 * 16, 8 * 16, 71, 433));

            Ennemi010 *enn = new Ennemi010(119 * 16, 7 * 16);
            enn->cachette();
            addEnnemi(enn);
            enn = new Ennemi010(119 * 16, 9 * 16);
            enn->cachette();
            addEnnemi(enn);
            enn = new Ennemi010(123 * 16, 12 * 16);
            enn->cachette();
            addEnnemi(enn);
            enn = new Ennemi010(126 * 16, 12 * 16);
            enn->cachette();
            addEnnemi(enn);

            addEnnemi(new Ennemi027(29 * 16, 3 * 16 - 1));
            addEnnemi(new Ennemi027(53 * 16, 12 * 16 - 1));
            addEnnemi(new Ennemi027(76 * 16, 16 * 16 - 1));

            addEnnemi(new Ennemi053(27 * 16, 27 * 16));
            addEnnemi(new Ennemi053(94 * 16, 38 * 16));
            addEnnemi(new Ennemi053(59 * 16, 39 * 16));
            addEnnemi(new Ennemi053(54 * 16, 31 * 16));

            addEnnemi(new Ennemi054(108 * 16, 39 * 16, N));
            addEnnemi(new Ennemi054(124 * 16, 32 * 16, N));
            addEnnemi(new Ennemi054(79 * 16, 37 * 16, S));
            addEnnemi(new Ennemi054(94 * 16, 15 * 16, N));
        }
        break;
    case 23:
        ...
        addEnnemi(new Ennemi012(17 * 16, 8 * 16));
        addEnnemi(new Ennemi012(62 * 16, 8 * 16));
    ...
    case 24:
        ...
        addObject(new Pnj(8 * 16 + 5, 15 * 16 + 5, 68, 269));
        addEffect(new Zzzzz(9 * 16 + 5, 15 * 16));

        addEnnemi(new Ennemi008(48 * 16, 32 * 16));
        addEnnemi(new Ennemi008(34 * 16, 50 * 16));
        addEnnemi(new Ennemi008(64 * 16, 44 * 16));
        addEnnemi(new Ennemi008(97 * 16, 28 * 16));

        addEnnemi(new Ennemi053(27 * 16, 35 * 16));
        addEnnemi(new Ennemi053(21 * 16, 9 * 16));
        addEnnemi(new Ennemi053(45 * 16, 10 * 16));
        addEnnemi(new Ennemi053(98 * 16, 7 * 16));
        addEnnemi(new Ennemi053(113 * 16, 22 * 16));
        addEnnemi(new Ennemi053(83 * 16, 25 * 16));
        addEnnemi(new Ennemi053(49 * 16, 46 * 16));
        addEnnemi(new Ennemi053(90 * 16, 39 * 16));
        addEnnemi(new Ennemi053(116 * 16, 51 * 16));

        addEnnemi(new Ennemi054(65 * 16, 31 * 16, S));
        addEnnemi(new Ennemi054(92 * 16, 22 * 16, N));
        addEnnemi(new Ennemi054(80 * 16, 10 * 16, S));
        addEnnemi(new Ennemi054(34 * 16, 11 * 16, S));
        addEnnemi(new Ennemi054(54 * 16, 6 * 16, S));
        addEnnemi(new Ennemi054(104 * 16, 17 * 16, S));
        addEnnemi(new Ennemi054(104 * 16, 43 * 16, N));
        addEnnemi(new Ennemi054(74 * 16, 54 * 16, S));
        addEnnemi(new Ennemi054(115 * 16, 8 * 16, N));
        addEnnemi(new Ennemi054(95 * 16, 53 * 16, N));
    ...
    case 25:
        ...
        addObject(new Animal(11 * 16, 55 * 16, 5));
        addObject(new Animal(32 * 16, 52 * 16, 5));
        addObject(new Animal(37 * 16, 18 * 16, 5));
        addObject(new Animal(65 * 16, 28 * 16, 5));
        addObject(new Animal(42 * 16, 41 * 16, 5));
        addObject(new Animal(64 * 16, 57 * 16, 5));
        addObject(new Animal(61 * 16, 23 * 16, 5));
        addObject(new Animal(49 * 16, 34 * 16, 5));
        addObject(new Animal(8 * 16, 31 * 16, 5));
        addObject(new Animal(51 * 16, 61 * 16, 5));
        break;
    case 26:
        ...
        addEnnemi(new Ennemi009(13 * 16, 35 * 16 + 8));
        addEnnemi(new Ennemi009(23 * 16, 70 * 16 + 8));
        addEnnemi(new Ennemi009(116 * 16, 69 * 16 + 8));
        addEnnemi(new Ennemi009(62 * 16, 61 * 16 + 8));
        addEnnemi(new Ennemi009(69 * 16, 42 * 16 + 8));

        addEnnemi(new Ennemi010(97 * 16, 42 * 16));
        addEnnemi(new Ennemi010(52 * 16, 46 * 16));
        addEnnemi(new Ennemi010(31 * 16, 30 * 16));
        addEnnemi(new Ennemi010(71 * 16, 27 * 16));

        addEnnemi(new Ennemi053(22 * 16, 10 * 16));
        addEnnemi(new Ennemi053(45 * 16, 12 * 16));
        addEnnemi(new Ennemi053(74 * 16, 8 * 16));
        addEnnemi(new Ennemi053(86 * 16, 17 * 16));
        addEnnemi(new Ennemi053(129 * 16, 13 * 16));

        addEnnemi(new Ennemi054(124 * 16, 4 * 16, N));
        addEnnemi(new Ennemi054(118 * 16, 17 * 16, S));
        addEnnemi(new Ennemi054(56 * 16, 71 * 16, N));
        addEnnemi(new Ennemi054(80 * 16, 69 * 16, S));
    ...
    case 27:
        ...
        addEnnemi(new Ennemi007(17 * 16, 37 * 16));
        addEnnemi(new Ennemi007(31 * 16, 58 * 16));
        addEnnemi(new Ennemi007(56 * 16, 20 * 16));
        addEnnemi(new Ennemi007(75 * 16, 53 * 16));
        addEnnemi(new Ennemi007(31 * 16, 19 * 16));

        addEnnemi(new Ennemi009(123 * 16, 69 * 16 + 8));
        addEnnemi(new Ennemi009(102 * 16, 32 * 16 + 8));

        addEnnemi(new Ennemi013(12 * 16, 47 * 16 - 4));
        addEnnemi(new Ennemi013(43 * 16, 15 * 16 - 4));
        addEnnemi(new Ennemi013(69 * 16, 45 * 16 - 4));
        addEnnemi(new Ennemi013(43 * 16, 61 * 16 - 4));

        addEnnemi(new Ennemi014(26 * 16 - 12, 44 * 16));
        addEnnemi(new Ennemi014(67 * 16 - 12, 59 * 16));
        addEnnemi(new Ennemi014(72 * 16 - 12, 16 * 16));
        addEnnemi(new Ennemi014(51 * 16 - 12, 31 * 16));
        break;
    case 28:
    ...
    case 29:
        ...
        addEnnemi(new Ennemi054(11 * 16, 47 * 16, S));
        addEnnemi(new Ennemi054(17 * 16, 24 * 16, S));
    ...
    case 30:
        ...
        addEnnemi(new Ennemi005(87 * 16, 22 * 16 - 10));
        addEnnemi(new Ennemi005(61 * 16, 22 * 16 - 10));
        addEnnemi(new Ennemi005(31 * 16, 49 * 16 - 10));
        addEnnemi(new Ennemi005(62 * 16, 43 * 16 - 10));
        addEnnemi(new Ennemi005(96 * 16, 41 * 16 - 10));
        addEnnemi(new Ennemi005(32 * 16, 28 * 16 - 10));

        addEnnemi(new Ennemi006(50 * 16, 35 * 16 - 21));
        addEnnemi(new Ennemi006(23 * 16, 21 * 16 - 21));
        addEnnemi(new Ennemi006(75 * 16 + 8, 30 * 16 - 21));
        addEnnemi(new Ennemi006(28 * 16 + 8, 36 * 16 - 21));
    ...
    case 31:
        ...
        addEnnemi(new Ennemi032(9 * 16, 41 * 16 - 7));
        addEnnemi(new Ennemi032(11 * 16, 17 * 16 - 7));
        addEnnemi(new Ennemi032(27 * 16, 28 * 16 - 7));
        addEnnemi(new Ennemi032(29 * 16, 50 * 16 - 7));
        addEnnemi(new Ennemi032(47 * 16, 50 * 16 - 7));
        addEnnemi(new Ennemi032(48 * 16, 12 * 16 - 7));
        addEnnemi(new Ennemi032(55 * 16, 28 * 16 - 7));
        addEnnemi(new Ennemi032(68 * 16, 10 * 16 - 7));
        addEnnemi(new Ennemi032(70 * 16, 46 * 16 - 7));
        addEnnemi(new Ennemi032(36 * 16, 16 * 16 - 7));
    ...
    case 32:
        ...
        addEnnemi(new Ennemi032(15 * 16, 7 * 16 - 7));
        addEnnemi(new Ennemi032(19 * 16, 28 * 16 - 7));
        addEnnemi(new Ennemi032(40 * 16, 27 * 16 - 7));
        addEnnemi(new Ennemi032(52 * 16, 8 * 16 - 7));

        addEnnemi(new Ennemi055(27 * 16 + 5, 12 * 16));
        addEnnemi(new Ennemi055(9 * 16 + 5, 28 * 16));
        addEnnemi(new Ennemi055(21 * 16 + 5, 45 * 16));
        addEnnemi(new Ennemi055(43 * 16 + 5, 37 * 16));
    ...
    case 33:
        ...
        map->setSol(45 * 16, 31 * 16, link->getStatus()->getMaxGanonOr() == 999 ? 2089 : link->getStatus()->getMaxGanonOr() == 500 ? 2093
                                                                                     : link->getStatus()->getMaxGanonOr() == 200   ? 2092
                                                                                                                                   : 2091);

        addObject(new Pnj(32 * 16 + 8, 37 * 16 + 11, 49, 349));
        map->setSol(31 * 16, 38 * 16, inventory->getTroc(TT_ROUE) == -1 ? 2094 : link->getInventory()->hasObject(BOMBES) ? 2089
                                                                                                                         : 2098);
    ...
    case 36:
        ...
        if (inventory->hasObject(PERLE))
        {
            addEnnemi(new Ennemi032(8 * 16, 22 * 16 - 7));
            addEnnemi(new Ennemi032(54 * 16, 65 * 16 - 7));
            addEnnemi(new Ennemi032(40 * 16, 65 * 16 - 7));
            addEnnemi(new Ennemi032(13 * 16, 78 * 16 - 7));
            addEnnemi(new Ennemi032(10 * 16, 51 * 16 - 7));
            addEnnemi(new Ennemi032(38 * 16, 43 * 16 - 7));
            addEnnemi(new Ennemi032(54 * 16, 16 * 16 - 7));

            addEnnemi(new Ennemi037(30 * 16, 13 * 16 - 10));
            addEnnemi(new Ennemi037(61 * 16, 46 * 16 - 10));
            addEnnemi(new Ennemi037(56 * 16, 82 * 16 - 10));
            addEnnemi(new Ennemi037(21 * 16, 84 * 16 - 10));
            addEnnemi(new Ennemi037(22 * 16, 45 * 16 - 10));
            addEnnemi(new Ennemi037(40 * 16, 20 * 16 - 10));
        }
        break;
    case 37:
        ...
        addEnnemi(new Ennemi032(26 * 16, 5 * 16 - 7));
        addEnnemi(new Ennemi032(90 * 16, 15 * 16 - 7));
        addEnnemi(new Ennemi032(61 * 16, 15 * 16 - 7));
        addEnnemi(new Ennemi032(51 * 16, 34 * 16 - 7));
        addEnnemi(new Ennemi032(123 * 16, 36 * 16 - 7));

        addEnnemi(new Ennemi084(50 * 16, 4 * 16, N));
        addEnnemi(new Ennemi084(79 * 16, 37 * 16, S));
        addEnnemi(new Ennemi084(33 * 16, 29 * 16, S));
        addEnnemi(new Ennemi084(78 * 16, 14 * 16, N));
    ...
    case 38:
        ...
        if (inventory->hasObject(PERLE))
        {
            addEnnemi(new Ennemi056(17 * 16 - 1, 8 * 16 - 1));
            addEnnemi(new Ennemi056(62 * 16 - 1, 8 * 16 - 1));
            addEnnemi(new Ennemi056(16 * 16 - 1, 24 * 16 - 1));
            addEnnemi(new Ennemi056(46 * 16 - 1, 19 * 16 - 1));
    ...
    case 39:
        ...
        addEnnemi(new Ennemi032(113 * 16, 51 * 16 - 7));
        addEnnemi(new Ennemi032(99 * 16, 30 * 16 - 7));
        addEnnemi(new Ennemi032(99 * 16, 6 * 16 - 7));
        addEnnemi(new Ennemi032(53 * 16, 30 * 16 - 7));
        addEnnemi(new Ennemi032(21 * 16, 10 * 16 - 7));
        addEnnemi(new Ennemi032(40 * 16, 11 * 16 - 7));
        addEnnemi(new Ennemi032(30 * 16, 49 * 16 - 7));
        addEnnemi(new Ennemi032(29 * 16, 28 * 16 - 7));

        addEnnemi(new Ennemi055(38 * 16 + 5, 38 * 16));
        addEnnemi(new Ennemi055(59 * 16 + 5, 46 * 16));
        addEnnemi(new Ennemi055(96 * 16 + 5, 44 * 16));
        addEnnemi(new Ennemi055(87 * 16 + 5, 23 * 16));
    ...
    case 40:
        ...
        addEnnemi(new Ennemi011(40 * 16, 41 * 16));
        addEnnemi(new Ennemi011(62 * 16, 26 * 16));
        addEnnemi(new Ennemi011(69 * 16, 44 * 16));

        addEnnemi(new Ennemi056(35 * 16 - 1, 31 * 16 - 1));
        addEnnemi(new Ennemi056(60 * 16 - 1, 47 * 16 - 1));
    ...
    case 41:
        ...
        if (inventory->hasObject(PERLE))
        {
            addEnnemi(new Ennemi032(82 * 16, 61 * 16 - 7));
            addEnnemi(new Ennemi032(60 * 16, 66 * 16 - 7));
            addEnnemi(new Ennemi032(13 * 16, 37 * 16 - 7));

            addEnnemi(new Ennemi055(63 * 16 + 5, 10 * 16));
            addEnnemi(new Ennemi055(27 * 16 + 5, 7 * 16));
            addEnnemi(new Ennemi055(120 * 16 + 5, 68 * 16));
            addEnnemi(new Ennemi055(12 * 16 + 5, 69 * 16));
            addEnnemi(new Ennemi055(123 * 16 + 5, 10 * 16));

            addEnnemi(new Ennemi086(97 * 16, 44 * 16));
            addEnnemi(new Ennemi086(51 * 16, 46 * 16));
            addEnnemi(new Ennemi086(28 * 16, 29 * 16));
            addEnnemi(new Ennemi086(130 * 16, 55 * 16));
        }
        break;
    case 42:
        ...
        addEnnemi(new Ennemi015(17 * 16 + 4, 41 * 16));
        addEnnemi(new Ennemi015(31 * 16 + 4, 57 * 16));
        addEnnemi(new Ennemi015(39 * 16 + 4, 21 * 16));
        addEnnemi(new Ennemi015(70 * 16 + 4, 57 * 16));
        addEnnemi(new Ennemi015(62 * 16 + 4, 12 * 16));
        addEnnemi(new Ennemi015(57 * 16 + 4, 37 * 16));

        addEnnemi(new Ennemi055(120 * 16 + 5, 67 * 16));
        addEnnemi(new Ennemi055(107 * 16 + 5, 24 * 16));
        break;
    case 43:
        ...
        addEnnemi(new Ennemi056(16 * 16 - 1, 20 * 16 - 1));
        addEnnemi(new Ennemi056(27 * 16 - 1, 40 * 16 - 1));
        addEnnemi(new Ennemi056(45 * 16 - 1, 31 * 16 - 1));
        addEnnemi(new Ennemi056(65 * 16 - 1, 55 * 16 - 1));
        break;
    case 44:
        ...
        if (!inventory->hasObject(FLECHE_FEU) || !inventory->hasObject(FLECHE_GLACE) || !inventory->hasObject(FLECHE_LUMIERE) || !inventory->hasObject(FLACON_4))
        {
            ouvrePorte(31, 28, 1);
        }
        ...
        addEnnemi(new Ennemi032(51 * 16, 20 * 16 - 7));
        addEnnemi(new Ennemi032(36 * 16, 40 * 16 - 7));
    ...
    case 45:
        ...
        addEnnemi(new Ennemi015(53 * 16 + 4, 35 * 16));
        addEnnemi(new Ennemi015(26 * 16 + 4, 20 * 16));
        addEnnemi(new Ennemi015(88 * 16 + 4, 21 * 16));
        addEnnemi(new Ennemi015(92 * 16 + 4, 40 * 16));
        addEnnemi(new Ennemi015(111 * 16 + 4, 45 * 16));
        addEnnemi(new Ennemi015(59 * 16 + 4, 21 * 16));

        addEnnemi(new Ennemi044(32 * 16 - 3, 28 * 16 - 10));
        addEnnemi(new Ennemi044(73 * 16 - 3, 31 * 16 - 10));
        addEnnemi(new Ennemi044(121 * 16 - 3, 48 * 16 - 10));
        addEnnemi(new Ennemi044(22 * 16 - 3, 36 * 16 - 10));
    ...
    case 46:
        ...
        if (scene->getCoffre(1, 14))
            ouvrePorte(29, 28, 0);
        if (scene->getCoffre(1, 15))
            ouvrePorte(29, 43, 0);
        if (scene->getCoffre(1, 16))
            ouvrePorte(69, 13, 0);
        if (scene->getCoffre(1, 17))
            ouvrePorte(69, 43, 0);
        if (scene->getCoffre(1, 18))
            ouvrePorte(98, 21, 1);
        if (scene->getCoffre(1, 19))
            ouvrePorte(109, 43, 0);
        if (scene->getCoffre(1, 20))
            ouvrePorte(138, 6, 1);
        if (scene->getCoffre(1, 21))
            ouvrePorte(169, 28, 0);
        if (scene->getCoffre(1, 22))
            ouvrePorte(209, 43, 0);
        if (scene->getCoffre(1, 23))
            ouvrePorte(298, 36, 1);
        if (scene->getCoffre(1, 24))
            ouvrePorte(298, 21, 1);
        ...
        addEnnemi(new Ennemi001(169 * 16 + 8, 21 * 16 + 6));
        addEnnemi(new Ennemi001(209 * 16, 5 * 16 + 6));
        addEnnemi(new Ennemi001(26 * 16, 4 * 16 + 6));
        addEnnemi(new Ennemi001(33 * 16, 4 * 16 + 6));
        addEnnemi(new Ennemi001(73 * 16, 21 * 16 + 6));
        addEnnemi(new Ennemi001(131 * 16, 5 * 16 + 6));
        addEnnemi(new Ennemi001(200 * 16, 36 * 16 + 6));
        addEnnemi(new Ennemi001(277 * 16, 23 * 16 + 6));
        addEnnemi(new Ennemi001(287 * 16, 34 * 16 + 6));
        addEnnemi(new Ennemi001(249 * 16, 35 * 16 + 6));
        addEnnemi(new Ennemi001(270 * 16, 8 * 16 + 6));

        addEnnemi(new Ennemi004(129 * 16 + 8, 56 * 16 - 1));
        addEnnemi(new Ennemi004(29 * 16, 52 * 16 - 1));
        addEnnemi(new Ennemi004(106 * 16, 51 * 16 - 1));
        addEnnemi(new Ennemi004(113 * 16, 51 * 16 - 1));
        addEnnemi(new Ennemi004(184 * 16 + 8, 47 * 16 - 1));
        addEnnemi(new Ennemi004(315 * 16, 7 * 16 - 1));
        addEnnemi(new Ennemi004(227 * 16, 22 * 16 - 1));

        addEnnemi(new Ennemi018(287 * 16, 3 * 16 + 2));
        addEnnemi(new Ennemi018(287 * 16, 11 * 16 + 2));
        addEnnemi(new Ennemi018(128 * 16, 27 * 16 + 2));
        addEnnemi(new Ennemi018(70 * 16, 35 * 16 + 2));
        addEnnemi(new Ennemi018(125 * 16, 48 * 16 + 2));
        addEnnemi(new Ennemi018(134 * 16, 48 * 16 + 2));
        addEnnemi(new Ennemi018(189 * 16 + 8, 5 * 16 + 2));
        addEnnemi(new Ennemi018(265 * 16, 48 * 16 + 2));
        addEnnemi(new Ennemi018(294 * 16, 48 * 16 + 2));
        addEnnemi(new Ennemi018(309 * 16 + 8, 19 * 16 + 2));
        addEnnemi(new Ennemi018(278 * 16, 43 * 16 + 2));
        addEnnemi(new Ennemi018(268 * 16, 19 * 16 + 2));

        addEnnemi(new Ennemi053(67 * 16, 51 * 16));
        addEnnemi(new Ennemi053(70 * 16, 54 * 16));
        addEnnemi(new Ennemi053(72 * 16, 50 * 16));
        addEnnemi(new Ennemi053(90 * 16, 36 * 16));
        addEnnemi(new Ennemi053(124 * 16, 19 * 16));
        addEnnemi(new Ennemi053(117 * 16, 36 * 16));
        addEnnemi(new Ennemi053(106 * 16, 30 * 16));
        addEnnemi(new Ennemi053(226 * 16, 51 * 16));
        addEnnemi(new Ennemi053(45 * 16, 13 * 16));
        addEnnemi(new Ennemi053(90 * 16, 22 * 16));
        addEnnemi(new Ennemi053(136 * 16, 32 * 16));
        addEnnemi(new Ennemi053(163 * 16, 4 * 16));
        addEnnemi(new Ennemi053(176 * 16, 4 * 16));
        addEnnemi(new Ennemi053(185 * 16, 33 * 16));
        addEnnemi(new Ennemi053(205 * 16, 20 * 16));
        addEnnemi(new Ennemi053(197 * 16, 24 * 16));
        addEnnemi(new Ennemi053(306 * 16, 23 * 16));
        addEnnemi(new Ennemi053(313 * 16, 23 * 16));
        addEnnemi(new Ennemi053(293 * 16, 26 * 16));

        addObject(new PiegePics(34 * 16, 49 * 16, S));
        addObject(new PiegePics(38 * 16, 49 * 16, S));
        addObject(new PiegePics(42 * 16, 49 * 16, S));
        addObject(new PiegePics(46 * 16, 49 * 16, S));
        addObject(new PiegePics(190 * 16, 53 * 16, S));
        addObject(new PiegePics(201 * 16, 53 * 16, S));
        addObject(new PiegePics(196 * 16, 51 * 16, S));
        addObject(new PiegePics(305 * 16, 32 * 16, S));
        addObject(new PiegePics(308 * 16, 32 * 16, S));
        addObject(new PiegePics(305 * 16, 51 * 16, S));
        addObject(new PiegePics(51 * 16, 7 * 16, S));
        addObject(new PiegePics(52 * 16, 7 * 16, S));

        addObject(new PiegeLong(6 * 16, 25 * 16, S));
        addObject(new PiegeLong(166 * 16, 40 * 16, S));
        addObject(new PiegeLong(106 * 16, 2 * 16, S));
        addObject(new PiegeLong(48 * 16, 18 * 16, S));
    ...
    case 47:
        ...
        if (link->getInventory()->hasObject(GANTS))
            addObject(new Coffre(322 * 16, 62 * 16 + 8, 1, true, TI_NO_ITEM));

        if (scene->getCoffre(2, 4))
            ouvrePorte(178, 21, 1);
        ...
        if (scene->getCoffre(2, 5))
            addObject(new Coffre(204 * 16, 34 * 16, 0, true, TI_NO_ITEM));
        ...
        if (scene->getCoffre(2, 8))
            addObject(new Coffre(334 * 16, 33 * 16, 0, true, TI_NO_ITEM));
        addObject(new Coffre(350 * 16, 6 * 16, 0, scene->getCoffre(2, 9), TI_CLE, 9));

        addObject(new Sphere(269 * 16 + 8, 67 * 16));
        addObject(new Sphere(337 * 16, 64 * 16));
        addObject(new Sphere(260 * 16, 34 * 16));
        addObject(new Sphere(329 * 16 + 8, 20 * 16));
        addObject(new Sphere(168 * 16, 4 * 16));
        addObject(new Sphere(166 * 16, 19 * 16));

        addObject(new TasDePierres(342 * 16, 39 * 16, 0));
        addObject(new TasDePierres(356 * 16, 34 * 16, 0));

        addObject(new Caisse(208 * 16, 36 * 16, 2, 3));
        addObject(new Caisse(212 * 16, 38 * 16, 2, 2));
        addObject(new Caisse(209 * 16, 39 * 16, 2, 1));
        addObject(new Caisse(300 * 16, 75 * 16, 2, 1, true));
        addObject(new Caisse(306 * 16, 82 * 16, 2, 1));
        addObject(new Caisse(315 * 16, 75 * 16, 2, 1));
        addObject(new Caisse(271 * 16, 80 * 16, 2, 3));
        addObject(new Caisse(268 * 16, 81 * 16, 2, 4));
        addObject(new Caisse(270 * 16, 81 * 16, 2, 3));
        addObject(new Caisse(272 * 16, 82 * 16, 2, 2));
        addObject(new Caisse(270 * 16, 83 * 16, 2, 2));
        addObject(new Caisse(271 * 16, 83 * 16, 2, 2));
        addObject(new Caisse(268 * 16, 84 * 16, 2, 1));
        addObject(new Caisse(272 * 16, 84 * 16, 2, 1));
        addObject(new Caisse(172 * 16, 6 * 16, 2, 1));
        addObject(new Caisse(172 * 16, 7 * 16, 2, 1));
        addObject(new Caisse(172 * 16, 8 * 16, 2, 1));
        addObject(new Caisse(260 * 16, 37 * 16, 2, 1));
        addObject(new Caisse(261 * 16, 38 * 16, 2, 1));
        addObject(new Caisse(260 * 16, 39 * 16, 2, 1));
        addObject(new Caisse(329 * 16, 5 * 16, 2, 1));
        addObject(new Caisse(330 * 16, 5 * 16, 2, 1));
        addObject(new Caisse(328 * 16, 6 * 16, 2, 1));
        addObject(new Caisse(331 * 16, 6 * 16, 2, 1));
        addObject(new Caisse(328 * 16, 7 * 16, 2, 1));
        addObject(new Caisse(331 * 16, 7 * 16, 2, 1));
        addObject(new Caisse(329 * 16, 8 * 16, 2, 1));
        addObject(new Caisse(330 * 16, 8 * 16, 2, 1));
        addObject(new Caisse(329 * 16, 35 * 16, 2, 2));
        addObject(new Caisse(329 * 16, 36 * 16, 2, 2));
        addObject(new Caisse(330 * 16, 36 * 16, 2, 3));
        addObject(new Caisse(331 * 16, 36 * 16, 2, 2));
        addObject(new Caisse(329 * 16, 37 * 16, 2, 1));
        addObject(new Caisse(330 * 16, 38 * 16, 2, 1));
        addObject(new Caisse(332 * 16, 38 * 16, 2, 2));
        addObject(new Caisse(326 * 16, 63 * 16, 2, 9));
        addObject(new Caisse(328 * 16, 63 * 16, 2, 9));
        addObject(new Caisse(330 * 16, 63 * 16, 2, 9));
        addObject(new Caisse(332 * 16, 63 * 16, 2, 9));
        addObject(new Caisse(334 * 16, 63 * 16, 2, 9));

        addEnnemi(new Ennemi009(250 * 16, 84 * 16));
        addEnnemi(new Ennemi009(311 * 16, 66 * 16));

        addEnnemi(new Ennemi010(279 * 16, 14 * 16));
        addEnnemi(new Ennemi010(255 * 16, 41 * 16));
        addEnnemi(new Ennemi010(264 * 16, 41 * 16));
        addEnnemi(new Ennemi010(354 * 16, 74 * 16));
        addEnnemi(new Ennemi010(139 * 16 + 8, 78 * 16));

        addEnnemi(new Ennemi022(185 * 16, 18 * 16 - 7));
        addEnnemi(new Ennemi022(245 * 16, 7 * 16 - 7));
        addEnnemi(new Ennemi022(252 * 16, 16 * 16 - 7));
        addEnnemi(new Ennemi022(245 * 16, 23 * 16 - 7));
        addEnnemi(new Ennemi022(348 * 16, 6 * 16 - 7));
        addEnnemi(new Ennemi022(270 * 16, 52 * 16 - 7));
        addEnnemi(new Ennemi022(266 * 16, 69 * 16 - 7));
        addEnnemi(new Ennemi022(272 * 16, 64 * 16 - 7));
        addEnnemi(new Ennemi022(349 * 16 + 8, 67 * 16 - 7));
        addEnnemi(new Ennemi022(349 * 16 + 8, 78 * 16 - 7));

        addEnnemi(new Ennemi023(209 * 16 + 3, 52 * 16 - 1));
        addEnnemi(new Ennemi023(267 * 16 + 3, 5 * 16 - 1));
        addEnnemi(new Ennemi023(291 * 16 + 3, 5 * 16 - 1));
        addEnnemi(new Ennemi023(313 * 16 + 3, 37 * 16 - 1));
        addEnnemi(new Ennemi023(291 * 16 + 3, 44 * 16 - 1));
        addEnnemi(new Ennemi023(286 * 16 + 3, 65 * 16 - 1));
        addEnnemi(new Ennemi023(291 * 16 + 3, 84 * 16 - 1));
        addEnnemi(new Ennemi023(129 * 16 + 3, 82 * 16 - 1));
        addEnnemi(new Ennemi023(149 * 16 + 3, 82 * 16 - 1));
        addEnnemi(new Ennemi023(109 * 16 + 3, 38 * 16 - 1));

        addEnnemi(new Ennemi027(309 * 16 + 8, 4 * 16 - 1));
        addEnnemi(new Ennemi027(247 * 16, 51 * 16 - 1));
    ...
    case 48:
        ...
        if (scene->getCoffre(3, 23))
            ouvrePorte(178, 21, 1);
        if (scene->getCoffre(3, 24))
            ouvrePorte(178, 51, 1);
        if (scene->getCoffre(3, 25))
            ouvrePorte(209, 58, 0);
        if (scene->getCoffre(3, 26))
            ouvrePorte(238, 36, 1);
        if (scene->getCoffre(3, 27))
            ouvrePorte(289, 13, 2);

        if (scene->getCoffre(3, 29))
            map->setSol(37 * 16, 50 * 16, 1936);
        if (scene->getCoffre(3, 30))
            map->setSol(37 * 16, 54 * 16, 1936);
        if (scene->getCoffre(3, 31))
            map->setSol(68 * 16, 27 * 16, 1936);
        if (scene->getCoffre(3, 32))
            map->setSol(71 * 16, 27 * 16, 1936);
        if (scene->getCoffre(3, 33))
            map->setSol(69 * 16, 41 * 16, 1936);
        if (scene->getCoffre(3, 34))
            map->setSol(70 * 16, 41 * 16, 1936);
        if (scene->getCoffre(3, 35))
            map->setSol(109 * 16, 7 * 16, 1936);
        if (scene->getCoffre(3, 36))
            map->setSol(102 * 16, 35 * 16, 1936);
        if (scene->getCoffre(3, 37))
            map->setSol(102 * 16, 39 * 16, 1936);
        if (scene->getCoffre(3, 38))
            map->setSol(127 * 16, 17 * 16, 1936);
        if (scene->getCoffre(3, 39))
            map->setSol(132 * 16, 17 * 16, 1936);
        if (scene->getCoffre(3, 40))
            map->setSol(186 * 16, 26 * 16, 1936);
        if (scene->getCoffre(3, 41))
            map->setSol(191 * 16, 49 * 16, 1936);
        if (scene->getCoffre(3, 42))
            map->setSol(191 * 16, 34 * 16, 1936);
        if (scene->getCoffre(3, 43))
            map->setSol(196 * 16, 34 * 16, 1936);
        if (scene->getCoffre(3, 44))
            map->setSol(207 * 16, 24 * 16, 1936);
        if (scene->getCoffre(3, 45))
            map->setSol(212 * 16, 24 * 16, 1936);
        if (scene->getCoffre(3, 46))
            map->setSol(204 * 16, 35 * 16, 1936);
        if (scene->getCoffre(3, 47))
            map->setSol(215 * 16, 35 * 16, 1936);
        if (scene->getCoffre(3, 48))
            map->setSol(206 * 16, 51 * 16, 1936);
        if (scene->getCoffre(3, 49))
            map->setSol(213 * 16, 51 * 16, 1936);
        if (scene->getCoffre(3, 50))
            map->setSol(224 * 16, 20 * 16, 1936);
        if (scene->getCoffre(3, 51))
            map->setSol(234 * 16, 26 * 16, 1936);
        if (scene->getCoffre(3, 52))
            map->setSol(229 * 16, 37 * 16, 1936);
        if (scene->getCoffre(3, 53))
            map->setSol(234 * 16, 53 * 16, 1936);
        if (scene->getCoffre(3, 54))
            map->setSol(227 * 16, 56 * 16, 1936);
        if (scene->getCoffre(3, 55))
            map->setSol(242 * 16, 49 * 16, 1936);
        if (scene->getCoffre(3, 56))
            map->setSol(242 * 16, 55 * 16, 1936);
        if (scene->getCoffre(3, 57))
            map->setSol(247 * 16, 57 * 16, 1936);
        if (scene->getCoffre(3, 58))
            map->setSol(252 * 16, 57 * 16, 1936);

        if (scene->getCoffre(3, 29) && scene->getCoffre(3, 30))
            ouvrePorte(38, 51, 1);
        if (scene->getCoffre(3, 31) && scene->getCoffre(3, 32))
            ouvrePorte(69, 28, 0);
        if (scene->getCoffre(3, 33) && scene->getCoffre(3, 34))
            addObject(new Coffre(75 * 16, 40 * 16, 0, scene->getCoffre(3, 6), TI_CLE, 6));
        if (scene->getCoffre(3, 35))
            ouvrePorte(98, 6, 1);
        if (scene->getCoffre(3, 36) && scene->getCoffre(3, 37))
            ouvrePorte(98, 36, 1);
        if (scene->getCoffre(3, 38) && scene->getCoffre(3, 39))
            ouvrePorte(129, 13, 0);
        if (scene->getCoffre(3, 40) && scene->getCoffre(3, 41) && scene->getCoffre(3, 42) && scene->getCoffre(3, 43) && scene->getCoffre(3, 44) && scene->getCoffre(3, 45) && scene->getCoffre(3, 46) && scene->getCoffre(3, 47) && scene->getCoffre(3, 48) && scene->getCoffre(3, 49) && scene->getCoffre(3, 50) && scene->getCoffre(3, 51) && scene->getCoffre(3, 52) && scene->getCoffre(3, 53) && scene->getCoffre(3, 54))
            ouvrePorte(209, 13, 0);
        if (scene->getCoffre(3, 55) && scene->getCoffre(3, 56))
            ouvrePorte(238, 51, 1);
        if (scene->getCoffre(3, 57) && scene->getCoffre(3, 58))
            ouvrePorte(249, 58, 0);
        ...
        addObject(new PiegeFeu(275 * 16, 49 * 16));
        addObject(new PiegeFeu(275 * 16, 55 * 16));
        addObject(new PiegeFeu(164 * 16, 70 * 16));
        addObject(new PiegeFeu(90 * 16, 67 * 16));
        addObject(new PiegeFeu(117 * 16, 4 * 16));
        addObject(new PiegeFeu(64 * 16, 32 * 16));
        addObject(new PiegeFeu(75 * 16, 32 * 16));
        addObject(new PiegeFeu(18 * 16, 21 * 16));

        addEnnemi(new Ennemi005(49 * 16 + 8, 67 * 16 - 10));
        addEnnemi(new Ennemi005(29 * 16 + 8, 52 * 16 - 10));
        addEnnemi(new Ennemi005(249 * 16 + 8, 52 * 16 - 10));
        addEnnemi(new Ennemi005(263 * 16, 18 * 16 - 10));
        addEnnemi(new Ennemi005(255 * 16 + 8, 27 * 16 - 10));
        addEnnemi(new Ennemi005(269 * 16 + 8, 37 * 16 - 10));
        addEnnemi(new Ennemi005(89 * 16 + 8, 52 * 16 - 10));
        addEnnemi(new Ennemi005(189 * 16 + 8, 66 * 16 - 10));
        addEnnemi(new Ennemi005(229 * 16 + 8, 7 * 16 - 10));
        addEnnemi(new Ennemi005(89 * 16 + 8, 7 * 16 - 10));
        addEnnemi(new Ennemi005(69 * 16 + 8, 7 * 16 - 10));
        addEnnemi(new Ennemi005(169 * 16 + 8, 7 * 16 - 10));
        addEnnemi(new Ennemi005(149 * 16 + 8, 22 * 16 - 10));
        addEnnemi(new Ennemi005(129 * 16 + 8, 52 * 16 - 10));

        addEnnemi(new Ennemi018(124 * 16, 63 * 16 + 2));
        addEnnemi(new Ennemi018(259 * 16, 48 * 16 + 2));
        addEnnemi(new Ennemi018(270 * 16, 21 * 16 + 2));
        addEnnemi(new Ennemi018(250 * 16, 23 * 16 + 2));
        addEnnemi(new Ennemi018(233 * 16, 63 * 16 + 2));
        addEnnemi(new Ennemi018(269 * 16, 72 * 16 + 2));
        addEnnemi(new Ennemi018(144 * 16, 64 * 16 + 2));
        addEnnemi(new Ennemi018(155 * 16, 64 * 16 + 2));
        addEnnemi(new Ennemi018(144 * 16, 69 * 16 + 2));
        addEnnemi(new Ennemi018(155 * 16, 69 * 16 + 2));
        addEnnemi(new Ennemi018(53 * 16, 48 * 16 + 2));
        addEnnemi(new Ennemi018(264 * 16, 11 * 16 + 2));
        addEnnemi(new Ennemi018(108 * 16, 23 * 16 + 2));
        addEnnemi(new Ennemi018(111 * 16, 23 * 16 + 2));
        addEnnemi(new Ennemi018(146 * 16, 12 * 16 + 2));
        addEnnemi(new Ennemi018(14 * 16, 12 * 16 + 2));

        addEnnemi(new Ennemi025(109 * 16 - 6 + 8, 66 * 16 + 2));
        addEnnemi(new Ennemi025(29 * 16 - 6 + 8, 66 * 16 + 2));
        addEnnemi(new Ennemi025(248 * 16 - 6 + 8, 66 * 16 + 2));
        addEnnemi(new Ennemi025(69 * 16 - 6 + 8, 49 * 16 + 2));
        addEnnemi(new Ennemi025(249 * 16 - 6 + 8, 5 * 16 + 2));
        addEnnemi(new Ennemi025(91 * 16 - 6 + 8, 21 * 16 + 2));
        addEnnemi(new Ennemi025(149 * 16 - 6 + 8, 51 * 16 + 2));
        addEnnemi(new Ennemi025(49 * 16 - 6 + 8, 36 * 16 + 2));
        addEnnemi(new Ennemi025(69 * 16 - 6 + 8, 21 * 16 + 2));
        addEnnemi(new Ennemi025(106 * 16 - 6 + 8, 36 * 16 + 2));
        addEnnemi(new Ennemi025(169 * 16 - 6 + 8, 21 * 16 + 2));

        addEnnemi(new Ennemi053(13 * 16, 69 * 16));
        addEnnemi(new Ennemi053(5 * 16, 63 * 16));
        addEnnemi(new Ennemi053(125 * 16, 5 * 16));
        addEnnemi(new Ennemi053(133 * 16, 10 * 16));
        addEnnemi(new Ennemi053(49 * 16 + 8, 22 * 16));
        addEnnemi(new Ennemi053(32 * 16, 7 * 16));
        addEnnemi(new Ennemi053(197 * 16, 26 * 16));
        addEnnemi(new Ennemi053(198 * 16, 47 * 16));
        addEnnemi(new Ennemi053(219 * 16, 27 * 16));
        addEnnemi(new Ennemi053(221 * 16, 47 * 16));
    ...
    case 49:
        ...
        if (scene->getCoffre(4, 8))
            ouvrePorte(49, 58, 0);
        if (scene->getCoffre(4, 9))
            ouvrePorte(69, 28, 0);
        if (scene->getCoffre(4, 10))
            ouvrePorte(118, 51, 1);
        if (scene->getCoffre(4, 11))
            ouvrePorte(129, 43, 0);
        ...
        if (scene->getCoffre(4, 22))
            map->setSol(222 * 16, 21 * 16, 1936);
        if (scene->getCoffre(4, 23))
            map->setSol(228 * 16, 27 * 16, 1936);
        if (scene->getCoffre(4, 24))
            map->setSol(231 * 16, 27 * 16, 1936);
        if (scene->getCoffre(4, 25))
            map->setSol(237 * 16, 19 * 16, 1936);
        if (scene->getCoffre(4, 26))
            map->setSol(222 * 16, 9 * 16, 1936);
        if (scene->getCoffre(4, 27))
            map->setSol(230 * 16, 2 * 16, 1936);
        if (scene->getCoffre(4, 28))
            map->setSol(237 * 16, 5 * 16, 1936);
        if (scene->getCoffre(4, 29))
            map->setSol(237 * 16, 9 * 16, 1936);
        if (scene->getCoffre(4, 31))
            map->setSol(117 * 16, 35 * 16, 1936);
        if (scene->getCoffre(4, 32))
            map->setSol(117 * 16, 39 * 16, 1936);

        if (scene->getCoffre(4, 22) && scene->getCoffre(4, 23) && scene->getCoffre(4, 24) && scene->getCoffre(4, 25) && scene->getCoffre(4, 26) && scene->getCoffre(4, 27) && scene->getCoffre(4, 28) && scene->getCoffre(4, 29))
            ouvrePorte(238, 6, 1);

        if (scene->getCoffre(4, 31) && scene->getCoffre(4, 32))
            ouvrePorte(118, 36, 1);
        ...
        addEnnemi(new Ennemi026(101 * 16, 21 * 16));
        addEnnemi(new Ennemi026(95 * 16, 31 * 16));
        addEnnemi(new Ennemi026(58 * 16, 61 * 16));
        addEnnemi(new Ennemi026(23 * 16, 64 * 16));
        addEnnemi(new Ennemi026(47 * 16, 8 * 16));
        addEnnemi(new Ennemi026(24 * 16, 0));
        addEnnemi(new Ennemi026(58 * 16, 15 * 16));
        addEnnemi(new Ennemi026(225 * 16, 80 * 16));
        addEnnemi(new Ennemi026(231 * 16, 84 * 16));
        addEnnemi(new Ennemi026(155 * 16, 72 * 16));
        addEnnemi(new Ennemi026(155 * 16, 76 * 16));

        addEnnemi(new Ennemi032(134 * 16, 22 * 16 - 7));
        addEnnemi(new Ennemi032(65 * 16, 50 * 16 - 7));
        addEnnemi(new Ennemi032(110 * 16, 52 * 16 - 7));
        addEnnemi(new Ennemi032(90 * 16, 67 * 16 - 7));
        addEnnemi(new Ennemi032(89 * 16, 82 * 16 - 7));
        addEnnemi(new Ennemi032(49 * 16, 52 * 16 - 7));
        addEnnemi(new Ennemi032(29 * 16, 52 * 16 - 7));
        addEnnemi(new Ennemi032(49 * 16, 36 * 16 - 7));
        addEnnemi(new Ennemi032(67 * 16, 7 * 16 - 7));
        addEnnemi(new Ennemi032(70 * 16, 4 * 16 - 7));
        addEnnemi(new Ennemi032(72 * 16, 10 * 16 - 7));
        addEnnemi(new Ennemi032(126 * 16, 38 * 16 - 7));
        addEnnemi(new Ennemi032(229 * 16, 67 * 16 - 7));
        addEnnemi(new Ennemi032(166 * 16, 84 * 16 - 7));
        addEnnemi(new Ennemi032(173 * 16, 82 * 16 - 7));
        addEnnemi(new Ennemi032(223 * 16, 10 * 16 - 7));

        /*addEnnemi(new Ennemi086(109*16,15*16));*/ addEnnemi(new Ennemi086(117 * 16, 8 * 16));
        addEnnemi(new Ennemi086(118 * 16, 21 * 16));
        addEnnemi(new Ennemi086(105 * 16, 34 * 16));
        /*addEnnemi(new Ennemi086(114*16,40*16));*/ addEnnemi(new Ennemi086(71 * 16, 43 * 16));
        addEnnemi(new Ennemi086(108 * 16, 76 * 16));
        addEnnemi(new Ennemi086(116 * 16, 85 * 16 - 8));
        addEnnemi(new Ennemi086(120 * 16, 64 * 16));
        addEnnemi(new Ennemi086(132 * 16, 75 * 16));
        addEnnemi(new Ennemi086(134 * 16, 55 * 16));
        addEnnemi(new Ennemi086(69 * 16, 82 * 16));
        addEnnemi(new Ennemi086(35 * 16, 71 * 16));
        addEnnemi(new Ennemi086(25 * 16, 34 * 16));
        addEnnemi(new Ennemi086(24 * 16 + 8, 21 * 16));
        addEnnemi(new Ennemi086(35 * 16, 11 * 16));
        addEnnemi(new Ennemi086(42 * 16, 23 * 16));
        addEnnemi(new Ennemi086(225 * 16, 37 * 16));
        addEnnemi(new Ennemi086(238 * 16, 36 * 16));
        addEnnemi(new Ennemi086(251 * 16, 39 * 16));
        addEnnemi(new Ennemi086(223 * 16, 17 * 16));
        addEnnemi(new Ennemi086(227 * 16, 7 * 16));
        addEnnemi(new Ennemi086(234 * 16, 20 * 16));
        addEnnemi(new Ennemi086(246 * 16, 63 * 16));
        addEnnemi(new Ennemi086(231 * 16, 51 * 16));
        addEnnemi(new Ennemi086(205 * 16, 78 * 16));
        addEnnemi(new Ennemi086(150 * 16, 57 * 16));
        addEnnemi(new Ennemi086(160 * 16, 65 * 16));
        addEnnemi(new Ennemi086(171 * 16, 57 * 16));
        addEnnemi(new Ennemi086(143 * 16, 22 * 16));
        addEnnemi(new Ennemi086(144 * 16, 39 * 16));
        addEnnemi(new Ennemi086(156 * 16, 31 * 16));
        addEnnemi(new Ennemi086(163 * 16, 18 * 16));
        addEnnemi(new Ennemi086(167 * 16, 40 * 16));
    ...
    case 50:
        ...
        if (scene->getCoffre(5, 25))
            ouvrePorte(269, 6, 4);
        if (scene->getCoffre(5, 26))
            ouvrePorte(58, 66, 1);
        if (scene->getCoffre(5, 28))
            ouvrePorte(129, 28, 0);
        if (scene->getCoffre(5, 29))
            ouvrePorte(158, 66, 1);
        ...
        if (scene->getCoffre(5, 32))
            ouvrePorte(189, 73, 0);
        if (scene->getCoffre(5, 33))
            ouvrePorte(209, 73, 0);
        if (scene->getCoffre(5, 34))
            ouvrePorte(258, 36, 1);
        if (scene->getCoffre(5, 35))
            ouvrePorte(249, 73, 0);
        if (scene->getCoffre(5, 36))
            ouvrePorte(249, 88, 0);
        ...
        addObject(new PiegeMain(242 * 16, 47 * 16));
        addObject(new PiegeMain(182 * 16, 77 * 16));
        addObject(new PiegeMain(182 * 16, 2 * 16));
        addObject(new PiegeMain(282 * 16, 77 * 16));
        addObject(new PiegeMain(282 * 16, 2 * 16));
        addObject(new PiegeMain(62 * 16, 62 * 16));

        addEnnemi(new Ennemi001(106 * 16, 50 * 16 + 6));
        addEnnemi(new Ennemi001(114 * 16, 55 * 16 + 6));
        addEnnemi(new Ennemi001(107 * 16, 84 * 16 + 6));
        addEnnemi(new Ennemi001(112 * 16, 79 * 16 + 6));
        addEnnemi(new Ennemi001(226 * 16, 96 * 16 + 6));
        addEnnemi(new Ennemi001(233 * 16, 97 * 16 + 6));
        addEnnemi(new Ennemi001(208 * 16, 66 * 16 + 6));
        addEnnemi(new Ennemi001(109 * 16, 20 * 16 + 6));
        addEnnemi(new Ennemi001(152 * 16, 23 * 16 + 6));
        addEnnemi(new Ennemi001(144 * 16, 21 * 16 + 6));
        addEnnemi(new Ennemi001(25 * 16, 50 * 16 + 6));
        addEnnemi(new Ennemi001(33 * 16, 53 * 16 + 6));
        addEnnemi(new Ennemi001(267 * 16, 36 * 16 + 6));
        addEnnemi(new Ennemi001(273 * 16, 38 * 16 + 6));
        addEnnemi(new Ennemi001(305 * 16, 49 * 16 + 6));
        addEnnemi(new Ennemi001(310 * 16, 53 * 16 + 6));
        addEnnemi(new Ennemi001(314 * 16, 50 * 16 + 6));

        addEnnemi(new Ennemi026(146 * 16, 66 * 16));
        addEnnemi(new Ennemi026(153 * 16, 66 * 16));
        addEnnemi(new Ennemi026(86 * 16, 65 * 16));
        addEnnemi(new Ennemi026(90 * 16, 71 * 16));
        addEnnemi(new Ennemi026(93 * 16, 64 * 16));
        addEnnemi(new Ennemi026(85 * 16, 53 * 16));
        addEnnemi(new Ennemi026(266 * 16, 63 * 16));
        addEnnemi(new Ennemi026(273 * 16, 69 * 16));
        addEnnemi(new Ennemi026(282 * 16, 48 * 16));
        addEnnemi(new Ennemi026(283 * 16, 56 * 16));
        addEnnemi(new Ennemi026(265 * 16, 101 * 16));
        addEnnemi(new Ennemi026(266 * 16, 93 * 16));
        addEnnemi(new Ennemi026(273 * 16, 97 * 16));
        addEnnemi(new Ennemi026(243 * 16, 93 * 16));
        addEnnemi(new Ennemi026(253 * 16, 101 * 16));
        addEnnemi(new Ennemi026(206 * 16, 71 * 16));
        addEnnemi(new Ennemi026(194 * 16, 63 * 16));
        addEnnemi(new Ennemi026(196 * 16, 71 * 16));
        addEnnemi(new Ennemi026(185 * 16, 39 * 16));
        addEnnemi(new Ennemi026(194 * 16, 34 * 16));
        addEnnemi(new Ennemi026(224 * 16, 11 * 16));
        addEnnemi(new Ennemi026(95 * 16, 16 * 16));
        addEnnemi(new Ennemi026(145 * 16, 42 * 16));
        addEnnemi(new Ennemi026(156 * 16, 35 * 16));
        addEnnemi(new Ennemi026(141 * 16, 49 * 16));
        addEnnemi(new Ennemi026(153 * 16, 58 * 16));
        addEnnemi(new Ennemi026(26 * 16, 42 * 16));
        addEnnemi(new Ennemi026(31 * 16, 31 * 16));
        addEnnemi(new Ennemi026(35 * 16, 39 * 16));
        addEnnemi(new Ennemi026(45 * 16, 63 * 16));
        addEnnemi(new Ennemi026(46 * 16, 71 * 16));
        addEnnemi(new Ennemi026(53 * 16, 63 * 16));
        addEnnemi(new Ennemi026(64 * 16, 33 * 16));
        addEnnemi(new Ennemi026(71 * 16, 31 * 16));
        addEnnemi(new Ennemi026(75 * 16, 38 * 16));
        addEnnemi(new Ennemi026(273 * 16, 26 * 16));
        addEnnemi(new Ennemi026(305 * 16, 69 * 16));
        addEnnemi(new Ennemi026(314 * 16, 65 * 16));

        addEnnemi(new Ennemi037(112 * 16, 48 * 16 - 10));
        addEnnemi(new Ennemi037(249 * 16, 96 * 16 - 10));
        addEnnemi(new Ennemi037(125 * 16, 20 * 16 - 10));
        addEnnemi(new Ennemi037(285 * 16, 66 * 16 - 10));
        addEnnemi(new Ennemi037(294 * 16, 68 * 16 - 10));

        addEnnemi(new Ennemi056(126 * 16 - 1, 80 * 16 - 1));
        addEnnemi(new Ennemi056(133 * 16 - 1, 80 * 16 - 1));
        addEnnemi(new Ennemi056(129 * 16 - 1, 71 * 16 - 1));
        addEnnemi(new Ennemi056(91 * 16 - 1, 49 * 16 - 1));
        addEnnemi(new Ennemi056(166 * 16 - 1, 82 * 16 - 1));
        addEnnemi(new Ennemi056(246 * 16 - 1, 67 * 16 - 1));
        addEnnemi(new Ennemi056(253 * 16 - 1, 67 * 16 - 1));
        addEnnemi(new Ennemi056(273 * 16 - 1, 53 * 16 - 1));
        addEnnemi(new Ennemi056(289 * 16 - 1, 52 * 16 - 1));
        addEnnemi(new Ennemi056(189 * 16 - 1, 85 * 16 - 1));
        addEnnemi(new Ennemi056(195 * 16 - 1, 95 * 16 - 1));
        addEnnemi(new Ennemi056(202 * 16 - 1, 87 * 16 - 1));
        addEnnemi(new Ennemi056(212 * 16 - 1, 89 * 16 - 1));
        addEnnemi(new Ennemi056(190 * 16 - 1, 10 * 16 - 1));
        addEnnemi(new Ennemi056(195 * 16 - 1, 20 * 16 - 1));
        addEnnemi(new Ennemi056(203 * 16 - 1, 9 * 16 - 1));
        addEnnemi(new Ennemi056(206 * 16 - 1, 18 * 16 - 1));
        addEnnemi(new Ennemi056(229 * 16 - 1, 36 * 16 - 1));
        addEnnemi(new Ennemi056(106 * 16 - 1, 40 * 16 - 1));
        addEnnemi(new Ennemi056(113 * 16 - 1, 33 * 16 - 1));
        addEnnemi(new Ennemi056(249 * 16 - 1, 37 * 16 - 1));
        addEnnemi(new Ennemi056(169 * 16 - 1, 66 * 16 - 1));
        addEnnemi(new Ennemi056(33 * 16 - 1, 66 * 16 - 1));
        addEnnemi(new Ennemi056(66 * 16 - 1, 50 * 16 - 1));
        addEnnemi(new Ennemi056(73 * 16 - 1, 54 * 16 - 1));
        addEnnemi(new Ennemi056(50 * 16 - 1, 48 * 16 - 1));
        addEnnemi(new Ennemi056(273 * 16 - 1, 7 * 16 - 1));
        addEnnemi(new Ennemi056(287 * 16 - 1, 14 * 16 - 1));
        addEnnemi(new Ennemi056(296 * 16 - 1, 7 * 16 - 1));
        addEnnemi(new Ennemi056(297 * 16 - 1, 24 * 16 - 1));
        addEnnemi(new Ennemi056(307 * 16 - 1, 14 * 16 - 1));
        addEnnemi(new Ennemi056(287 * 16 - 1, 36 * 16 - 1));

        addEnnemi(new Ennemi062(269 * 16 + 4, 81 * 16, false));
        addEnnemi(new Ennemi062(189 * 16 + 4, 51 * 16, false));
        addEnnemi(new Ennemi062(298 * 16 + 4, 90 * 16, false));

        addEnnemi(new Ennemi064(106 * 16 - 4, 65 * 16 - 4));
        addEnnemi(new Ennemi064(112 * 16 - 4, 69 * 16 - 4));
        addEnnemi(new Ennemi064(93 * 16 - 4, 82 * 16 - 4));
        addEnnemi(new Ennemi064(148 * 16 - 4, 84 * 16 - 4));
        addEnnemi(new Ennemi064(152 * 16 - 4, 78 * 16 - 4));
        addEnnemi(new Ennemi064(229 * 16 - 4, 66 * 16 - 4));
        addEnnemi(new Ennemi064(189 * 16 - 4, 66 * 16 - 4));
        addEnnemi(new Ennemi064(228 * 16 - 4, 6 * 16 - 4));
        addEnnemi(new Ennemi064(209 * 16 - 4, 36 * 16 - 4));
        addEnnemi(new Ennemi064(209 * 16 - 4, 53 * 16 - 4));
        addEnnemi(new Ennemi064(218 * 16 - 4, 50 * 16 - 4));
        addEnnemi(new Ennemi064(227 * 16 - 4, 52 * 16 - 4));
        addEnnemi(new Ennemi064(89 * 16 - 4, 37 * 16 - 4));
        addEnnemi(new Ennemi064(166 * 16 - 4, 21 * 16 - 4));
        addEnnemi(new Ennemi064(69 * 16 - 4, 66 * 16 - 4));
        addEnnemi(new Ennemi064(271 * 16 - 4, 21 * 16 - 4));
        addEnnemi(new Ennemi064(292 * 16 - 4, 12 * 16 - 4));
        addEnnemi(new Ennemi064(309 * 16 - 4, 36 * 16 - 4));

        addEnnemi(new Ennemi091(229 * 16 + 5, 82 * 16));
        addEnnemi(new Ennemi091(226 * 16 + 5, 20 * 16));
        addEnnemi(new Ennemi091(232 * 16 + 5, 23 * 16));
        addEnnemi(new Ennemi091(119 * 16 + 5, 23 * 16));
        addEnnemi(new Ennemi091(135 * 16 + 5, 23 * 16));
        addEnnemi(new Ennemi091(46 * 16 + 5, 34 * 16));
        addEnnemi(new Ennemi091(48 * 16 + 5, 39 * 16));
        addEnnemi(new Ennemi091(53 * 16 + 5, 36 * 16));
        addEnnemi(new Ennemi091(288 * 16 + 5, 89 * 16));
        addEnnemi(new Ennemi091(296 * 16 + 5, 96 * 16));
        addEnnemi(new Ennemi091(298 * 16 + 5, 83 * 16));
        addEnnemi(new Ennemi091(307 * 16 + 5, 91 * 16));

        addEnnemi(new Ennemi101(29 * 16, 58 * 16, S));
        addEnnemi(new Ennemi101(238 * 16, 36 * 16 + 8, E));
    ...
    case 51:
        ...
        addObject(new PiegeMurs(80 * 16, 41 * 16 - 1));
        addObject(new PiegeMurs(160 * 16, 41 * 16 - 1));

        addObject(new PiegePics(164 * 16, 64 * 16 - 8, S));
        addObject(new PiegePics(34 * 16, 36 * 16 - 8, S));
        addObject(new PiegePics(113 * 16, 21 * 16, S));
        addObject(new PiegePics(114 * 16, 22 * 16, S));
        addObject(new PiegePics(115 * 16, 23 * 16, S));
        addObject(new PiegePics(286 * 16, 51 * 16, S));
        addObject(new PiegePics(293 * 16, 51 * 16, S));
        addObject(new PiegePics(192 * 16, 51 * 16, S));
        addObject(new PiegePics(194 * 16, 51 * 16, S));
        addObject(new PiegePics(196 * 16, 51 * 16, S));
        addObject(new PiegePics(269 * 16, 100 * 16, S));
        addObject(new PiegePics(271 * 16, 93 * 16, S));

        addObject(new PiegeLong(109 * 16, 81 * 16 - 8, S));
        addObject(new PiegeLong(26 * 16, 55 * 16 + 8, S));
        addObject(new PiegeLong(86 * 16, 64 * 16, S));

        addEnnemi(new Ennemi007(146 * 16, 70 * 16));
        addEnnemi(new Ennemi007(154 * 16, 63 * 16));
        addEnnemi(new Ennemi007(143 * 16, 21 * 16));
        addEnnemi(new Ennemi007(147 * 16, 26 * 16));
        addEnnemi(new Ennemi007(148 * 16, 18 * 16));
        addEnnemi(new Ennemi007(151 * 16, 22 * 16));
        addEnnemi(new Ennemi007(153 * 16, 25 * 16));
        addEnnemi(new Ennemi007(156 * 16, 20 * 16));
        addEnnemi(new Ennemi007(129 * 16 + 8, 81 * 16));
        addEnnemi(new Ennemi007(45 * 16, 55 * 16));
        addEnnemi(new Ennemi007(49 * 16, 54 * 16));
        addEnnemi(new Ennemi007(55 * 16, 51 * 16));
        addEnnemi(new Ennemi007(105 * 16, 71 * 16));
        addEnnemi(new Ennemi007(106 * 16, 63 * 16));
        addEnnemi(new Ennemi007(115 * 16, 66 * 16));
        addEnnemi(new Ennemi007(288 * 16, 88 * 16));
        addEnnemi(new Ennemi007(297 * 16, 97 * 16));
        addEnnemi(new Ennemi007(302 * 16, 81 * 16));
        addEnnemi(new Ennemi007(312 * 16, 87 * 16));
        addEnnemi(new Ennemi007(294 * 16, 20 * 16));
        addEnnemi(new Ennemi007(296 * 16, 11 * 16));
        addEnnemi(new Ennemi007(304 * 16, 22 * 16));
        addEnnemi(new Ennemi007(306 * 16, 12 * 16));
        addEnnemi(new Ennemi007(307 * 16, 37 * 16));
        addEnnemi(new Ennemi007(275 * 16, 81 * 16));
        addEnnemi(new Ennemi007(226 * 16, 96 * 16));
        addEnnemi(new Ennemi007(233 * 16, 98 * 16));
        addEnnemi(new Ennemi007(199 * 16, 85 * 16));
        addEnnemi(new Ennemi007(207 * 16, 98 * 16));
        addEnnemi(new Ennemi007(209 * 16, 88 * 16));
        addEnnemi(new Ennemi007(189 * 16, 18 * 16));
        addEnnemi(new Ennemi007(196 * 16, 8 * 16));
        addEnnemi(new Ennemi007(201 * 16, 21 * 16));
        addEnnemi(new Ennemi007(214 * 16, 15 * 16));
        addEnnemi(new Ennemi007(226 * 16, 51 * 16));
        addEnnemi(new Ennemi007(230 * 16, 54 * 16));

        addEnnemi(new Ennemi016(149 * 16 + 8, 37 * 16 - 8));
        addEnnemi(new Ennemi016(51 * 16 + 8, 37 * 16 - 8));
        addEnnemi(new Ennemi016(69 * 16 + 8, 37 * 16 - 8));
        addEnnemi(new Ennemi016(69 * 16 + 8, 67 * 16 - 8));
        addEnnemi(new Ennemi016(109 * 16 + 8, 51 * 16 - 8));
        addEnnemi(new Ennemi016(149 * 16 + 8, 82 * 16 - 8));
        addEnnemi(new Ennemi016(289 * 16 + 8, 52 * 16 - 8));
        addEnnemi(new Ennemi016(268 * 16, 85 * 16));
        addEnnemi(new Ennemi016(229 * 16 + 8, 67 * 16 - 8));
        addEnnemi(new Ennemi016(189 * 16 + 8, 37 * 16 - 8));
        addEnnemi(new Ennemi016(209 * 16 + 8, 67 * 16 - 8));
        addEnnemi(new Ennemi016(270 * 16, 97 * 16 - 8));
        addEnnemi(new Ennemi016(249 * 16 + 8, 82 * 16 - 8));

        addEnnemi(new Ennemi029(125 * 16, 64 * 16 - 10));
        addEnnemi(new Ennemi029(134 * 16, 68 * 16 - 10));
        addEnnemi(new Ennemi029(166 * 16, 66 * 16 - 10));
        addEnnemi(new Ennemi029(47 * 16, 34 * 16 - 10));
        addEnnemi(new Ennemi029(65 * 16, 52 * 16 - 10));
        addEnnemi(new Ennemi029(73 * 16, 54 * 16 - 10));
        addEnnemi(new Ennemi029(54 * 16, 66 * 16 - 10));
        addEnnemi(new Ennemi029(27 * 16, 65 * 16 - 10));
        addEnnemi(new Ennemi029(34 * 16, 68 * 16 - 10));
        addEnnemi(new Ennemi029(105 * 16, 54 * 16 - 10));
        addEnnemi(new Ennemi029(114 * 16, 56 * 16 - 10));
        addEnnemi(new Ennemi029(147 * 16, 50 * 16 - 10));
        addEnnemi(new Ennemi029(153 * 16, 52 * 16 - 10));
        addEnnemi(new Ennemi029(292 * 16, 71 * 16 - 10));
        addEnnemi(new Ennemi029(294 * 16, 63 * 16 - 10));
        addEnnemi(new Ennemi029(266 * 16, 8 * 16 - 10));
        addEnnemi(new Ennemi029(272 * 16, 3 * 16 - 10));
        addEnnemi(new Ennemi029(307 * 16, 51 * 16 - 10));
        addEnnemi(new Ennemi029(286 * 16, 37 * 16 - 10));
        addEnnemi(new Ennemi029(270 * 16, 51 * 16 - 10));
        addEnnemi(new Ennemi029(273 * 16, 66 * 16 - 10));
        addEnnemi(new Ennemi029(249 * 16, 96 * 16 - 10));
        addEnnemi(new Ennemi029(228 * 16, 6 * 16 - 10));
        addEnnemi(new Ennemi029(205 * 16, 35 * 16 - 10));
        addEnnemi(new Ennemi029(214 * 16, 37 * 16 - 10));
        addEnnemi(new Ennemi029(193 * 16, 66 * 16 - 10));
        addEnnemi(new Ennemi029(233 * 16, 78 * 16 - 10));

        addEnnemi(new Ennemi062(309 * 16 + 4, 67 * 16, false));
        addEnnemi(new Ennemi062(207 * 16 + 4, 51 * 16, false));
    ...
    case 52:
        ...
        addObject(new TasDePierres(156 * 16, 71 * 16, 1));
        addObject(new TasDePierres(243 * 16, 41 * 16, 1));

        addObject(new Pierre(16 * 265, 16 * 6, 8, map));
        addObject(new Pierre(16 * 265, 16 * 7, 8, map));
        addObject(new Pierre(16 * 265, 16 * 8, 8, map));

        addObject(new Caisse(310 * 16, 81 * 16, 0, 1));
        addObject(new Caisse(309 * 16, 82 * 16, 0, 1));
        addObject(new Caisse(310 * 16, 83 * 16, 0, 1));

        addEnnemi(new Ennemi007(147 * 16, 66 * 16));
        addEnnemi(new Ennemi007(153 * 16, 68 * 16));
        addEnnemi(new Ennemi007(146 * 16, 85 * 16));
        addEnnemi(new Ennemi007(148 * 16, 79 * 16));
        addEnnemi(new Ennemi007(152 * 16, 86 * 16));
        addEnnemi(new Ennemi007(105 * 16, 50 * 16));
        addEnnemi(new Ennemi007(114 * 16, 54 * 16));
        addEnnemi(new Ennemi007(167 * 16, 41 * 16));
        addEnnemi(new Ennemi007(173 * 16, 40 * 16));
        addEnnemi(new Ennemi007(114 * 16, 22 * 16));
        addEnnemi(new Ennemi007(165 * 16, 20 * 16));
        addEnnemi(new Ennemi007(174 * 16, 23 * 16));
        addEnnemi(new Ennemi007(189 * 16 + 8, 22 * 16));
        addEnnemi(new Ennemi007(263 * 16, 63 * 16));
        addEnnemi(new Ennemi007(276 * 16, 71 * 16));
        addEnnemi(new Ennemi007(287 * 16, 82 * 16));
        addEnnemi(new Ennemi007(309 * 16 + 8, 7 * 16));
        addEnnemi(new Ennemi007(203 * 16, 63 * 16));
        addEnnemi(new Ennemi007(216 * 16, 71 * 16));

        addEnnemi(new Ennemi030(124 * 16 + 8, 67 * 16 - 8));
        addEnnemi(new Ennemi030(134 * 16 + 8, 67 * 16 - 8));
        addEnnemi(new Ennemi030(109 * 16 + 8, 67 * 16 - 8));
        addEnnemi(new Ennemi030(83 * 16 + 8, 33 * 16));
        addEnnemi(new Ennemi030(95 * 16 + 8, 40 * 16));
        addEnnemi(new Ennemi030(89 * 16 + 8, 18 * 16 - 8));
        addEnnemi(new Ennemi030(129 * 16 + 8, 22 * 16 - 8));
        addEnnemi(new Ennemi030(49 * 16 + 8, 37 * 16 - 8));
        addEnnemi(new Ennemi030(29 * 16 + 8, 67 * 16 - 8));
        addEnnemi(new Ennemi030(69 * 16 + 8, 67 * 16 - 8));
        addEnnemi(new Ennemi030(229 * 16 + 8, 67 * 16 - 8));
        addEnnemi(new Ennemi030(229 * 16 + 8, 7 * 16 - 8));
        addEnnemi(new Ennemi030(229 * 16 + 8, 37 * 16 - 8));
        addEnnemi(new Ennemi030(189 * 16 + 8, 37 * 16 - 8));
        addEnnemi(new Ennemi030(289 * 16 + 8, 97 * 16 - 8));
        addEnnemi(new Ennemi030(309 * 16 + 8, 22 * 16 - 8));
        addEnnemi(new Ennemi030(289 * 16 + 8, 7 * 16 - 8));

        addEnnemi(new Ennemi042(125 * 16 - 5, 81 * 16 - 3));
        addEnnemi(new Ennemi042(134 * 16 - 5, 81 * 16 - 3));
        addEnnemi(new Ennemi042(85 * 16 - 5, 68 * 16 - 3));
        addEnnemi(new Ennemi042(89 * 16 - 5, 64 * 16 - 3));
        addEnnemi(new Ennemi042(92 * 16 - 5, 69 * 16 - 3));
        addEnnemi(new Ennemi042(169 * 16 - 5 + 8, 69 * 16 - 3));
        addEnnemi(new Ennemi042(85 * 16 - 5, 79 * 16 - 3));
        addEnnemi(new Ennemi042(93 * 16 - 5, 84 * 16 - 3));
        addEnnemi(new Ennemi042(106 * 16 - 5, 37 * 16 - 3));
        addEnnemi(new Ennemi042(114 * 16 - 5, 39 * 16 - 3));
        addEnnemi(new Ennemi042(93 * 16 - 5, 22 * 16 - 3));
        addEnnemi(new Ennemi042(149 * 16 - 5 + 8, 22 * 16 - 3));
        addEnnemi(new Ennemi042(69 * 16 - 5 + 8, 52 * 16 - 3));
        addEnnemi(new Ennemi042(249 * 16 - 5 + 8, 97 * 16 - 3));
        addEnnemi(new Ennemi042(189 * 16 - 5 + 8, 7 * 16 - 3));
        addEnnemi(new Ennemi042(209 * 16 - 5 + 8, 37 * 16 - 3));
        addEnnemi(new Ennemi042(189 * 16 - 5 + 8, 67 * 16 - 3));
        addEnnemi(new Ennemi042(309 * 16 - 5 + 8, 67 * 16 - 3));
        addEnnemi(new Ennemi042(269 * 16 - 5 + 8, 22 * 16 - 3));

        addEnnemi(new Ennemi062(166 * 16 + 4, 80 * 16, false));
        addEnnemi(new Ennemi062(171 * 16 + 4, 83 * 16, false));
        addEnnemi(new Ennemi062(106 * 16 + 4, 80 * 16, false));
        addEnnemi(new Ennemi062(111 * 16 + 4, 84 * 16, false));
    ...
    case 53:
        ...
        if (scene->getCoffre(8, 8))
            ouvrePorte(18, 51, 1);
        if (scene->getCoffre(8, 9))
            ouvrePorte(98, 21, 1);
        ...
        addObject(new PiegeLong(106 * 16, 49 * 16, S));
        addObject(new PiegeLong(126 * 16, 4 * 16, S));

        addEnnemi(new Ennemi012(234 * 16, 48 * 16));
        addEnnemi(new Ennemi012(234 * 16, 54 * 16));
        addEnnemi(new Ennemi012(225 * 16, 38 * 16));
        addEnnemi(new Ennemi012(230 * 16, 35 * 16));
        addEnnemi(new Ennemi012(234 * 16, 37 * 16));
        addEnnemi(new Ennemi012(184 * 16, 30 * 16));
        addEnnemi(new Ennemi012(193 * 16, 37 * 16));
        addEnnemi(new Ennemi012(204 * 16, 22 * 16));
        addEnnemi(new Ennemi012(215 * 16, 28 * 16));
        addEnnemi(new Ennemi012(229 * 16 + 8, 8 * 16));
        addEnnemi(new Ennemi012(229 * 16 + 8, 22 * 16));
        addEnnemi(new Ennemi012(209 * 16 + 8, 51 * 16));
        addEnnemi(new Ennemi012(187 * 16, 50 * 16));
        addEnnemi(new Ennemi012(192 * 16, 53 * 16));
        addEnnemi(new Ennemi012(169 * 16, 52 * 16));

        addEnnemi(new Ennemi013(44 * 16, 46 * 16 - 4));
        addEnnemi(new Ennemi013(55 * 16, 46 * 16 - 4));
        addEnnemi(new Ennemi013(58 * 16, 31 * 16 - 4));
        addEnnemi(new Ennemi013(40 * 16, 39 * 16 - 4));
        addEnnemi(new Ennemi013(21 * 16, 31 * 16 - 4));
        addEnnemi(new Ennemi013(18 * 16, 43 * 16 - 4));
        addEnnemi(new Ennemi013(44 * 16, 16 * 16 - 4));
        addEnnemi(new Ennemi013(18 * 16, 13 * 16 - 4));
        addEnnemi(new Ennemi013(61 * 16, 13 * 16 - 4));
        addEnnemi(new Ennemi013(142 * 16, 36 * 16 - 4));
        addEnnemi(new Ennemi013(144 * 16, 43 * 16 - 4));
        addEnnemi(new Ennemi013(149 * 16, 31 * 16 - 4));
        addEnnemi(new Ennemi013(155 * 16, 43 * 16 - 4));
        addEnnemi(new Ennemi013(157 * 16, 36 * 16 - 4));
        addEnnemi(new Ennemi013(124 * 16, 46 * 16 - 4));
        addEnnemi(new Ennemi013(135 * 16, 46 * 16 - 4));
        addEnnemi(new Ennemi013(109 * 16, 37 * 16 - 4));
        addEnnemi(new Ennemi013(104 * 16, 24 * 16 - 4));
        addEnnemi(new Ennemi013(134 * 16, 24 * 16 - 4));
        addEnnemi(new Ennemi013(147 * 16, 7 * 16 - 4));
        addEnnemi(new Ennemi013(146 * 16, 16 * 16 - 4));
        addEnnemi(new Ennemi013(152 * 16, 28 * 16 - 4));
        addEnnemi(new Ennemi013(105 * 16, 1 * 16 - 4));
        addEnnemi(new Ennemi013(114 * 16, 1 * 16 - 4));
        addEnnemi(new Ennemi013(84 * 16, 46 * 16 - 4));
        addEnnemi(new Ennemi013(90 * 16, 58 * 16 - 4));
        addEnnemi(new Ennemi013(96 * 16, 46 * 16 - 4));

        addEnnemi(new Ennemi033(26 * 16 - 3 + 8, 50 * 16 - 9));
        addEnnemi(new Ennemi033(32 * 16 - 3 + 8, 50 * 16 - 9));
        addEnnemi(new Ennemi033(49 * 16 - 3, 52 * 16 - 9));
        addEnnemi(new Ennemi033(67 * 16 - 3, 51 * 16 - 9));
        addEnnemi(new Ennemi033(71 * 16 - 3, 55 * 16 - 9));
        addEnnemi(new Ennemi033(73 * 16 - 3, 49 * 16 - 9));
        addEnnemi(new Ennemi033(69 * 16 - 3, 36 * 16 - 9));
        addEnnemi(new Ennemi033(13 * 16 - 3, 51 * 16 - 9));
        addEnnemi(new Ennemi033(6 * 16 - 3, 35 * 16 - 9));
        addEnnemi(new Ennemi033(11 * 16 - 3, 39 * 16 - 9));
        addEnnemi(new Ennemi033(65 * 16 - 3, 22 * 16 - 9));
        addEnnemi(new Ennemi033(26 * 16 - 3, 20 * 16 - 9));
        addEnnemi(new Ennemi033(6 * 16 - 3, 7 * 16 - 9));
        addEnnemi(new Ennemi033(12 * 16 - 3, 4 * 16 - 9));
        addEnnemi(new Ennemi033(13 * 16 - 3, 21 * 16 - 9));
        addEnnemi(new Ennemi033(51 * 16 - 3, 5 * 16 - 9));
        addEnnemi(new Ennemi033(69 * 16 - 3, 6 * 16 - 9));
        addEnnemi(new Ennemi033(91 * 16 - 3, 107 * 16 - 9));
        addEnnemi(new Ennemi033(93 * 16 - 3, 115 * 16 - 9));
        addEnnemi(new Ennemi033(129 * 16 - 3, 111 * 16 - 9));
        addEnnemi(new Ennemi033(85 * 16 - 3, 84 * 16 - 9));
        addEnnemi(new Ennemi033(109 * 16 - 3, 87 * 16 - 9));
        addEnnemi(new Ennemi033(120 * 16 - 3, 95 * 16 - 9));
        addEnnemi(new Ennemi033(128 * 16 - 3, 84 * 16 - 9));
        addEnnemi(new Ennemi033(109 * 16 - 3, 66 * 16 - 9));
        addEnnemi(new Ennemi033(147 * 16 - 3, 66 * 16 - 9));
        addEnnemi(new Ennemi033(146 * 16 - 3, 95 * 16 - 9));
        addEnnemi(new Ennemi033(152 * 16 - 3, 98 * 16 - 9));
        addEnnemi(new Ennemi033(148 * 16 - 3, 111 * 16 - 9));

        addEnnemi(new Ennemi034(109 * 16 - 4 + 8, 111 * 16 - 9));
        addEnnemi(new Ennemi034(91 * 16 - 4, 65 * 16 - 9));
        addEnnemi(new Ennemi034(89 * 16 - 4 + 8, 96 * 16 - 9));
        addEnnemi(new Ennemi034(129 * 16 - 4 + 8, 66 * 16 - 9));
        addEnnemi(new Ennemi034(9 * 16 - 4, 66 * 16 - 9));
        addEnnemi(new Ennemi034(10 * 16 - 4, 81 * 16 - 9));
        addEnnemi(new Ennemi034(10 * 16 - 4, 112 * 16 - 9));
        addEnnemi(new Ennemi034(11 * 16 - 4, 97 * 16 - 9));
        addEnnemi(new Ennemi034(28 * 16 - 4, 111 * 16 - 9));
        addEnnemi(new Ennemi034(29 * 16 - 4, 67 * 16 - 9));
        addEnnemi(new Ennemi034(30 * 16 - 4, 88 * 16 - 9));
        addEnnemi(new Ennemi034(38 * 16 - 4, 81 * 16 - 9));
        addEnnemi(new Ennemi034(41 * 16 - 4, 93 * 16 - 9));
        addEnnemi(new Ennemi034(49 * 16 - 4, 112 * 16 - 9));
        addEnnemi(new Ennemi034(50 * 16 - 4, 65 * 16 - 9));
        addEnnemi(new Ennemi034(51 * 16 - 4, 85 * 16 - 9));
        addEnnemi(new Ennemi034(69 * 16 - 4, 111 * 16 - 9));
        addEnnemi(new Ennemi034(70 * 16 - 4, 67 * 16 - 9));
        addEnnemi(new Ennemi034(65 * 16 - 4, 96 * 16 - 9));
        addEnnemi(new Ennemi034(74 * 16 - 4, 96 * 16 - 9));
    ...
    case 54:
        ...
        if (scene->getCoffre(9, 26))
            ouvrePorte(109, 43, 0);
        if (scene->getCoffre(9, 27))
            ouvrePorte(118, 6, 1);
        if (scene->getCoffre(9, 28))
            ouvrePorte(118, 51, 1);
        if (scene->getCoffre(9, 29))
            ouvrePorte(158, 51, 1);
        if (scene->getCoffre(9, 30))
            ouvrePorte(169, 28, 0);
        if (scene->getCoffre(9, 31))
            ouvrePorte(178, 81, 1);
        if (scene->getCoffre(9, 32))
            ouvrePorte(218, 36, 1);
        if (scene->getCoffre(9, 33))
            ouvrePorte(229, 73, 0);
        if (scene->getCoffre(9, 34))
            ouvrePorte(238, 81, 1);
        if (scene->getCoffre(9, 35))
            ouvrePorte(249, 58, 0);
        if (scene->getCoffre(9, 36))
            map->setSol(102 * 16, 71 * 16, 1936);
        if (scene->getCoffre(9, 37))
            map->setSol(115 * 16, 62 * 16, 1936);
        if (scene->getCoffre(9, 38))
            map->setSol(127 * 16, 62 * 16, 1936);
        if (scene->getCoffre(9, 39))
            map->setSol(135 * 16, 62 * 16, 1936);
        if (scene->getCoffre(9, 40))
            map->setSol(133 * 16, 76 * 16, 1936);
        if (scene->getCoffre(9, 41))
            map->setSol(107 * 16, 80 * 16, 1936);
        if (scene->getCoffre(9, 42))
            map->setSol(102 * 16, 86 * 16, 1936);
        if (scene->getCoffre(9, 43))
            map->setSol(107 * 16, 86 * 16, 1936);
        if (scene->getCoffre(9, 44))
            map->setSol(130 * 16, 86 * 16, 1936);
        if (scene->getCoffre(9, 45))
            map->setSol(135 * 16, 83 * 16, 1936);
        if (scene->getCoffre(9, 36) && scene->getCoffre(9, 37) && scene->getCoffre(9, 38) && scene->getCoffre(9, 39) && scene->getCoffre(9, 40) && scene->getCoffre(9, 41) && scene->getCoffre(9, 42) && scene->getCoffre(9, 43) && scene->getCoffre(9, 44) && scene->getCoffre(9, 45))
            ouvrePorte(129, 58, 0);
        ...
        if (scene->getCoffre(9, 54))
            ouvrePorte(98, 81, 1);
        if (scene->getCoffre(9, 55))
            ouvrePorte(229, 58, 0);
        ...
        addObject(new Interrupteur(235 * 16, 85 * 16, 0, scene->getCoffre(9, 34), map, false));
        map->setSol(235 * 16, 85 * 16, scene->getCoffre(9, 34) ? 2546 : 2545, PIERRE);
        addObject(new Interrupteur(248 * 16, 70 * 16, 0, scene->getCoffre(9, 35), map));

        addObject(new Caisse(88 * 16, 81 * 16, 5, 5));
        addObject(new Caisse(90 * 16, 81 * 16, 5, 3));
        addObject(new Caisse(91 * 16, 84 * 16, 5, 3));
        addObject(new Caisse(247 * 16, 39 * 16, 5));
        addObject(new Caisse(249 * 16, 35 * 16, 5));
        addObject(new Caisse(250 * 16, 39 * 16, 5));
        addObject(new Caisse(130 * 16, 76 * 16, 5));
        addObject(new Caisse(130 * 16, 77 * 16, 5));
        addObject(new Caisse(224 * 16, 79 * 16, 5));
        addObject(new Caisse(230 * 16, 52 * 16, 5, 3));
        addObject(new Caisse(224 * 16, 85 * 16, 5));
        addObject(new Caisse(235 * 16, 79 * 16, 5));
        addObject(new Caisse(235 * 16, 85 * 16, 5));
        addObject(new Caisse(229 * 16, 51 * 16, 5, 1));
        addObject(new Caisse(230 * 16, 51 * 16, 5, 4));
        addObject(new Caisse(229 * 16, 52 * 16, 5, 2));

        addEnnemi(new Ennemi002(109 * 16 - 3 + 8, 36 * 16 + 6));
        addEnnemi(new Ennemi002(67 * 16 - 3 + 8, 65 * 16 + 6));
        addEnnemi(new Ennemi002(71 * 16 - 3 + 8, 68 * 16 + 6));
        addEnnemi(new Ennemi002(50 * 16 - 3 + 8, 51 * 16 + 6));
        addEnnemi(new Ennemi002(147 * 16 - 3 + 8, 26 * 16 + 6));
        addEnnemi(new Ennemi002(149 * 16 - 3 + 8, 34 * 16 + 6));
        addEnnemi(new Ennemi002(152 * 16 - 3 + 8, 30 * 16 + 6));
        addEnnemi(new Ennemi002(209 * 16 - 3 + 8, 65 * 16 + 6));
        addEnnemi(new Ennemi002(209 * 16 - 3 + 8, 81 * 16 + 6));
        addEnnemi(new Ennemi002(228 * 16 - 3 + 8, 36 * 16 + 6));

        addEnnemi(new Ennemi041(69 * 16, 42 * 16 - 8));
        addEnnemi(new Ennemi041(76 * 16, 50 * 16 - 8));
        addEnnemi(new Ennemi041(91 * 16, 48 * 16 - 8));
        addEnnemi(new Ennemi041(127 * 16, 52 * 16 - 8));
        addEnnemi(new Ennemi041(130 * 16, 10 * 16 - 8));

        addEnnemi(new Ennemi042(111 * 16 - 5, 77 * 16 - 3));
        addEnnemi(new Ennemi042(117 * 16 - 5, 67 * 16 - 3));
        addEnnemi(new Ennemi042(121 * 16 - 5, 75 * 16 - 3));
        addEnnemi(new Ennemi042(109 * 16 - 5, 52 * 16 - 3));
        addEnnemi(new Ennemi042(30 * 16 - 5, 82 * 16 - 3));
        addEnnemi(new Ennemi042(42 * 16 - 5, 73 * 16 - 3));
        addEnnemi(new Ennemi042(31 * 16 - 5, 33 * 16 - 3));
        addEnnemi(new Ennemi042(39 * 16 - 5, 37 * 16 - 3));
        addEnnemi(new Ennemi042(46 * 16 - 5, 26 * 16 - 3));
        addEnnemi(new Ennemi042(169 * 16 - 5, 22 * 16 - 3));
        addEnnemi(new Ennemi042(191 * 16 - 5, 40 * 16 - 3));
        addEnnemi(new Ennemi042(203 * 16 - 5, 45 * 16 - 3));
        addEnnemi(new Ennemi042(249 * 16 - 5 + 8, 51 * 16 - 3));
        addEnnemi(new Ennemi042(89 * 16 - 5, 67 * 16 - 3));

        addEnnemi(new Ennemi062(249 * 16 + 4, 81 * 16, false));
        addEnnemi(new Ennemi062(189 * 16 + 4, 66 * 16, false));

        addEnnemi(new Ennemi112(26 * 16, 6 * 16));
        addEnnemi(new Ennemi112(31 * 16, 4 * 16));
        addEnnemi(new Ennemi112(32 * 16, 9 * 16));
        addEnnemi(new Ennemi112(126 * 16, 35 * 16));
        addEnnemi(new Ennemi112(71 * 16, 36 * 16));
        addEnnemi(new Ennemi112(85 * 16, 33 * 16));
        addEnnemi(new Ennemi112(134 * 16, 69 * 16));
        addEnnemi(new Ennemi112(53 * 16, 66 * 16));
        addEnnemi(new Ennemi112(50 * 16, 79 * 16));
        addEnnemi(new Ennemi112(54 * 16, 7 * 16));
        addEnnemi(new Ennemi112(106 * 16, 7 * 16));
        addEnnemi(new Ennemi112(114 * 16, 8 * 16));
        addEnnemi(new Ennemi112(147 * 16, 6 * 16));
        addEnnemi(new Ennemi112(149 * 16, 9 * 16));
        addEnnemi(new Ennemi112(152 * 16, 7 * 16));
        addEnnemi(new Ennemi112(166 * 16, 38 * 16));
        addEnnemi(new Ennemi112(173 * 16, 37 * 16));
        addEnnemi(new Ennemi112(186 * 16, 52 * 16));
        addEnnemi(new Ennemi112(213 * 16, 36 * 16));
        addEnnemi(new Ennemi112(215 * 16, 49 * 16));
        addEnnemi(new Ennemi112(185 * 16, 82 * 16));
        addEnnemi(new Ennemi112(191 * 16, 80 * 16));
        addEnnemi(new Ennemi112(147 * 16, 75 * 16));
        addEnnemi(new Ennemi112(158 * 16, 69 * 16));
        addEnnemi(new Ennemi112(160 * 16, 81 * 16));
        addEnnemi(new Ennemi112(171 * 16, 68 * 16));
        addEnnemi(new Ennemi112(227 * 16, 80 * 16));
        addEnnemi(new Ennemi112(233 * 16, 82 * 16));
        addEnnemi(new Ennemi112(249 * 16, 24 * 16));
        addEnnemi(new Ennemi112(102 * 16, 66 * 16));
    ...
    case 55:
        ...
        if (scene->getCoffre(10, 19))
            map->setSol(47 * 16, 57 * 16, 1936);
        if (scene->getCoffre(10, 20))
            map->setSol(52 * 16, 57 * 16, 1936);
        if (scene->getCoffre(10, 21))
            map->setSol(106 * 16, 15 * 16, 1936);
        if (scene->getCoffre(10, 22))
            map->setSol(115 * 16, 2 * 16, 1936);
        if (scene->getCoffre(10, 23))
            map->setSol(119 * 16, 10 * 16, 1936);
        if (scene->getCoffre(10, 24))
            map->setSol(119 * 16, 22 * 16, 1936);
        if (scene->getCoffre(10, 25))
            map->setSol(136 * 16, 4 * 16, 1936);
        if (scene->getCoffre(10, 26))
            map->setSol(134 * 16, 17 * 16, 1936);
        if (scene->getCoffre(10, 27))
            map->setSol(24 * 16, 102 * 16, 1936);
        if (scene->getCoffre(10, 28))
            map->setSol(35 * 16, 102 * 16, 1936);
        if (scene->getCoffre(10, 29))
            map->setSol(55 * 16, 104 * 16, 1936);
        if (scene->getCoffre(10, 30))
            map->setSol(66 * 16, 104 * 16, 1936);
        if (scene->getCoffre(10, 31))
            map->setSol(73 * 16, 104 * 16, 1936);
        if (scene->getCoffre(10, 32))
            map->setSol(84 * 16, 104 * 16, 1936);
        if (scene->getCoffre(10, 33))
            map->setSol(58 * 16, 112 * 16, 1936);
        if (scene->getCoffre(10, 34))
            map->setSol(81 * 16, 112 * 16, 1936);
        if (scene->getCoffre(10, 35))
            map->setSol(55 * 16, 119 * 16, 1936);
        if (scene->getCoffre(10, 36))
            map->setSol(66 * 16, 119 * 16, 1936);
        if (scene->getCoffre(10, 37))
            map->setSol(73 * 16, 119 * 16, 1936);
        if (scene->getCoffre(10, 38))
            map->setSol(84 * 16, 119 * 16, 1936);
        if (scene->getCoffre(10, 39))
            map->setSol(108 * 16, 122 * 16, 1936);
        if (scene->getCoffre(10, 40))
            map->setSol(111 * 16, 122 * 16, 1936);
        if (scene->getCoffre(10, 41))
            map->setSol(108 * 16, 132 * 16, 1936);
        if (scene->getCoffre(10, 42))
            map->setSol(111 * 16, 132 * 16, 1936);
        if (scene->getCoffre(10, 43))
            map->setSol(97 * 16, 152 * 16, 1936);
        if (scene->getCoffre(10, 44))
            map->setSol(97 * 16, 162 * 16, 1936);
        if (scene->getCoffre(10, 45))
            map->setSol(6 * 16, 201 * 16, 1936);
        if (scene->getCoffre(10, 46))
            map->setSol(27 * 16, 201 * 16, 1936);
        if (scene->getCoffre(10, 47))
            map->setSol(30 * 16, 201 * 16, 1936);
        if (scene->getCoffre(10, 48))
            map->setSol(14 * 16, 219 * 16, 1936);
        if (scene->getCoffre(10, 49))
            map->setSol(23 * 16, 213 * 16, 1936);
        if (scene->getCoffre(10, 50))
            map->setSol(27 * 16, 220 * 16, 1936);

        if (scene->getCoffre(10, 19) && scene->getCoffre(10, 20))
            ouvrePorte(49, 58, 0);
        if (scene->getCoffre(10, 21) && scene->getCoffre(10, 22) && scene->getCoffre(10, 23) && scene->getCoffre(10, 20) && scene->getCoffre(10, 25) && scene->getCoffre(10, 26))
            ouvrePorte(98, 6, 1);
        if (scene->getCoffre(10, 27) && scene->getCoffre(10, 28))
            ouvrePorte(29, 103, 0);
        if (scene->getCoffre(10, 29) && scene->getCoffre(10, 30) && scene->getCoffre(10, 31) && scene->getCoffre(10, 32) && scene->getCoffre(10, 33) && scene->getCoffre(10, 34) && scene->getCoffre(10, 35) && scene->getCoffre(10, 36) && scene->getCoffre(10, 37) && scene->getCoffre(10, 38))
            ouvrePorte(69, 88, 0);
        if (scene->getCoffre(10, 39) && scene->getCoffre(10, 40) && scene->getCoffre(10, 41) && scene->getCoffre(10, 42))
            ouvrePorte(98, 126, 1);
        if (scene->getCoffre(10, 43) && scene->getCoffre(10, 44))
            ouvrePorte(98, 156, 1);
        if (scene->getCoffre(10, 45) && scene->getCoffre(10, 46) && scene->getCoffre(10, 47) && scene->getCoffre(10, 48) && scene->getCoffre(10, 49) && scene->getCoffre(10, 50))
            ouvrePorte(38, 201, 1);
        ...
        addObject(new Caisse(118 * 16, 154 * 16, 4));
        addObject(new Caisse(118 * 16, 155 * 16, 4));
        addObject(new Caisse(118 * 16, 156 * 16, 4));

        addEnnemi(new Ennemi038(67 * 16 - 3, 66 * 16 + 7));
        addEnnemi(new Ennemi038(29 * 16 - 3, 37 * 16 + 7));
        addEnnemi(new Ennemi038(45 * 16 - 3, 3 * 16 + 7));
        addEnnemi(new Ennemi038(47 * 16 - 3, 9 * 16 + 7));
        addEnnemi(new Ennemi038(53 * 16 - 3, 5 * 16 + 7));
        addEnnemi(new Ennemi038(107 * 16 - 3, 21 * 16 + 7));
        addEnnemi(new Ennemi038(89 * 16 - 3, 66 * 16 + 7));
        addEnnemi(new Ennemi038(45 * 16 - 3, 54 * 16 + 7));
        addEnnemi(new Ennemi038(125 * 16 - 3, 111 * 16 + 7));
        addEnnemi(new Ennemi038(69 * 16 - 3, 125 * 16 + 7));
        addEnnemi(new Ennemi038(92 * 16 - 3, 114 * 16 + 7));
        addEnnemi(new Ennemi038(89 * 16 - 3, 141 * 16 + 7));
        addEnnemi(new Ennemi038(29 * 16 - 3, 111 * 16 + 7));
        addEnnemi(new Ennemi038(27 * 16 - 3, 140 * 16 + 7));
        addEnnemi(new Ennemi038(107 * 16 - 3, 94 * 16 + 7));
        addEnnemi(new Ennemi038(112 * 16 - 3, 99 * 16 + 7));
        addEnnemi(new Ennemi038(107 * 16 - 3, 84 * 16 + 7));
        addEnnemi(new Ennemi038(112 * 16 - 3, 81 * 16 + 7));
        addEnnemi(new Ennemi038(49 * 16 - 3, 216 * 16 + 7));
        addEnnemi(new Ennemi038(89 * 16 - 3, 216 * 16 + 7));
        addEnnemi(new Ennemi038(27 * 16 - 3, 185 * 16 + 7));
        addEnnemi(new Ennemi038(32 * 16 - 3, 187 * 16 + 7));
        addEnnemi(new Ennemi038(49 * 16 - 3, 155 * 16 + 7));
        addEnnemi(new Ennemi038(107 * 16 - 3, 172 * 16 + 7));
        addEnnemi(new Ennemi038(105 * 16 - 3, 217 * 16 + 7));
        addEnnemi(new Ennemi038(109 * 16 - 3, 198 * 16 + 7));
        addEnnemi(new Ennemi038(86 * 16 - 3, 4 * 16 + 7));
        addEnnemi(new Ennemi038(89 * 16 - 3, 9 * 16 + 7));

        addEnnemi(new Ennemi039(5 * 16 + 4, 34 * 16 + 7));
        addEnnemi(new Ennemi039(13 * 16 + 4, 34 * 16 + 7));
        addEnnemi(new Ennemi039(129 * 16 + 4, 36 * 16 + 7));
        addEnnemi(new Ennemi039(129 * 16 + 4, 125 * 16 + 7));
        addEnnemi(new Ennemi039(47 * 16 + 4, 110 * 16 + 7));
        addEnnemi(new Ennemi039(70 * 16 + 4, 97 * 16 + 7));
        addEnnemi(new Ennemi039(89 * 16 + 4, 126 * 16 + 7));
        addEnnemi(new Ennemi039(29 * 16 + 4, 96 * 16 + 7));
        addEnnemi(new Ennemi039(9 * 16 + 4, 126 * 16 + 7));
        addEnnemi(new Ennemi039(109 * 16 + 4, 110 * 16 + 7));
        addEnnemi(new Ennemi039(89 * 16 + 4, 81 * 16 + 7));
        addEnnemi(new Ennemi039(49 * 16 + 4, 81 * 16 + 7));
        addEnnemi(new Ennemi039(9 * 16 + 4, 186 * 16 + 7));
        addEnnemi(new Ennemi039(113 * 16 + 4, 187 * 16 + 7));
        addEnnemi(new Ennemi039(129 * 16 + 4, 186 * 16 + 7));
        addEnnemi(new Ennemi039(91 * 16 + 4, 5 * 16 + 7));

        addEnnemi(new Ennemi072(66 * 16, 5 * 16 - 10));
        addEnnemi(new Ennemi072(73 * 16, 4 * 16 - 10));
        addEnnemi(new Ennemi072(17 * 16, 12 * 16 - 10));
        addEnnemi(new Ennemi072(12 * 16, 56 * 16 - 10));
        addEnnemi(new Ennemi072(25 * 16, 66 * 16 - 10));
        addEnnemi(new Ennemi072(25 * 16, 53 * 16 - 10));
        addEnnemi(new Ennemi072(31 * 16, 55 * 16 - 10));
        addEnnemi(new Ennemi072(110 * 16, 55 * 16 - 10));
        addEnnemi(new Ennemi072(121 * 16, 63 * 16 - 10));
        addEnnemi(new Ennemi072(122 * 16, 53 * 16 - 10));
        addEnnemi(new Ennemi072(132 * 16, 65 * 16 - 10));

        addEnnemi(new Ennemi118(73 * 16, 215 * 16));
        addEnnemi(new Ennemi118(5 * 16, 157 * 16));
        addEnnemi(new Ennemi118(9 * 16, 173 * 16));
        addEnnemi(new Ennemi118(11 * 16, 162 * 16));
        addEnnemi(new Ennemi118(13 * 16, 156 * 16));
        addEnnemi(new Ennemi118(17 * 16, 170 * 16));
        addEnnemi(new Ennemi118(22 * 16, 159 * 16));
        addEnnemi(new Ennemi118(23 * 16, 166 * 16));
        addEnnemi(new Ennemi118(29 * 16, 172 * 16));
        addEnnemi(new Ennemi118(31 * 16, 156 * 16));
        addEnnemi(new Ennemi118(43 * 16, 44 * 16));
        addEnnemi(new Ennemi118(44 * 16, 18 * 16));
        addEnnemi(new Ennemi118(58 * 16, 56 * 16));
        addEnnemi(new Ennemi118(83 * 16, 55 * 16));
        addEnnemi(new Ennemi118(93 * 16, 18 * 16));
        addEnnemi(new Ennemi118(94 * 16, 39 * 16));
        addEnnemi(new Ennemi118(95 * 16, 56 * 16));
        addEnnemi(new Ennemi118(9 * 16, 15 * 16));
        addEnnemi(new Ennemi118(16 * 16, 20 * 16));
        addEnnemi(new Ennemi118(23 * 16, 9 * 16));
        addEnnemi(new Ennemi118(25 * 16, 14 * 16));
        addEnnemi(new Ennemi118(27 * 16, 20 * 16));
        addEnnemi(new Ennemi118(31 * 16, 15 * 16));
        addEnnemi(new Ennemi118(9 * 16, 38 * 16));
        addEnnemi(new Ennemi118(106 * 16, 37 * 16));
        addEnnemi(new Ennemi118(107 * 16, 65 * 16));
        addEnnemi(new Ennemi118(115 * 16, 67 * 16));
        addEnnemi(new Ennemi118(127 * 16, 51 * 16));
        addEnnemi(new Ennemi118(46 * 16, 66 * 16));
        addEnnemi(new Ennemi118(52 * 16, 68 * 16));
        addEnnemi(new Ennemi118(6 * 16, 106 * 16));
        addEnnemi(new Ennemi118(8 * 16, 112 * 16));
        addEnnemi(new Ennemi118(10 * 16, 96 * 16));
        addEnnemi(new Ennemi118(11 * 16, 104 * 16));
        addEnnemi(new Ennemi118(13 * 16, 100 * 16));
        addEnnemi(new Ennemi118(131 * 16, 105 * 16));
        addEnnemi(new Ennemi118(132 * 16, 97 * 16));
        addEnnemi(new Ennemi118(132 * 16, 110 * 16));
        addEnnemi(new Ennemi118(105 * 16, 126 * 16));
        addEnnemi(new Ennemi118(114 * 16, 127 * 16));
        addEnnemi(new Ennemi118(50 * 16, 96 * 16));
        addEnnemi(new Ennemi118(50 * 16, 125 * 16));
        addEnnemi(new Ennemi118(79 * 16, 93 * 16));
        addEnnemi(new Ennemi118(90 * 16, 101 * 16));
        addEnnemi(new Ennemi118(92 * 16, 95 * 16));
        addEnnemi(new Ennemi118(28 * 16, 125 * 16));
        addEnnemi(new Ennemi118(33 * 16, 128 * 16));
        addEnnemi(new Ennemi118(31 * 16, 143 * 16));
        addEnnemi(new Ennemi118(46 * 16, 141 * 16));
        addEnnemi(new Ennemi118(51 * 16, 143 * 16));
        addEnnemi(new Ennemi118(54 * 16, 139 * 16));
        addEnnemi(new Ennemi118(107 * 16, 141 * 16));
        addEnnemi(new Ennemi118(113 * 16, 144 * 16));
        addEnnemi(new Ennemi118(26 * 16, 81 * 16));
        addEnnemi(new Ennemi118(33 * 16, 84 * 16));
        addEnnemi(new Ennemi118(6 * 16, 205 * 16));
        addEnnemi(new Ennemi118(11 * 16, 212 * 16));
        addEnnemi(new Ennemi118(17 * 16, 201 * 16));
        addEnnemi(new Ennemi118(20 * 16, 209 * 16));
        addEnnemi(new Ennemi118(32 * 16, 210 * 16));
        addEnnemi(new Ennemi118(44 * 16, 194 * 16));
        addEnnemi(new Ennemi118(45 * 16, 170 * 16));
        addEnnemi(new Ennemi118(56 * 16, 204 * 16));
        addEnnemi(new Ennemi118(62 * 16, 169 * 16));
        addEnnemi(new Ennemi118(85 * 16, 170 * 16));
        addEnnemi(new Ennemi118(87 * 16, 205 * 16));
        addEnnemi(new Ennemi118(93 * 16, 194 * 16));
        addEnnemi(new Ennemi118(95 * 16, 180 * 16));
        addEnnemi(new Ennemi118(123 * 16, 155 * 16));
        addEnnemi(new Ennemi118(130 * 16, 172 * 16));
        addEnnemi(new Ennemi118(106 * 16, 184 * 16));
        addEnnemi(new Ennemi118(108 * 16, 190 * 16));
        addEnnemi(new Ennemi118(113 * 16, 205 * 16));
        addEnnemi(new Ennemi118(117 * 16, 213 * 16));
    ...
    case 56:
        ...
        if (scene->getCoffre(11, 7))
            ouvrePorte(69, 13, 0);
        if (scene->getCoffre(11, 8))
            ouvrePorte(69, 28, 0);
        ...
        if (scene->getCoffre(11, 12))
        {
            ...
            addEnnemi(new Ennemi119(48 * 16 - 3 + 8, 96 * 16 + 5));
        ...
        {
            addObject(new StatueGarde(65 * 16 + 5, 31 * 16 + 5 - 8));
            addObject(new StatueGarde(73 * 16 + 5, 31 * 16 + 5 - 8));
            addObject(new StatueGarde(45 * 16 + 5, 93 * 16 + 5 - 8));
            addObject(new StatueGarde(85 * 16 + 5, 46 * 16 + 5 - 8));
            addObject(new StatueGarde(93 * 16 + 5, 46 * 16 + 5 - 8));
            addObject(new StatueGarde(49 * 16 + 5, 46 * 16 + 5 - 8));
            addObject(new StatueGarde(7 * 16 + 5, 33 * 16 + 5 - 8));
            addObject(new StatueGarde(23 * 16 + 5, 35 * 16 + 5 - 8));
            addObject(new StatueGarde(16 * 16 + 5, 50 * 16 + 5 - 8));
            addObject(new StatueGarde(25 * 16 + 5, 50 * 16 + 5 - 8));
            addObject(new StatueGarde(53 * 16 + 5, 31 * 16 + 5 - 8));
            addObject(new StatueGarde(7 * 16 + 5, 61 * 16 + 5 - 8));
            addObject(new StatueGarde(11 * 16 + 5, 61 * 16 + 5 - 8));
            addObject(new StatueGarde(16 * 16 + 5, 93 * 16 + 5 - 8));
            addObject(new StatueGarde(25 * 16 + 5, 93 * 16 + 5 - 8));
            addObject(new StatueGarde(34 * 16 + 5, 93 * 16 + 5 - 8));
            addObject(new StatueGarde(86 * 16 + 5, 31 * 16 + 5 - 8));
            addObject(new StatueGarde(92 * 16 + 5, 31 * 16 + 5 - 8));
            addObject(new StatueGarde(126 * 16 + 5, 91 * 16 + 5 - 8));
            addObject(new StatueGarde(113 * 16 + 5, 31 * 16 + 5 - 8));
            addObject(new StatueGarde(105 * 16 + 5, 16 * 16 + 5 - 8));
            addObject(new StatueGarde(113 * 16 + 5, 16 * 16 + 5 - 8));
            addObject(new StatueGarde(115 * 16 + 5, 48 * 16 + 5 - 8));
            addObject(new StatueGarde(123 * 16 + 5, 48 * 16 + 5 - 8));
            addObject(new StatueGarde(125 * 16 + 5 - 8, 33 * 16 + 5 - 8));
            addObject(new StatueGarde(125 * 16 + 5, 61 * 16 + 5 - 8));
            addObject(new StatueGarde(133 * 16 + 5, 61 * 16 + 5 - 8));
            addObject(new StatueGarde(129 * 16 + 5, 3 * 16 + 5 - 8));
        }
        addEnnemi(new Ennemi119(49 * 16 - 3 + 8, 21 * 16 + 5));
        addEnnemi(new Ennemi119(48 * 16 - 3 + 8, 6 * 16 + 5));
        addEnnemi(new Ennemi119(7 * 16 - 3 + 8, 23 * 16 + 5));
        addEnnemi(new Ennemi119(19 * 16 - 3 + 8, 20 * 16 + 5));
        addEnnemi(new Ennemi119(31 * 16 - 3 + 8, 23 * 16 + 5));
        addEnnemi(new Ennemi119(10 * 16 - 3 + 8, 6 * 16 + 5));
        addEnnemi(new Ennemi119(27 * 16 - 3 + 8, 6 * 16 + 5));
        addEnnemi(new Ennemi119(89 * 16 - 3 + 8, 21 * 16 + 5));
        addEnnemi(new Ennemi119(149 * 16 - 3 + 8, 22 * 16 + 5));
        addEnnemi(new Ennemi119(149 * 16 - 3 + 8, 32 * 16 + 5));
        addEnnemi(new Ennemi119(189 * 16 - 3 + 8, 22 * 16 + 5));
        addEnnemi(new Ennemi119(189 * 16 - 3 + 8, 32 * 16 + 5));
        addEnnemi(new Ennemi119(146 * 16 - 3 + 8, 5 * 16 + 5));
        addEnnemi(new Ennemi119(152 * 16 - 3 + 8, 5 * 16 + 5));
        addEnnemi(new Ennemi119(187 * 16 - 3 + 8, 5 * 16 + 5));
        addEnnemi(new Ennemi119(193 * 16 - 3 + 8, 5 * 16 + 5));
        addEnnemi(new Ennemi119(169 * 16 - 3 + 8, 36 * 16 + 5));
        addEnnemi(new Ennemi119(90 * 16 - 3 + 8, 6 * 16 + 5));
    ...
    case 57:
        ...
        if (scene->getCoffre(12, 7))
            ouvrePorte(49, 238, 0);
        if (scene->getCoffre(12, 8))
            ouvrePorte(5, 233, 4);
        ...
        else
        {
            ...
            if (!scene->getMonsters(50))
            {
                ...
                addEnnemi(new Ennemi046(67 * 16 - 3 + 8, 35 * 16 + 5));
                addEnnemi(new Ennemi046(68 * 16 - 3 + 8, 48 * 16 + 5));
                addEnnemi(new Ennemi046(72 * 16 - 3 + 8, 42 * 16 + 5));
                addEnnemi(new Ennemi046(8 * 16 - 3 + 8, 7 * 16 + 5));
                addEnnemi(new Ennemi046(20 * 16 - 3 + 8, 4 * 16 + 5));
                addEnnemi(new Ennemi046(30 * 16 - 3 + 8, 8 * 16 + 5));
                addEnnemi(new Ennemi046(8 * 16 - 3 + 8, 21 * 16 + 5));
                addEnnemi(new Ennemi046(14 * 16 - 3 + 8, 25 * 16 + 5));
                addEnnemi(new Ennemi046(26 * 16 - 3 + 8, 26 * 16 + 5));
                addEnnemi(new Ennemi046(33 * 16 - 3 + 8, 19 * 16 + 5));
                addEnnemi(new Ennemi046(4 * 16 - 3 + 8, 96 * 16 + 5));
                addEnnemi(new Ennemi046(9 * 16 - 3 + 8, 99 * 16 + 5));
                addEnnemi(new Ennemi046(17 * 16 - 3 + 8, 94 * 16 + 5));
                addEnnemi(new Ennemi046(22 * 16 - 3 + 8, 99 * 16 + 5));
                addEnnemi(new Ennemi046(28 * 16 - 3 + 8, 95 * 16 + 5));
                addEnnemi(new Ennemi046(89 * 16 - 3 + 8, 21 * 16 + 5));
                addEnnemi(new Ennemi046(105 * 16 - 3 + 8, 5 * 16 + 5));
                addEnnemi(new Ennemi046(109 * 16 - 3 + 8, 52 * 16 + 5));
                addEnnemi(new Ennemi046(117 * 16 - 3 + 8, 53 * 16 + 5));
                addEnnemi(new Ennemi046(126 * 16 - 3 + 8, 50 * 16 + 5));
                addEnnemi(new Ennemi046(127 * 16 - 3 + 8, 81 * 16 + 5));
                addEnnemi(new Ennemi046(128 * 16 - 3 + 8, 71 * 16 + 5));
                addEnnemi(new Ennemi046(133 * 16 - 3 + 8, 76 * 16 + 5));

                addEnnemi(new Ennemi047(85 * 16 - 3 + 8, 48 * 16 + 5));
                addEnnemi(new Ennemi047(47 * 16 - 3 + 8, 47 * 16 + 5));
                addEnnemi(new Ennemi047(51 * 16 - 3 + 8, 55 * 16 + 5));
                addEnnemi(new Ennemi047(47 * 16 - 3 + 8, 6 * 16 + 5));
                addEnnemi(new Ennemi047(47 * 16 - 3 + 8, 22 * 16 + 5));
                addEnnemi(new Ennemi047(46 * 16 - 3 + 8, 34 * 16 + 5));
                addEnnemi(new Ennemi047(53 * 16 - 3 + 8, 39 * 16 + 5));
                addEnnemi(new Ennemi047(32 * 16 - 3 + 8, 97 * 16 + 5));
                addEnnemi(new Ennemi047(86 * 16 - 3 + 8, 34 * 16 + 5));
                addEnnemi(new Ennemi047(92 * 16 - 3 + 8, 40 * 16 + 5));
                addEnnemi(new Ennemi047(106 * 16 - 3 + 8, 26 * 16 + 5));
                addEnnemi(new Ennemi047(110 * 16 - 3 + 8, 18 * 16 + 5));
                ...
                addEnnemi(new Ennemi048(86 * 16 - 3 + 8, 171 * 16 + 5));
                addEnnemi(new Ennemi048(93 * 16 - 3 + 8, 173 * 16 + 5));
                addEnnemi(new Ennemi048(86 * 16 - 3 + 8, 156 * 16 + 5));
                addEnnemi(new Ennemi048(11 * 16 - 3 + 8, 236 * 16 + 5));
                addEnnemi(new Ennemi048(21 * 16 - 3 + 8, 235 * 16 + 5));
                addEnnemi(new Ennemi048(30 * 16 - 3 + 8, 236 * 16 + 5));
                addEnnemi(new Ennemi048(71 * 16 - 3 + 8, 235 * 16 + 5));
                addEnnemi(new Ennemi048(17 * 16 - 3 + 8, 40 * 16 + 5, true));
                addEnnemi(new Ennemi048(21 * 16 - 3 + 8, 48 * 16 + 5, true));
                addEnnemi(new Ennemi048(27 * 16 - 3 + 8, 43 * 16 + 5, true));
                addEnnemi(new Ennemi048(7 * 16 - 3 + 8, 69 * 16 + 5));
                addEnnemi(new Ennemi048(9 * 16 - 3 + 8, 81 * 16 + 5));
                addEnnemi(new Ennemi048(11 * 16 - 3 + 8, 75 * 16 + 5));
                addEnnemi(new Ennemi048(47 * 16 - 3 + 8, 95 * 16 + 5));
                addEnnemi(new Ennemi048(69 * 16 - 3 + 8, 22 * 16 + 5));
                addEnnemi(new Ennemi048(127 * 16 - 3 + 8, 21 * 16 + 5));
                addEnnemi(new Ennemi048(129 * 16 - 3 + 8, 7 * 16 + 5));
                addEnnemi(new Ennemi048(132 * 16 - 3 + 8, 16 * 16 + 5));
                addEnnemi(new Ennemi048(109 * 16 - 3 + 8, 35 * 16 + 5));
                addEnnemi(new Ennemi048(91 * 16 - 3 + 8, 98 * 16 + 5));
                addEnnemi(new Ennemi048(147 * 16 - 3 + 8, 26 * 16 + 5));
                addEnnemi(new Ennemi048(149 * 16 - 3 + 8, 34 * 16 + 5));
                addEnnemi(new Ennemi048(152 * 16 - 3 + 8, 21 * 16 + 5));
                addEnnemi(new Ennemi048(167 * 16 - 3 + 8, 36 * 16 + 5));
                addEnnemi(new Ennemi048(171 * 16 - 3 + 8, 36 * 16 + 5));
                addEnnemi(new Ennemi048(187 * 16 - 3 + 8, 21 * 16 + 5));
                addEnnemi(new Ennemi048(189 * 16 - 3 + 8, 7 * 16 + 5));
                addEnnemi(new Ennemi048(189 * 16 - 3 + 8, 34 * 16 + 5));
                addEnnemi(new Ennemi048(192 * 16 - 3 + 8, 27 * 16 + 5));
                addEnnemi(new Ennemi048(45 * 16 - 3 + 8, 245 * 16 + 5));
            }
            else
            {
        ...
        addObject(new Pnj(16 * 6, 16 * 48 - 8, 105, 1344));
        addObject(new TalkableArea(16 * 6, 16 * 50, 1344));

        addEnnemi(new Ennemi121(113 * 16, 157 * 16));
        addEnnemi(new Ennemi121(126 * 16, 158 * 16));
        addEnnemi(new Ennemi121(129 * 16, 172 * 16));
        addEnnemi(new Ennemi121(144 * 16, 171 * 16));
        addEnnemi(new Ennemi121(146 * 16, 185 * 16));
        addEnnemi(new Ennemi121(151 * 16, 189 * 16));
        addEnnemi(new Ennemi121(154 * 16, 186 * 16));
        addEnnemi(new Ennemi121(119 * 16, 156 * 16));
        addEnnemi(new Ennemi121(138 * 16, 173 * 16));
        addEnnemi(new Ennemi121(145 * 16, 200 * 16));
    ...
    case 58:
        ...
        addObject(new Pnj(16 * 64, 16 * 92 + 8, 6, 1424, N));
        addObject(new TalkableArea(16 * 64, 16 * 94, 1425));
        ...
        addObject(new Dices(16 * 25, 16 * 63, true));
        addObject(new Dices(16 * 28, 16 * 63, true));
        addObject(new Dices(16 * 31, 16 * 63, true));
        addObject(new Dices(16 * 34, 16 * 63, true));

        addObject(new Dices(16 * 46, 16 * 3, false));
        addObject(new Dices(16 * 49, 16 * 3, false));
        addObject(new Dices(16 * 52, 16 * 3, false));

        addObject(new Dices(16 * 3, 16 * 78, false));
        addObject(new Dices(16 * 5, 16 * 78, false));
        addObject(new Dices(16 * 7, 16 * 78, false));
        addObject(new Dices(16 * 12, 16 * 78, false));
        addObject(new Dices(16 * 15, 16 * 78, false));

        addObject(new Dices(16 * 103, 16 * 63, false));
        addObject(new Dices(16 * 116, 16 * 63, false));
        addObject(new Dices(16 * 103, 16 * 71, false));
        addObject(new Dices(16 * 116, 16 * 71, false));
        ...
        addObject(new Dices(16 * 83, 16 * 18, false));
        addObject(new Dices(16 * 87, 16 * 18, false));
        addObject(new Dices(16 * 90, 16 * 18, false));
        addObject(new Dices(16 * 93, 16 * 18, false));
        addObject(new Dices(16 * 96, 16 * 18, false));

        addEnnemi(new Ennemi123(69 * 16 + 5, 69 * 16));
        addEnnemi(new Ennemi123(69 * 16 + 5, 78 * 16));
        addEnnemi(new Ennemi123(49 * 16 + 5, 66 * 16));
        addEnnemi(new Ennemi123(49 * 16 + 5, 81 * 16));
        addEnnemi(new Ennemi123(89 * 16 + 5, 66 * 16));
        addEnnemi(new Ennemi123(89 * 16 + 5, 81 * 16));
        addEnnemi(new Ennemi123(129 * 16 + 5, 21 * 16));
        addEnnemi(new Ennemi123(69 * 16 + 5, 51 * 16));
        addEnnemi(new Ennemi123(49 * 16 + 5, 36 * 16));
        addEnnemi(new Ennemi123(89 * 16 + 5, 36 * 16));
        addEnnemi(new Ennemi123(109 * 16 + 5, 36 * 16));
        addEnnemi(new Ennemi123(89 * 16 + 5, 96 * 16));
        addEnnemi(new Ennemi123(99 * 16 + 5, 100 * 16));
        addEnnemi(new Ennemi123(109 * 16 + 5, 94 * 16));
        addEnnemi(new Ennemi123(29 * 16 + 5, 36 * 16));
        addEnnemi(new Ennemi123(45 * 16 + 5, 21 * 16));
        addEnnemi(new Ennemi123(53 * 16 + 5, 21 * 16));
        addEnnemi(new Ennemi123(49 * 16 + 5, 96 * 16));
        addEnnemi(new Ennemi123(9 * 16 + 5, 6 * 16));
        addEnnemi(new Ennemi123(9 * 16 + 5, 18 * 16));
        addEnnemi(new Ennemi123(9 * 16 + 5, 51 * 16));
        addEnnemi(new Ennemi123(6 * 16 + 5, 67 * 16));
        addEnnemi(new Ennemi123(129 * 16 + 5, 51 * 16));
        addEnnemi(new Ennemi123(133 * 16 + 5, 66 * 16));
        addEnnemi(new Ennemi123(6 * 16 + 5, 97 * 16));
        addEnnemi(new Ennemi123(18 * 16 + 5, 100 * 16));
        addEnnemi(new Ennemi123(27 * 16 + 5, 94 * 16));

        addEnnemi(new Ennemi126(49 * 16 + 8, 52 * 16));
        addEnnemi(new Ennemi126(89 * 16 + 8, 52 * 16));
        addEnnemi(new Ennemi126(86 * 16, 3 * 16));
        addEnnemi(new Ennemi126(93 * 16, 3 * 16));
        addEnnemi(new Ennemi126(106 * 16, 3 * 16));
        addEnnemi(new Ennemi126(113 * 16, 3 * 16));
        addEnnemi(new Ennemi126(86 * 16, 11 * 16));
        addEnnemi(new Ennemi126(93 * 16, 11 * 16));
        addEnnemi(new Ennemi126(106 * 16, 11 * 16));
        addEnnemi(new Ennemi126(113 * 16, 11 * 16));
        addEnnemi(new Ennemi126(127 * 16, 36 * 16));
        addEnnemi(new Ennemi126(133 * 16, 37 * 16));
    ...
    case 59:
        ...
        addObject(new PiegePics(174 * 16, 48 * 16, S));
        addObject(new PiegePics(185 * 16, 48 * 16, S));
        addObject(new PiegePics(189 * 16, 48 * 16, S));
        addObject(new PiegePics(193 * 16, 48 * 16, S));

        addObject(new PiegeLong(207 * 16, 48 * 16, S));
        addObject(new PiegeLong(217 * 16, 48 * 16, S));
        addObject(new PiegeLong(204 * 16, 34 * 16, S));
        addObject(new PiegeLong(266 * 16, 48 * 16, S));
        addObject(new PiegeLong(286 * 16, 48 * 16, S));
        addObject(new PiegeLong(266 * 16, 3 * 16, S));
        addObject(new PiegeLong(276 * 16, 11 * 16, S));
        addObject(new PiegeLong(286 * 16, 3 * 16, S));
        addObject(new PiegeLong(306 * 16, 29 * 16, S));

        addEnnemi(new Ennemi026(129 * 16, 56 * 16));
        addEnnemi(new Ennemi026(135 * 16, 48 * 16));
        addEnnemi(new Ennemi026(142 * 16, 53 * 16));
        addEnnemi(new Ennemi026(103 * 16, 29 * 16));
        addEnnemi(new Ennemi026(112 * 16, 35 * 16));
        addEnnemi(new Ennemi026(116 * 16, 21 * 16));
        addEnnemi(new Ennemi026(119 * 16, 41 * 16));
        addEnnemi(new Ennemi026(124 * 16, 29 * 16));
        addEnnemi(new Ennemi026(130 * 16, 23 * 16));
        addEnnemi(new Ennemi026(135 * 16, 33 * 16));
        addEnnemi(new Ennemi026(144 * 16, 39 * 16));
        addEnnemi(new Ennemi026(145 * 16, 18 * 16));
        addEnnemi(new Ennemi026(145 * 16, 30 * 16));
        addEnnemi(new Ennemi026(153 * 16, 27 * 16));
        addEnnemi(new Ennemi026(155 * 16, 37 * 16));
        addEnnemi(new Ennemi026(152 * 16, 4 * 16));
        addEnnemi(new Ennemi026(124 * 16, 5 * 16));
        addEnnemi(new Ennemi026(114 * 16, 9 * 16));
        addEnnemi(new Ennemi026(86 * 16, 4 * 16));
        addEnnemi(new Ennemi026(85 * 16, 40 * 16));
        addEnnemi(new Ennemi026(88 * 16, 25 * 16));
        addEnnemi(new Ennemi026(95 * 16, 30 * 16));
        addEnnemi(new Ennemi026(245 * 16, 25 * 16));
        addEnnemi(new Ennemi026(245 * 16, 38 * 16));
        addEnnemi(new Ennemi026(252 * 16, 29 * 16));
        addEnnemi(new Ennemi026(256 * 16, 21 * 16));
        addEnnemi(new Ennemi026(245 * 16, 55 * 16));
        addEnnemi(new Ennemi026(313 * 16, 55 * 16));
        addEnnemi(new Ennemi026(313 * 16, 4 * 16));
        addEnnemi(new Ennemi026(190 * 16, 33 * 16));
        addEnnemi(new Ennemi026(194 * 16, 20 * 16));
        addEnnemi(new Ennemi026(209 * 16, 26 * 16));
        addEnnemi(new Ennemi026(185 * 16, 3 * 16));
        addEnnemi(new Ennemi026(198 * 16, 4 * 16));
        addEnnemi(new Ennemi026(205 * 16, 11 * 16));
        addEnnemi(new Ennemi026(213 * 16, 3 * 16));
        addEnnemi(new Ennemi026(234 * 16, 4 * 16));
        addEnnemi(new Ennemi026(224 * 16, 32 * 16));
        addEnnemi(new Ennemi026(230 * 16, 25 * 16));
        addEnnemi(new Ennemi026(234 * 16, 39 * 16));
        addEnnemi(new Ennemi026(232 * 16, 55 * 16));
        addEnnemi(new Ennemi026(166 * 16, 53 * 16));
        addEnnemi(new Ennemi026(165 * 16, 30 * 16));
        addEnnemi(new Ennemi026(170 * 16, 23 * 16));
        addEnnemi(new Ennemi026(176 * 16, 34 * 16));

        addEnnemi(new Ennemi042(6 * 16 - 5, 34 * 16 - 3));
        addEnnemi(new Ennemi042(8 * 16 - 5, 6 * 16 - 3));
        addEnnemi(new Ennemi042(14 * 16 - 5, 24 * 16 - 3));
        addEnnemi(new Ennemi042(27 * 16 - 5, 35 * 16 - 3));
        addEnnemi(new Ennemi042(29 * 16 - 5, 52 * 16 - 3));
        addEnnemi(new Ennemi042(32 * 16 - 5, 4 * 16 - 3));
        addEnnemi(new Ennemi042(33 * 16 - 5, 21 * 16 - 3));
        addEnnemi(new Ennemi042(44 * 16 - 5, 31 * 16 - 3));
        addEnnemi(new Ennemi042(48 * 16 - 5, 8 * 16 - 3));
        addEnnemi(new Ennemi042(54 * 16 - 5, 22 * 16 - 3));
        addEnnemi(new Ennemi042(54 * 16 - 5, 49 * 16 - 3));
        addEnnemi(new Ennemi042(55 * 16 - 5, 39 * 16 - 3));
        addEnnemi(new Ennemi042(66 * 16 - 5, 21 * 16 - 3));
        addEnnemi(new Ennemi042(69 * 16 - 5, 55 * 16 - 3));
    ...
    case 60:
        ...
        if (scene->getCoffre(15, 5))
            ouvrePorte(18, 66, 1);
        if (scene->getCoffre(15, 6))
            ouvrePorte(9, 58, 0);
        if (scene->getCoffre(15, 7))
            ouvrePorte(29, 58, 0);
        if (scene->getCoffre(15, 8))
            ouvrePorte(58, 36, 1);
        if (scene->getCoffre(15, 9))
            ouvrePorte(49, 43, 0);
        if (scene->getCoffre(15, 10))
            ouvrePorte(49, 133, 0);
        if (scene->getCoffre(15, 11))
            ouvrePorte(129, 58, 0);
        if (scene->getCoffre(15, 12))
            ouvrePorte(129, 103, 0);
        ...
        addEnnemi(new Ennemi129(36 * 16, 138 * 16 - 5));
        addEnnemi(new Ennemi129(43 * 16, 138 * 16 - 5));
        ...
        addEnnemi(new Ennemi131(29 * 16 + 8, 7 * 16 - 8));
        addEnnemi(new Ennemi131(49 * 16 + 8, 7 * 16 - 8));
        addEnnemi(new Ennemi131(9 * 16 + 8, 22 * 16 - 8));
        addEnnemi(new Ennemi131(9 * 16 + 8, 37 * 16 - 8));
        addEnnemi(new Ennemi131(9 * 16 + 8, 52 * 16 - 8));
        addEnnemi(new Ennemi131(29 * 16 + 8, 52 * 16 - 8));

        addEnnemi(new Ennemi132(32 * 16, 120 * 16 + 6));
        addEnnemi(new Ennemi132(40 * 16, 125 * 16 + 6));
        addEnnemi(new Ennemi132(44 * 16, 116 * 16 + 6));

        addEnnemi(new Ennemi133(89 * 16 - 4 + 8, 5 * 16 + 7));
        addEnnemi(new Ennemi133(99 * 16 - 4 + 8, 8 * 16 + 7));
        addEnnemi(new Ennemi133(109 * 16 - 4 + 8, 5 * 16 + 7));

        addEnnemi(new Ennemi134(66 * 16 - 3 + 8, 125 * 16 + 6));
        addEnnemi(new Ennemi134(72 * 16 - 3 + 8, 125 * 16 + 6));
        addEnnemi(new Ennemi134(26 * 16 - 3 + 8, 127 * 16 + 6));
        addEnnemi(new Ennemi134(39 * 16 - 3 + 8, 110 * 16 + 6));
        addEnnemi(new Ennemi134(50 * 16 - 3 + 8, 126 * 16 + 6));
        addEnnemi(new Ennemi134(39 * 16 - 3 + 8, 141 * 16 + 6));
        addEnnemi(new Ennemi134(9 * 16 - 3 + 8, 126 * 16 + 6));
        addEnnemi(new Ennemi134(9 * 16 - 3 + 8, 111 * 16 + 6));

        addEnnemi(new Ennemi135(128 * 16 + 4, 38 * 16));
        addEnnemi(new Ennemi135(128 * 16 + 4, 51 * 16));
        addEnnemi(new Ennemi135(133 * 16 + 4, 44 * 16));

        addEnnemi(new Ennemi136(88 * 16 - 4, 126 * 16 - 4));
        addEnnemi(new Ennemi136(96 * 16 - 4, 128 * 16 - 4));
        addEnnemi(new Ennemi136(104 * 16 - 4, 125 * 16 - 4));
        addEnnemi(new Ennemi136(112 * 16 - 4, 127 * 16 - 4));
        addEnnemi(new Ennemi136(129 * 16 - 4, 126 * 16 - 4));
        addEnnemi(new Ennemi136(126 * 16 - 4, 110 * 16 - 4));
        addEnnemi(new Ennemi136(132 * 16 - 4, 112 * 16 - 4));

        addEnnemi(new Ennemi137(34 * 16, 30 * 16 + 6));
        addEnnemi(new Ennemi137(42 * 16, 22 * 16 + 6));
        addEnnemi(new Ennemi137(49 * 16, 36 * 16 + 6));

        addEnnemi(new Ennemi138(69 * 16 + 3, 40 * 16 + 4));
        addEnnemi(new Ennemi138(89 * 16 + 3, 22 * 16 + 4));
        addEnnemi(new Ennemi138(109 * 16 + 3, 22 * 16 + 4));
        addEnnemi(new Ennemi138(66 * 16 + 3, 67 * 16 + 4));
        addEnnemi(new Ennemi138(106 * 16 + 3, 68 * 16 + 4));

        addEnnemi(new Ennemi139(45 * 16 + 5, 51 * 16));
        addEnnemi(new Ennemi139(54 * 16 + 5, 54 * 16));
        addEnnemi(new Ennemi139(30 * 16 + 5, 67 * 16));
        addEnnemi(new Ennemi139(40 * 16 + 5, 65 * 16));
        addEnnemi(new Ennemi139(50 * 16 + 5, 68 * 16));

        addEnnemi(new Ennemi140(97 * 16, 101 * 16));
        addEnnemi(new Ennemi140(99 * 16, 111 * 16));
        addEnnemi(new Ennemi140(108 * 16, 107 * 16));
        addEnnemi(new Ennemi140(85 * 16, 83 * 16));
        addEnnemi(new Ennemi140(88 * 16, 80 * 16));
        addEnnemi(new Ennemi140(92 * 16, 82 * 16));
        addEnnemi(new Ennemi140(91 * 16, 42 * 16));
        addEnnemi(new Ennemi140(92 * 16, 52 * 16));
        addEnnemi(new Ennemi140(100 * 16, 48 * 16));
        addEnnemi(new Ennemi140(101 * 16, 38 * 16));
        break;
    case 61:
    ...
    case 69:
        ...
        break;
    case 70:
        if (scene->getAvancement() >= AV_PORTAIL_PRE_PRESENT_OUVERT && scene->getAvancement() < AV_PORTAIL_PRE_PRESENT_FERME)
        {
            ouvrePorte(9, 3, 0);
        }
    ...
    case 127:
        addObject(new Jarre(4 * 16, 12 * 16, 0, TI_NO_ITEM, map));
        addObject(new Jarre(5 * 16, 12 * 16, 0, TI_PETIT_COEUR, map));
        if (inventory->getTrocGemme(0) >= TGR_FER_CHEVAL && inventory->getTrocGemme(1) >= TGB_CLOCHE && inventory->getTrocGemme(2) >= TGJ_MIROIR)
        {
    ...
    case 136:
        ...
        break;
    case 137:
        if (inventory->nbCristaux() < 3 || link->getInventory()->getTrocGemme(3) < TGV_BIERE || inventory->hasCristal(3))
        {
            for (int j = 0; j < 2; j++)
            {
                for (int i = 0; i < 3; i++)
    ...
    case 156:
        ...
        if (scene->getCoffre(16, 19))
            ouvrePorte(29, 13, 0);
        if (scene->getCoffre(16, 20))
            ouvrePorte(38, 6, 1);
        if (scene->getCoffre(16, 21))
            ouvrePorte(49, 103, 0);
        if (scene->getCoffre(16, 22))
            ouvrePorte(38, 201, 1);
        if (scene->getCoffre(16, 23))
            ouvrePorte(29, 193, 0);
        if (scene->getCoffre(16, 24))
            ouvrePorte(29, 178, 0);
        if (scene->getCoffre(16, 25))
            ouvrePorte(18, 171, 1);
        if (scene->getCoffre(16, 26))
            ouvrePorte(9, 163, 0);
        if (scene->getCoffre(16, 27))
            ouvrePorte(18, 156, 1);
        if (scene->getCoffre(16, 28))
            ouvrePorte(38, 156, 1);
        if (scene->getCoffre(16, 29))
            ouvrePorte(49, 163, 0);
        if (scene->getCoffre(16, 30))
            ouvrePorte(58, 171, 1);
        if (scene->getCoffre(16, 31))
            ouvrePorte(69, 178, 0);
        if (scene->getCoffre(16, 32))
            ouvrePorte(58, 186, 1);
        if (scene->getCoffre(16, 33))
            ouvrePorte(118, 291, 1);
        if (scene->getCoffre(16, 34))
            ouvrePorte(129, 283, 2);
        if (scene->getCoffre(16, 35))
            ouvrePorte(158, 171, 3);
        if (scene->getCoffre(16, 36))
            ouvrePorte(169, 268, 2);
        if (scene->getCoffre(16, 37))
            ouvrePorte(218, 81, 3);
        if (scene->getCoffre(16, 38))
            ouvrePorte(209, 157, 4);
        if (scene->getCoffre(16, 39))
        ...
        if (scene->getCoffre(17, 4))
            ouvrePorte(29, 88, 0);
        if (scene->getCoffre(17, 5))
            ouvrePorte(49, 13, 0);
        if (scene->getCoffre(17, 6))
            ouvrePorte(49, 193, 0);
        if (scene->getCoffre(17, 7))
            ouvrePorte(49, 253, 0);
        if (scene->getCoffre(17, 8))
            ouvrePorte(69, 88, 0);
        if (scene->getCoffre(17, 9))
            ouvrePorte(69, 238, 0);
        if (scene->getCoffre(17, 10))
            ouvrePorte(69, 253, 0);
        if (scene->getCoffre(17, 11))
            ouvrePorte(78, 261, 1);
        if (scene->getCoffre(17, 12))
            ouvrePorte(109, 163, 0);
        if (scene->getCoffre(17, 13))
            ouvrePorte(129, 103, 0);
        if (scene->getCoffre(17, 14))
            ouvrePorte(138, 111, 1);
        if (scene->getCoffre(17, 15))
            ouvrePorte(118, 156, 1);
        if (scene->getCoffre(17, 16))
            ouvrePorte(129, 193, 0);
        if (scene->getCoffre(17, 17))
            ouvrePorte(149, 103, 0);
        if (scene->getCoffre(17, 18))
            ouvrePorte(149, 268, 0);
        if (scene->getCoffre(17, 19))
            ouvrePorte(149, 283, 0);
        if (scene->getCoffre(17, 20))
            ouvrePorte(158, 156, 1);
        if (scene->getCoffre(17, 21))
            ouvrePorte(169, 238, 0);
        if (scene->getCoffre(17, 22))
            ouvrePorte(178, 246, 1);
        if (scene->getCoffre(17, 23))
            ouvrePorte(189, 88, 0);
        if (scene->getCoffre(17, 24))
            ouvrePorte(218, 261, 1);
        if (scene->getCoffre(17, 25))
            ouvrePorte(218, 156, 1);
        if (scene->getCoffre(17, 26))
            ouvrePorte(229, 238, 0);
        if (scene->getCoffre(17, 27))
            ouvrePorte(249, 13, 0);
        if (scene->getCoffre(17, 28))
            ouvrePorte(249, 178, 0);
        if (scene->getCoffre(17, 29))
            ouvrePorte(278, 111, 1);
        if (scene->getCoffre(17, 30))
            ouvrePorte(278, 156, 1);
        if (scene->getCoffre(17, 31))
            ouvrePorte(269, 238, 0);
        if (scene->getCoffre(17, 32))
            ouvrePorte(289, 88, 0);
        if (scene->getCoffre(17, 33))
            ouvrePorte(278, 171, 1);
        if (scene->getCoffre(17, 34))
            ouvrePorte(289, 178, 0);
        if (scene->getCoffre(17, 35))
            ouvrePorte(278, 246, 1);
        if (scene->getCoffre(17, 36))
            ouvrePorte(278, 261, 1);
        if (scene->getCoffre(17, 42))
            ouvrePorte(158, 111, 1);

        addObject(new TasDePierres(202 * 16, 281 * 16, 1));
        addObject(new TasDePierres(216 * 16, 281 * 16, 1));
        ...
        addObject(new Caisse(30 * 16, 260 * 16, 2, 3));
        addObject(new Caisse(27 * 16, 261 * 16, 2, 4));
        addObject(new Caisse(29 * 16, 261 * 16, 2, 3));
        addObject(new Caisse(31 * 16, 262 * 16, 2, 2));
        addObject(new Caisse(29 * 16, 263 * 16, 2, 2));
        addObject(new Caisse(30 * 16, 263 * 16, 2, 2));
        addObject(new Caisse(27 * 16, 264 * 16, 2, 1));
        addObject(new Caisse(31 * 16, 264 * 16, 2, 1));

        addObject(new Caisse(8 * 16, 80 * 16, 5, 1));
        addObject(new Caisse(8 * 16, 81 * 16, 2, 2));
        addObject(new Caisse(9 * 16, 81 * 16, 5, 2));
        addObject(new Caisse(10 * 16, 81 * 16, 2, 2));
        addObject(new Caisse(8 * 16, 82 * 16, 5, 1));
        addObject(new Caisse(9 * 16, 83 * 16, 2, 1));
        addObject(new Caisse(11 * 16, 83 * 16, 5, 2));

        addObject(new Caisse(88 * 16, 245 * 16, 5, 5));
        addObject(new Caisse(92 * 16, 245 * 16, 5, 5));
        addObject(new Caisse(88 * 16, 249 * 16, 5, 5));
        addObject(new Caisse(92 * 16, 249 * 16, 5, 5));

        addObject(new Pnj(95 * 16, 205 * 16, 71, 1727));

        addEnnemi(new Ennemi015(249 * 16 + 4, 37 * 16));
        addEnnemi(new Ennemi015(219 * 16 + 4, 127 * 16));
        addEnnemi(new Ennemi015(281 * 16 + 4, 130 * 16));
        addEnnemi(new Ennemi015(219 * 16 + 4, 220 * 16));
        addEnnemi(new Ennemi015(276 * 16 + 4, 219 * 16));

        addEnnemi(new Ennemi018(9 * 16, 203 * 16 + 2));
        addEnnemi(new Ennemi018(34 * 16, 3 * 16 + 2));
        addEnnemi(new Ennemi018(66 * 16, 86 * 16 + 2));
        addEnnemi(new Ennemi018(15 * 16, 92 * 16 + 2));
        addEnnemi(new Ennemi018(57 * 16, 86 * 16 + 2));
        addEnnemi(new Ennemi018(26 * 16, 189 * 16 + 2));
        addEnnemi(new Ennemi018(33 * 16, 185 * 16 + 2));
        addEnnemi(new Ennemi018(26 * 16, 176 * 16 + 2));
        addEnnemi(new Ennemi018(13 * 16, 161 * 16 + 2));
        addEnnemi(new Ennemi018(46 * 16, 153 * 16 + 2));
        addEnnemi(new Ennemi018(53 * 16, 159 * 16 + 2));
        addEnnemi(new Ennemi018(52 * 16, 176 * 16 + 2));
        addEnnemi(new Ennemi018(66 * 16, 183 * 16 + 2));
        addEnnemi(new Ennemi018(68 * 16, 191 * 16 + 2));
        addEnnemi(new Ennemi018(73 * 16, 186 * 16 + 2));
        addEnnemi(new Ennemi018(18 * 16, 286 * 16 + 2));
        addEnnemi(new Ennemi018(27 * 16, 281 * 16 + 2));
        addEnnemi(new Ennemi018(46 * 16, 293 * 16 + 2));
        addEnnemi(new Ennemi018(53 * 16, 276 * 16 + 2));
        addEnnemi(new Ennemi018(23 * 16, 237 * 16 + 2));
        addEnnemi(new Ennemi018(14 * 16, 241 * 16 + 2));
        addEnnemi(new Ennemi018(31 * 16, 234 * 16 + 2));
        addEnnemi(new Ennemi018(92 * 16, 293 * 16 + 2));
        addEnnemi(new Ennemi018(72 * 16, 281 * 16 + 2));

        addEnnemi(new Ennemi026(155 * 16, 261 * 16));
        addEnnemi(new Ennemi026(152 * 16, 252 * 16));
        addEnnemi(new Ennemi026(138 * 16, 253 * 16));
        addEnnemi(new Ennemi026(132 * 16, 260 * 16));
        addEnnemi(new Ennemi026(186 * 16, 273 * 16));
        addEnnemi(new Ennemi026(193 * 16, 278 * 16));
        addEnnemi(new Ennemi026(128 * 16, 226 * 16));
        addEnnemi(new Ennemi026(151 * 16, 226 * 16));
        addEnnemi(new Ennemi026(115 * 16, 253 * 16));
        addEnnemi(new Ennemi026(126 * 16, 288 * 16));
        addEnnemi(new Ennemi026(168 * 16, 288 * 16));
        addEnnemi(new Ennemi026(132 * 16, 296 * 16));
        addEnnemi(new Ennemi026(124 * 16, 151 * 16));
        addEnnemi(new Ennemi026(135 * 16, 151 * 16));
        addEnnemi(new Ennemi026(124 * 16, 163 * 16));
        addEnnemi(new Ennemi026(135 * 16, 163 * 16));
        addEnnemi(new Ennemi026(103 * 16, 185 * 16));
        addEnnemi(new Ennemi026(116 * 16, 193 * 16));
        addEnnemi(new Ennemi026(152 * 16, 168 * 16));
        addEnnemi(new Ennemi026(191 * 16, 157 * 16));
        addEnnemi(new Ennemi026(198 * 16, 166 * 16));
        addEnnemi(new Ennemi026(175 * 16, 178 * 16));
        addEnnemi(new Ennemi026(165 * 16, 106 * 16));
        addEnnemi(new Ennemi026(174 * 16, 118 * 16));
        addEnnemi(new Ennemi026(146 * 16, 86 * 16));
        addEnnemi(new Ennemi026(154 * 16, 78 * 16));
        addEnnemi(new Ennemi026(104 * 16, 110 * 16));
        addEnnemi(new Ennemi026(124 * 16, 268 * 16));
        addEnnemi(new Ennemi026(186 * 16, 198 * 16));

        addEnnemi(new Ennemi044(249 * 16 - 3 + 8, 200 * 16 - 10));
        addEnnemi(new Ennemi044(218 * 16 - 3, 186 * 16 - 10));
        addEnnemi(new Ennemi044(223 * 16 - 3, 200 * 16 - 10));
        addEnnemi(new Ennemi044(275 * 16 - 3, 200 * 16 - 10));
        addEnnemi(new Ennemi044(283 * 16 - 3, 186 * 16 - 10));
        addEnnemi(new Ennemi044(269 * 16 + 8 - 3, 172 * 16 - 10));
        addEnnemi(new Ennemi044(229 * 16 + 8 - 3, 172 * 16 - 10));
        addEnnemi(new Ennemi044(229 * 16 + 8 - 3, 157 * 16 - 10));
        addEnnemi(new Ennemi044(269 * 16 + 8 - 3, 112 * 16 - 10));
        addEnnemi(new Ennemi044(249 * 16 + 8 - 3, 110 * 16 - 10));
        addEnnemi(new Ennemi044(226 * 16 - 3, 96 * 16 - 10));
        addEnnemi(new Ennemi044(211 * 16 - 3, 108 * 16 - 10));
        addEnnemi(new Ennemi044(206 * 16 + 8 - 3, 101 * 16 - 10));
        addEnnemi(new Ennemi044(289 * 16 + 8 - 3, 82 * 16 - 10));
        addEnnemi(new Ennemi044(249 * 16 + 8 - 3, 7 * 16 - 10));
        addEnnemi(new Ennemi044(229 * 16 + 8 - 3, 22 * 16 - 10));
        addEnnemi(new Ennemi044(269 * 16 + 8 - 3, 22 * 16 - 10));

        addEnnemi(new Ennemi053(116 * 16, 127 * 16));
        addEnnemi(new Ennemi053(135 * 16, 131 * 16));
        addEnnemi(new Ennemi053(158 * 16, 128 * 16));
        addEnnemi(new Ennemi053(176 * 16, 131 * 16));
        addEnnemi(new Ennemi053(195 * 16, 129 * 16));
        addEnnemi(new Ennemi053(107 * 16, 217 * 16));
        addEnnemi(new Ennemi053(124 * 16, 220 * 16));
        addEnnemi(new Ennemi053(146 * 16, 217 * 16));
        addEnnemi(new Ennemi053(161 * 16, 221 * 16));
        addEnnemi(new Ennemi053(180 * 16, 217 * 16));
        addEnnemi(new Ennemi053(139 * 16, 38 * 16));
        addEnnemi(new Ennemi053(159 * 16, 41 * 16));

        addEnnemi(new Ennemi056(274 * 16 - 1, 275 * 16 - 1));
        addEnnemi(new Ennemi056(229 * 16 + 8 - 1, 277 * 16 - 1));
        addEnnemi(new Ennemi056(226 * 16 - 1, 254 * 16 - 1));
        addEnnemi(new Ennemi056(266 * 16 - 1, 251 * 16 - 1));
        addEnnemi(new Ennemi056(273 * 16 - 1, 257 * 16 - 1));
        addEnnemi(new Ennemi056(227 * 16 - 1, 295 * 16 - 1));
        addEnnemi(new Ennemi056(269 * 16 - 1 + 8, 97 * 16 - 1));

        addEnnemi(new Ennemi064(29 * 16 - 4, 6 * 16 - 4));
        addEnnemi(new Ennemi064(89 * 16 - 4, 102 * 16 - 4));
        addEnnemi(new Ennemi064(69 * 16 - 4, 96 * 16 - 4));
        addEnnemi(new Ennemi064(29 * 16 - 4, 96 * 16 - 4));
        addEnnemi(new Ennemi064(36 * 16 - 4, 81 * 16 - 4));
        addEnnemi(new Ennemi064(69 * 16 - 4, 111 * 16 - 4));
        addEnnemi(new Ennemi064(49 * 16 - 4, 201 * 16 - 4));
        addEnnemi(new Ennemi064(69 * 16 - 4, 246 * 16 - 4));
        addEnnemi(new Ennemi064(49 * 16 - 4, 261 * 16 - 4));
        addEnnemi(new Ennemi064(49 * 16 - 4, 246 * 16 - 4));
        addEnnemi(new Ennemi064(77 * 16 - 4, 291 * 16 - 4));
        addEnnemi(new Ennemi064(29 * 16 - 4, 201 * 16 - 4));
        addEnnemi(new Ennemi064(29 * 16 - 4, 21 * 16 - 4));
        addEnnemi(new Ennemi064(69 * 16 - 4, 21 * 16 - 4));
        addEnnemi(new Ennemi064(9 * 16 - 4, 171 * 16 - 4));
        addEnnemi(new Ennemi064(29 * 16 - 4, 156 * 16 - 4));
        addEnnemi(new Ennemi064(69 * 16 - 4, 171 * 16 - 4));
        addEnnemi(new Ennemi064(89 * 16 - 4, 231 * 16 - 4));

        addEnnemi(new Ennemi077(15 * 16 - 13, 127 * 16 - 12));
        addEnnemi(new Ennemi077(43 * 16 - 13, 130 * 16 - 12));
        addEnnemi(new Ennemi077(88 * 16 - 13, 128 * 16 - 12));
        addEnnemi(new Ennemi077(48 * 16 - 13, 40 * 16 - 12));
        addEnnemi(new Ennemi077(27 * 16 - 13, 217 * 16 - 12));
        addEnnemi(new Ennemi077(73 * 16 - 13, 220 * 16 - 12));

        addEnnemi(new Ennemi119(147 * 16 - 3, 291 * 16 + 5));
        addEnnemi(new Ennemi119(152 * 16 - 3, 291 * 16 + 5));
        addEnnemi(new Ennemi119(189 * 16 - 3 + 8, 261 * 16 + 5));
        addEnnemi(new Ennemi119(169 * 16 - 3 + 8, 231 * 16 + 5));
        addEnnemi(new Ennemi119(109 * 16 - 3 + 8, 261 * 16 + 5));
        addEnnemi(new Ennemi119(109 * 16 - 3 + 8, 291 * 16 + 5));
        addEnnemi(new Ennemi119(189 * 16 - 3 + 8, 246 * 16 + 5));
        addEnnemi(new Ennemi119(149 * 16 - 3 + 8, 156 * 16 + 5));
        addEnnemi(new Ennemi119(129 * 16 - 3 + 8, 201 * 16 + 5));
        addEnnemi(new Ennemi119(169 * 16 - 3 + 8, 201 * 16 + 5));
        addEnnemi(new Ennemi119(189 * 16 - 3 + 8, 186 * 16 + 5));
        addEnnemi(new Ennemi119(109 * 16 - 3 + 8, 171 * 16 + 5));
        addEnnemi(new Ennemi119(189 * 16 - 3 + 8, 111 * 16 + 5));
        addEnnemi(new Ennemi119(187 * 16 - 3, 96 * 16 + 5));
        addEnnemi(new Ennemi119(192 * 16 - 3, 96 * 16 + 5));
        addEnnemi(new Ennemi119(149 * 16 - 3 + 8, 96 * 16 + 5));
        addEnnemi(new Ennemi119(109 * 16 - 3 + 8, 96 * 16 + 5));
        addEnnemi(new Ennemi119(169 * 16 - 3 + 8, 81 * 16 + 5));
        addEnnemi(new Ennemi119(119 * 16 - 3 + 8, 81 * 16 + 5));
        addEnnemi(new Ennemi119(147 * 16 - 3, 21 * 16 + 5));
